...
| --- | --- |
| Eggplant Parmesan | |
| [Eggplant Parmesan.png](/File:Eggplant_Parmesan.png) | |
| Tangy, cheesy, and wonderful. | |
| Information | |
| Source | [Cooking](/Cooking "Cooking") |
| Buff(s) | Mining.png [Mining](/Mining "Mining") (+1)Defense.png [Defense](/Defense "Defense") (+3) |
| Buff Duration | Time Icon.png 4m 39s |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 175 | Health.png | 78 | |
| Sell Price | |  |  | | --- | --- | | Eggplant Parmesan.png | 200g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 315 | Health.png  Gold Quality Icon.png | 141 | |  | |  |  | | --- | --- | | Eggplant Parmesan.png  Gold Quality Icon.png | 300g | | |
| Recipe | |
| Recipe Source(s) | Lewis Icon.png [Lewis](/Lewis "Lewis") (Mail - 7+ HeartIconLarge.png) |
| Ingredients | Eggplant.png [Eggplant](/Eggplant "Eggplant") (1)Tomato.png [Tomato](/Tomato "Tomato") (1) |

**Eggplant Parmesan** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").

**Note**: this recipe is [profitable](/Cooking#Profitable_Recipes "Cooking") - it will always result in profit when using the lowest quality ingredients.

Eggplant Parmesan may randomly appear in [Krobus](/Krobus "Krobus")' shop on [Saturdays](/Days_of_the_Week#Saturday "Days of the Week"), in the [Garbage Can](/Garbage_Can "Garbage Can") outside the saloon, or in [the Stardrop Saloon](/The_Stardrop_Saloon "The Stardrop Saloon")'s rotating stock. It is also sold by the [Calico Egg Merchant](/Desert_Festival#Calico_Egg_Merchant "Desert Festival") and in [Gus](/Gus "Gus")'s [shop](/Desert_Festival#Villager_Shops "Desert Festival") at the [Desert Festival](/Desert_Festival "Desert Festival") for data-sort-value="10">![Calico Egg.png](/mediawiki/images/thumb/d/da/Calico_Egg.png/24px-Calico_Egg.png) 10 [Calico Eggs](/Calico_Egg "Calico Egg") and data-sort-value="30">![Calico Egg.png](/mediawiki/images/thumb/d/da/Calico_Egg.png/24px-Calico_Egg.png) 30 Calico Eggs, respectively. One Eggplant Parmesan may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").

## Gifting

| Villager Reactions | |
| --- | --- |
| Love | [Jodi Icon.png](/Jodi "Jodi") [Jodi](/Jodi "Jodi") |
...
Eggplant Parmesan is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Eggplant Parmesan is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt114.png](/mediawiki/images/thumb/3/33/Shirt114.png/24px-Shirt114.png)](/File:Shirt114.png) It can be also used as a red dye color at the dye pots in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Eggplant Parmesan is not used in any [quests](/Quests "Quests").

## Trivia

Despite Parmesan being a kind of cheese, and the dish being described as 'cheesy', the recipe does not actually call for [Cheese](/Cheese "Cheese").
