...
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="97 ">Gold.png97g |

**Granite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Granite is not used in any [bundles](/Bundles "Bundles").
...
Granite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt122.png](/mediawiki/images/thumb/f/f5/Shirt122.png/24px-Shirt122.png) [Shirt](/Tailoring "Tailoring"). It is a gray dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

One Granite may be requested by a [Spook Fish](/Spook_Fish "Spook Fish") in a [Fish Pond quest](/Fish_Pond#Quests "Fish Pond") to increase the capacity of the pond from 5 to 7.
