...
| Size (inches) | 20–49 |
| Fishing XP | 18   Silver Quality.png 21   Gold Quality.png 24   Iridium Quality.png 30 |
...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Shad.png | 60g | | Shad.png  Silver Quality Icon.png | 75g | | Shad.png  Gold Quality Icon.png | 90g | | Shad.png  Iridium Quality Icon.png | 120g | | |  |  | | --- | --- | | Shad.png | 75g | | Shad.png  Silver Quality Icon.png | 93g | | Shad.png  Gold Quality Icon.png | 112g | | Shad.png  Iridium Quality Icon.png | 150g | | |  |  | | --- | --- | | Shad.png | 90g | | Shad.png  Silver Quality Icon.png | 112g | | Shad.png  Gold Quality Icon.png | 135g | | Shad.png  Iridium Quality Icon.png | 180g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Green Roe.png | 60g | | |  |  | | --- | --- | | Green Aged Roe.png | 120g | | |  |  | | --- | --- | | Green Aged Roe.png | 168g | | | |

The **Shad** is a [fish](/Fish "Fish") that can be caught in the river (in [Pelican Town](/Pelican_Town "Pelican Town") or [Cindersap Forest](/Cindersap_Forest "Cindersap Forest")) and the [Riverlands Farm](/Farm_Maps#Riverland "Farm Maps"), [Forest Farm](/Farm_Maps#Forest "Farm Maps"), or [Hill-Top Farm](/Farm_Maps#Hill-Top "Farm Maps") during [Spring](/Spring "Spring"), [Summer](/Summer "Summer"), and [Fall](/Fall "Fall") while [raining](/Weather "Weather"). It can also be gifted by a [pet](/Animals#Pets "Animals") cat with max [friendship](/Animals#Friendship "Animals"). It may also randomly appear in [Krobus](/Krobus "Krobus")' shop on [Wednesdays](/Days_of_the_Week#Wednesday "Days of the Week") for data-sort-value="200">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)200g, or at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="60"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)180–1,000g.

Shad can be caught regardless of weather, time, or season using [Magic Bait](/Magic_Bait "Magic Bait").
...
* Shad is used in the ![Bundle Teal.png](/mediawiki/images/thumb/c/ce/Bundle_Teal.png/24px-Bundle_Teal.png) [River Fish Bundle](/Bundles#River_Fish_Bundle "Bundles") in the [Fish Tank](/Bundles#Fish_Tank "Bundles").
* 1 gold/iridium quality Shad is used in the ![Bundle Red.png](/mediawiki/images/thumb/3/3f/Bundle_Red.png/24px-Bundle_Red.png) [Quality Fish Bundle](/Remixed_Bundles#Quality_Fish_Bundle "Remixed Bundles") in the [Fish Tank (Remixed)](/Remixed_Bundles#Fish_Tank "Remixed Bundles").
...
Shad can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [Fish Shirt](/Tailoring "Tailoring"). [![Shirt158.png](/mediawiki/images/thumb/e/e7/Shirt158.png/24px-Shirt158.png)](/File:Shirt158.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as a green dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Fish Pond

Shad can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"), where they will reproduce every 2 days. The initial pond capacity is 3 fish, but the capacity can be increased to 10 by completing three quests. The only possible output is green Shad [Roe](/Roe "Roe").
...
| --- | --- | --- | --- | --- |
| Green Roe.png [Roe](/Roe "Roe") (1) | 12 | 1-10 | 90% | 21-86% |
| *Nothing* |  | 1-10 | 10% | 79-14% |

## Quests

Shad is not used in any [quests](/Quests "Quests").

## History

* [1.4](/Version_History#1.4 "Version History"): Added iridium quality. Can now be used in [Tailoring](/Tailoring "Tailoring").
* [1.5](/Version_History#1.5 "Version History"): Is now used in a remixed bundle.
