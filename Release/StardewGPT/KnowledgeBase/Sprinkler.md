...
| --- | --- |
| Sprinkler | |
| [Sprinkler.png](/File:Sprinkler.png) | |
| Waters the 4 adjacent tiles every morning. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | data-sort-value="100">Gold.png100g |
| Crafting | |
| Recipe Source | [Farming Skill Icon.png](/File:Farming_Skill_Icon.png) [Farming](/Farming "Farming") Level 2 |
| Ingredients | Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (1)Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (1) |

:   *This article is about the specific item. For all types of sprinklers, see [Crafting#Sprinklers](/Crafting#Sprinklers "Crafting").*

The **Sprinkler** is a [crafted](/Crafting "Crafting") item that waters 4 tiles (above, below, and to the right and left of it) every morning. Only tilled tiles will be watered. The Sprinkler is unlocked at [Farming](/Farming "Farming") level 2.

[Sprinklers](/Crafting#Sprinklers "Crafting") can water [Slime Hutch](/Slime_Hutch "Slime Hutch") troughs, but cannot be used to water [Garden Pots](/Garden_Pot "Garden Pot") or the [pet's](/Animals#Cat_or_Dog "Animals") water bowl. Sprinklers cannot be placed on sand.

A [Torch](/Torch "Torch") can be placed on a Sprinkler to provide minimal lighting in the dark.

[![Sprinklerexample.png](/mediawiki/images/thumb/2/2b/Sprinklerexample.png/140px-Sprinklerexample.png)](/File:Sprinklerexample.png)

## Types

| Image | Name | Description | Ingredients | Recipe Source |
| --- | --- | --- | --- | --- |
| [Sprinkler.png](/File:Sprinkler.png) | Sprinkler | Waters the 4 adjacent tiles every morning. | Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (1)Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (1) | Farming Skill Icon.png [Farming](/Farming "Farming") Level 2 |
...
The Sprinkler is not used in any [bundles](/Bundles "Bundles").

## Quests

The Sprinkler is not used in any [quests](/Quests "Quests").
...
| [Sprinklers](/Crafting#Sprinklers "Crafting") | [Iridium Sprinkler](/Iridium_Sprinkler "Iridium Sprinkler") • [Quality Sprinkler](/Quality_Sprinkler "Quality Sprinkler") • Sprinkler |
