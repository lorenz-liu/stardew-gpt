...
| --- | --- |
| Barbed Hook | |
| [Barbed Hook.png](/File:Barbed_Hook.png) | |
| Makes your catch more secure, causing the "fishing bar" to cling to your catch. Works best on slow, weak fish. | |
| Information | |
| Source | * [Fish Shop](/Fish_Shop "Fish Shop") * [Crafting](/Crafting "Crafting") * [Festival of Ice](/Festival_of_Ice "Festival of Ice") |
| Sell Price | data-sort-value="500">Gold.png500g |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 8) |
| Ingredients | Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (1)Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (1)Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (1) |

The **Barbed Hook** is a [tackle](/Tackle "Tackle") that helps fishing by keeping the fishing bar attached to the catch. It can be [crafted](/Crafting "Crafting") or purchased from [Willy's Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="1000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,000g after reaching [Fishing level 8](/Fishing#Fishing_Skill "Fishing"). It may also randomly appear at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="500"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,500–2,500g. A Barbed Hook is one of the rewards the player gets the first time they win the fishing competition at the [Festival of Ice](/Festival_of_Ice "Festival of Ice").

Using two Barbed Hooks on an [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") causes the fishing bar to cling more effectively to the catch compared to using one.
...
The Barbed Hook is not used in any [bundles](/Bundles "Bundles").

## Quests

The Barbed Hook is not used in any [quests](/Quests "Quests").

## Notes

* The fishing bar can be moved manually while a Barbed Hook is in use, although it is more difficult, especially with slower fish. The more the fish darts up and down, the easier it is to move the fishing bar manually, and the less effective the Barbed Hook is.
* Crafting and selling a Barbed Hook is data-sort-value="70">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)70g more profitable than selling 1 Copper Bar, 1 Iron Bar, and 1 Gold Bar without the [Blacksmith Profession](/Mining#Mining_Skill "Mining"). With the Blacksmith Profession, it is more profitable to sell the bars individually instead of crafting a Barbed Hook.

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): Using two Barbed Hooks causes the fishing bar to cling even more effectively to the catch.
