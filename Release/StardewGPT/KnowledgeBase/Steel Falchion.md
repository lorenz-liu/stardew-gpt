...
| --- | --- |
| Steel Falchion | |
| [Steel Falchion.png](/File:Steel_Falchion.png) | |
| Light and powerful. | |
| Information | |
| Type: | Sword |
| Level: | 8 |
| Source: | * [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") * Floor 110 of [The Mines](/The_Mines "The Mines") (remixed) * [The Mines](/The_Mines "The Mines") (Floors 100-119) * [Skull Cavern](/Skull_Cavern "Skull Cavern") * [Quarry Mine](/Quarry_Mine "Quarry Mine") |
| Damage: | 28-46 |
| Critical Strike Chance: | .02 |
| Stats: | Speed w.png [Speed](/Speed "Speed") (+4)Crit. Power.png [Crit. Power](/Crit._Power "Crit. Power") (+20) |
| Adventurer's Guild | |
| Purchase Price: | data-sort-value="9000">Gold.png9,000g |
| Sell Price: | data-sort-value="400">Gold.png400g |

The **Steel Falchion** is a [sword weapon](/Weapons#Sword "Weapons") that can be purchased from the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") for data-sort-value="9000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)9,000g after reaching floor 90 in [The Mines](/The_Mines "The Mines"). It can also be obtained as a [special item drop](/The_Mines#Special_Items "The Mines") on Floors 100-119 of [The Mines](/The_Mines "The Mines"), in the [Skull Cavern](/Skull_Cavern "Skull Cavern")[[1]](#cite_note-specialitem-1), or in the [Quarry Mine](/Quarry_Mine "Quarry Mine") by killing [special monsters](/The_Mines#Special_Items "The Mines") or by breaking [crates and barrels](/The_Mines#Crates_and_Barrels "The Mines"). It is a possible reward for the chest on floor 110 of the Mines if "remixed" mine rewards are selected in the [Advanced Options](/Options "Options") menu when starting a new game.

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.4](/Version_History#1.4 "Version History"): Damage changed from 26-38 to 28-46. Level increased from 14 to 16, sell price increased from data-sort-value="700">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)700g to data-sort-value="800">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)800g.
* [1.5](/Version_History#1.5 "Version History"): Level lowered from 16 to 8 and sell price lowered from data-sort-value="800">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)800g to data-sort-value="400">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)400g.

## References

1. [↑](#cite_ref-specialitem_1-0) See `MineShaft::getSpecialItemForThisMineLevel` in the game code.
