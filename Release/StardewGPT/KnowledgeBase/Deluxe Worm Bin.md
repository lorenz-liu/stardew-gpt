...
| --- | --- |
| Deluxe Worm Bin | |
| [Deluxe Worm Bin.png](/File:Deluxe_Worm_Bin.png) | |
| Produces Deluxe Bait on a regular basis. The worms are self-sufficient. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 8) |
| Ingredients | Worm Bin.png [Worm Bin](/Worm_Bin "Worm Bin") (1)Moss.png [Moss](/Moss "Moss") (30) |
| Produces | Deluxe Bait.png [Deluxe Bait](/Deluxe_Bait "Deluxe Bait") (4-5 daily) |

:   *See also: [Worm Bin](/Worm_Bin "Worm Bin").*

The **Deluxe Worm Bin** is a [craftable item](/Crafting "Crafting") that can be used to create [Deluxe Bait](/Deluxe_Bait "Deluxe Bait") for [fishing](/Fishing "Fishing"). The [crafting](/Crafting "Crafting") recipe is unlocked at [Fishing level 8](/Fishing#Fishing_Skill "Fishing").
