...
| --- | --- |
| Stone Golem (dangerous) | |
| [Stone Golem Dangerous Anim.gif](/File:Stone_Golem_Dangerous_Anim.gif) | |
| Information | |
...
| Speed: | 2 |
| XP: | 5 |
| Variations: | Iridium Golem.png [Iridium Golem](/Iridium_Golem "Iridium Golem")Stone Golem.png [Stone Golem](/Stone_Golem "Stone Golem")Wilderness Golem.png [Wilderness Golem](/Wilderness_Golem "Wilderness Golem") |
| Drops: | Coal.png [Coal](/Coal "Coal") (10%)Dwarf Scroll I.png [Dwarf Scroll I](/Dwarf_Scroll_I "Dwarf Scroll I") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)Iron Ore.png [Iron Ore](/Iron_Ore "Iron Ore") (10%)Quartz.png [Quartz](/Quartz "Quartz") (10%)Stone.png [Stone](/Stone "Stone") (90%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Stone Golems (dangerous)** are an [enemy](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") after activating the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") or during the [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") quest.

## Behavior

They behave identically to their weaker counterpart the [Stone Golem](/Stone_Golem "Stone Golem"). Mostly hidden by the walls with their dark colors, they wander aimlessly, but damage the player if they collide. They have glowing eyes.
