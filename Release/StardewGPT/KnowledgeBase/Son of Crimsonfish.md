...
| --- | --- |
| Son of Crimsonfish | |
| [Son of Crimsonfish.png](/File:Son_of_Crimsonfish.png) | |
...
| Size (inches) | 19–21 |
| Fishing XP | 34   Silver Quality.png 37   Gold Quality.png 40   Iridium Quality.png 46 |
...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Son of Crimsonfish.png | 1,500g | | Son of Crimsonfish.png  Silver Quality Icon.png | 1,875g | | Son of Crimsonfish.png  Gold Quality Icon.png | 2,250g | | Son of Crimsonfish.png  Iridium Quality Icon.png | 3,000g | | |  |  | | --- | --- | | Son of Crimsonfish.png | 1,875g | | Son of Crimsonfish.png  Silver Quality Icon.png | 2,343g | | Son of Crimsonfish.png  Gold Quality Icon.png | 2,812g | | Son of Crimsonfish.png  Iridium Quality Icon.png | 3,750g | | |  |  | | --- | --- | | Son of Crimsonfish.png | 2,250g | | Son of Crimsonfish.png  Silver Quality Icon.png | 2,812g | | Son of Crimsonfish.png  Gold Quality Icon.png | 3,375g | | Son of Crimsonfish.png  Iridium Quality Icon.png | 4,500g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Red Roe.png | 780g | | |  |  | | --- | --- | | Red Aged Roe.png | 1,560g | | |  |  | | --- | --- | | Red Aged Roe.png | 2,184g | | | |

The **Son of Crimsonfish** is one of the five [Legendary Fish](/Fish#Legendary_Fish_II "Fish") that must be caught for [Mr. Qi](/Mr._Qi "Mr. Qi")'s [Extended Family Quest](/Quests#Extended_Family "Quests"). It has the same sell price, healing effect, location, and chance of hooking as the [Crimsonfish](/Crimsonfish "Crimsonfish"). It can only be caught when the quest is active, but more than one can be caught per quest.

## Map

Son of Crimsonfish can be found in the ocean at [the beach](/The_Beach "The Beach") on the eastern pier.

![Maplocation.png](/mediawiki/images/thumb/5/5c/Maplocation.png/20px-Maplocation.png)

![Map.png](/mediawiki/images/4/43/Map.png)

[![CrimsonfishLocations.png](/mediawiki/images/thumb/0/02/CrimsonfishLocations.png/300px-CrimsonfishLocations.png)](/File:CrimsonfishLocations.png)
...
Son of Crimsonfish is not used in any [bundles](/Bundles "Bundles").
...
The Son of Crimsonfish can be used as a red dye in the dye pots, located at [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Fish Pond

Son of Crimsonfish can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"). The pond capacity is 1 fish and this cannot be increased. The only possible output is Son of Crimsonfish [Roe](/Roe "Roe").

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Red Roe.png [Roe](/Roe "Roe") (1-2) | 42 | 1 | 84% | 42% |
| *Nothing* |  | 1 | 16% | 58% |

## Quests

Son of Crimsonfish must be caught for the [Extended Family Quest](/Quests#Extended_Family "Quests").

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): Legendary Fish II [Roe](/Roe "Roe") now obtainable by the power from the [Jewels Of The Sea](/Jewels_Of_The_Sea "Jewels Of The Sea") book. Introduced bug preventing the fish being caught during the [Night Market](/Night_Market "Night Market").
* [1.6.9](/Version_History#1.6.9 "Version History"): Can now be placed in a [Fish Pond](/Fish_Pond "Fish Pond"). Fixed bug where it was not possible to catch the Son of Crimsonfish during the [Night Market](/Night_Market "Night Market").
