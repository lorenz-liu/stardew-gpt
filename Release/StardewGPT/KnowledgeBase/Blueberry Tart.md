...
| --- | --- |
| Blueberry Tart | |
| [Blueberry Tart.png](/File:Blueberry_Tart.png) | |
...
Blueberry Tart is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Blueberry Tart is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt016.png](/mediawiki/images/thumb/b/b0/Shirt016.png/24px-Shirt016.png) [Night Sky Shirt](/Tailoring "Tailoring"). It is a blue dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed. It can be placed in the blue dye pot at Emily's and Haley's house for use in [dyeing](/Dyeing "Dyeing").

## Quests

Blueberry Tart is not used in any [quests](/Quests "Quests").

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.1](/Version_History#1.1 "Version History"): Reduced value to data-sort-value="150">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)150g, down from data-sort-value="180">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)180g.
