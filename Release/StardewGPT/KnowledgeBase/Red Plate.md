...
| --- | --- |
| Red Plate | |
| [Red Plate.png](/File:Red_Plate.png) | |
| Full of antioxidants. | |
| Information | |
| Source | [Cooking](/Cooking "Cooking") |
| Buff(s) | Max Energy.png [Max Energy](/Energy "Energy") (+50) |
| Buff Duration | Time Icon.png 3m 30s |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 240 | Health.png | 108 | |
| Sell Price | |  |  | | --- | --- | | Red Plate.png | 400g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 432 | Health.png  Gold Quality Icon.png | 194 | |  | |  |  | | --- | --- | | Red Plate.png  Gold Quality Icon.png | 600g | | |
| Recipe | |
| Recipe Source(s) | Emily Icon.png [Emily](/Emily "Emily") (Mail - 7+ HeartIconLarge.png) |
| Ingredients | Red Cabbage.png [Red Cabbage](/Red_Cabbage "Red Cabbage") (1)Radish.png [Radish](/Radish "Radish") (1) |

**Red Plate** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").
...
Red Plate may randomly appear in [Krobus](/Krobus "Krobus")' shop on [Saturdays](/Days_of_the_Week#Saturday "Days of the Week"), in the [Garbage Can](/Garbage_Can "Garbage Can") outside the saloon, in the [Traveling Cart](/Traveling_Cart "Traveling Cart"), or in [the Stardrop Saloon](/The_Stardrop_Saloon "The Stardrop Saloon")'s rotating stock. One Red Plate may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").
...
Red Plate is not used in any [bundles](/Bundles "Bundles").
...
Red Plate is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Red Tuxedo](/Tailoring "Tailoring"). [![Shirt184.png](/mediawiki/images/thumb/2/25/Shirt184.png/24px-Shirt184.png)](/File:Shirt184.png) It can also be used as a red dye in the dye pots, located in [Haley](/Haley "Haley")'s and [Emily](/Emily "Emily")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Red Plate is not used in any [quests](/Quests "Quests").
