...
| --- | --- |
| Big Chest | |
| [Big Chest.png](/File:Big_Chest.png) | |
...
| Ingredients | Wood.png [Wood](/Wood "Wood") (120)Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (2) |

The **Big Chest** is a storage item that holds up to 70 different types of items, which is nearly double that of the regular [chest](/Chest "Chest") which holds 36 different items. Using it on a regular [chest](/Chest "Chest") or [stone chest](/Stone_Chest "Stone Chest") replaces it, keeping the contents inside and dropping the old chest.
...
| [Storage](/Crafting#Storage_Equipment "Crafting") | | Big Chest • [Big Stone Chest](/Big_Stone_Chest "Big Stone Chest") • [Chest](/Chest "Chest") • [Junimo Chest](/Junimo_Chest "Junimo Chest") • [Mini-Fridge](/Mini-Fridge "Mini-Fridge") • [Stone Chest](/Stone_Chest "Stone Chest") |
