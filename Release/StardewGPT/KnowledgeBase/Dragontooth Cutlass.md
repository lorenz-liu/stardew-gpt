...
| --- | --- |
| Dragontooth Cutlass | |
| [Dragontooth Cutlass.png](/File:Dragontooth_Cutlass.png) | |
| The blade was forged from a magical tooth. | |
| Information | |
| Type: | Sword |
| Level: | 13 |
| Source: | Chests in [Volcano Dungeon](/Volcano_Dungeon "Volcano Dungeon") |
| Damage: | 75-90 |
| Critical Strike Chance: | .02 |
| Stats: | Crit. Power.png [Crit. Power](/Crit._Power "Crit. Power") (+50) |
| Adventurer's Guild | |
| Purchase Price: | N/A |
| Sell Price: | data-sort-value="650 ">Gold.png650g |

The **Dragontooth Cutlass** is a [sword weapon](/Weapons#Sword "Weapons") that can be obtained by opening chests in the [Volcano Dungeon](/Volcano_Dungeon "Volcano Dungeon").
