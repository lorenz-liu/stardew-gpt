...
| Sell Price | data-sort-value="120 ">Gold.png120g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="156 ">Gold.png156g |

**Pyrite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Pyrite is not used in any [bundles](/Bundles "Bundles").
...
Pyrite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Jester Shirt](/Tailoring "Tailoring"). [![Shirt192.png](/mediawiki/images/thumb/2/25/Shirt192.png/24px-Shirt192.png)](/File:Shirt192.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as a yellow dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Pyrite is not used in any [quests](/Quests "Quests").
