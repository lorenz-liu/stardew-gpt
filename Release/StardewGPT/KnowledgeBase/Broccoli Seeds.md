...
| --- | --- |
| Broccoli Seeds | |
| [Broccoli Seeds.png](/File:Broccoli_Seeds.png) | |
| Plant in the fall. Takes 8 days to mature, and continues to produce after first harvest. | |
| Information | |
| Crop: | Broccoli.png [Broccoli](/Broccoli "Broccoli") |
| Growth Time: | 8 days |
...
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | Not sold |

**Broccoli Seeds** are a type of seed. Mature plants yield [Broccoli](/Broccoli "Broccoli").

They cannot be purchased using ![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/24px-Gold.png) [Gold](/Gold "Gold") from any traditional store, and are instead found in various other ways:[[1]](#cite_note-raccoonseeds-1)

* Digging up [Seed Spots](/Seed_Spot "Seed Spot").
* Completing [Raccoon](/Giant_Stump "Giant Stump") requests.
* Trading at the [Raccoon Wife's Shop](/Giant_Stump#Raccoon_Wife.27s_Shop "Giant Stump") for 5 ![Moss.png](/mediawiki/images/thumb/6/64/Moss.png/24px-Moss.png) [Moss](/Moss "Moss").
* Catching [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") (7% chance).[[2]](#cite_note-chestchance-2)
* Using the [Seed Maker](/Seed_Maker "Seed Maker").
* As the first prize from the Prize Machine in the [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor").
* Opening [Mystery Boxes](/Mystery_Box "Mystery Box") or [Golden Mystery Boxes](/Golden_Mystery_Box "Golden Mystery Box").
* Breaking open [crates and barrels](/The_Mines#Crates_and_Barrels "The Mines") in [the Mines](/The_Mines "The Mines"), [Skull Cavern](/Skull_Cavern "Skull Cavern"), or [Volcano Dungeon](/Volcano_Dungeon "Volcano Dungeon") (2% chance).[[3]](#cite_note-containerchance-3)
* Slaying [Iridium Golems](/Iridium_Golem "Iridium Golem") (50% chance).[[4]](#cite_note-golemchance-4)

All methods, other than trading at the Raccoon Wife's Shop and using the Seed Maker, only yield Broccoli Seeds between [Summer](/Summer "Summer") 21 and [Fall](/Fall "Fall") 20.

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Harvest | After-Harvest |
| --- | --- | --- | --- | --- | --- |
| Broccoli Stage 1.png | Broccoli Stage 2.png | Broccoli Stage 3.png | Broccoli Stage 4.png | Broccoli Stage 5.png | Broccoli Stage 4.png |
...
Broccoli Seeds are not used in any [tailoring](/Tailoring "Tailoring"). They can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane"). They can also be used as a brown dye when used in the spool of the [Sewing Machine](/Sewing_Machine "Sewing Machine") with a dyeable clothing item in the feed.

## References

1. [↑](#cite_ref-raccoonseeds_1-0) See `Utility::getRaccoonSeedForCurrentTimeOfYear` in the game code.
2. [↑](#cite_ref-chestchance_2-0) See `FishingRod::openTreasureMenuEndFunction` in the game code.
3. [↑](#cite_ref-containerchance_3-0) See `BreakableContainer::releaseContents` in the game code.
