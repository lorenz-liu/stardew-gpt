...
| Information | |
| Source | [Cooking](/Cooking "Cooking") Iridium Crab.png [Iridium Crab](/Iridium_Crab "Iridium Crab") (50%) |
| Buff(s) | Speed.png [Speed](/Speed "Speed") (+1)Defense.png [Defense](/Defense "Defense") (+1) |
| Buff Duration | Time Icon.png 16m 47s |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 225 | Health.png | 101 | |
| Sell Price | |  |  | | --- | --- | | Crab Cakes.png | 275g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 405 | Health.png  Gold Quality Icon.png | 182 | |  | |  |  | | --- | --- | | Crab Cakes.png  Gold Quality Icon.png | 412g | | |
| Recipe | |
| Recipe Source(s) | |  |  | | --- | --- | | Cooking Channel.png | [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") | | 21 Fall, Year 2 | |
| Ingredients | Crab.png [Crab](/Crab "Crab") (1)Wheat Flour.png [Wheat Flour](/Wheat_Flour "Wheat Flour") (1)Egg.png [Egg](/Egg "Egg") (1)Oil.png [Oil](/Oil "Oil") (1) |

**Crab Cakes** are a [cooked dish](/Cooking "Cooking"). They are prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").

[Iridium Crabs](/Iridium_Crab "Iridium Crab") in the [Skull Cavern](/Skull_Cavern "Skull Cavern") may drop Crab Cakes when slain (50% chance). [Gus](/Gus "Gus") will also sell an unlimited number of Crab Cakes at [The Stardrop Saloon](/The_Stardrop_Saloon "The Stardrop Saloon") for data-sort-value="550">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)550g each for approximately 4 days after viewing [Willy](/Willy "Willy")'s 6-heart cutscene. It is also sold by the [Calico Egg Merchant](/Desert_Festival#Calico_Egg_Merchant "Desert Festival") in the [Desert Festival](/Desert_Festival "Desert Festival") for data-sort-value="10">![Calico Egg.png](/mediawiki/images/thumb/d/da/Calico_Egg.png/24px-Calico_Egg.png) 10 [Calico Eggs](/Calico_Egg "Calico Egg"). 5 Crab Cakes can be obtained as a prize from the [Prize Machine](/Mayor%27s_Manor#Prize_Machine "Mayor's Manor"). One Crab Cakes may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").

## Gifting

| Villager Reactions | |
| --- | --- |
| Love | [Elliott Icon.png](/Elliott "Elliott") [Elliott](/Elliott "Elliott") |
...
Crab Cakes are not used in any [bundles](/Bundles "Bundles").

## Tailoring

Crab Cakes are used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Crab Cake Shirt](/Tailoring "Tailoring"). [![Shirt276.png](/mediawiki/images/thumb/0/05/Shirt276.png/24px-Shirt276.png)](/File:Shirt276.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Crab Cakes are not used in any [quests](/Quests "Quests").
