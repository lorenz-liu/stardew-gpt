...
| --- | --- |
| Basic Retaining Soil | |
| [Basic Retaining Soil.png](/File:Basic_Retaining_Soil.png) | |
...
| Sell Price | data-sort-value="4">Gold.png4g |
| Recipe | |
| Recipe Source(s) | Farming Skill Icon.png [Farming](/Farming "Farming") Level 4 |
| Ingredients | Stone.png [Stone](/Stone "Stone") (2) |

**Basic Retaining Soil** is a [Fertilizer](/Fertilizer "Fertilizer") that has a chance to keep soil watered. It can be [crafted](/Crafting "Crafting") or purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") for data-sort-value="100">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100g starting on Spring 15th of year 1.[[1]](#cite_note-unlock-1)
