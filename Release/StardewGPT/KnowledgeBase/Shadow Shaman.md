...
| --- | --- |
| Shadow Shaman | |
| [Shadow Shaman Anim.gif](/File:Shadow_Shaman_Anim.gif) | |
| Information | |
...
| Speed: | 3 |
| XP: | 15 |
| Variations: | Shadow Shaman Dangerous.png [Shadow Shaman (dangerous)](/Shadow_Shaman_(dangerous) "Shadow Shaman (dangerous)") |
| Drops: | Coal.png [Coal](/Coal "Coal") (1-3, 10%)Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (4%)Dwarf Scroll III.png [Dwarf Scroll III](/Dwarf_Scroll_III "Dwarf Scroll III") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (1%)Iridium Bar.png [Iridium Bar](/Iridium_Bar "Iridium Bar") (0.2%)Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (2%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%)Rare Disc.png [Rare Disc](/Rare_Disc "Rare Disc") (0.3%)Void Essence.png [Void Essence](/Void_Essence "Void Essence") (75%)Void Essence.png [Void Essence](/Void_Essence "Void Essence") (20%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Shadow Shaman** are void spirit [Monsters](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") after floor 80. 150 void spirits (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild"). Both Shadow Shaman and [Shadow Brutes](/Shadow_Brute "Shadow Brute") are counted toward this goal.

## Behavior

Shadow Shaman are magic users, with a healing spell that heals the Shadow Shaman itself and all enemies in the immediate area by 60 health points. They also shoot a small green fireball that bounces around and gives the player the [![Jinxed.png](/mediawiki/images/thumb/5/5d/Jinxed.png/24px-Jinxed.png)](/Buffs#Jinxed "Buffs#Jinxed") [Jinxed](/Buffs#Jinxed "Buffs") debuff when hit, which lowers the player's [Defense](/Defense "Defense") by 8. Players can increase their chances of avoiding the jinxed debuff when hit by a fireball by wearing [footwear](/Footwear "Footwear") that increases [immunity](/Immunity "Immunity"). A ring of leaves appears around a Shadow Shaman when it is about to cast a spell.

Shadow Shaman can also come towards you similarly to a [Shadow Brute](/Shadow_Brute "Shadow Brute") and damage you if they touch you.
...
| --- | --- |
| [Mines](/The_Mines "The Mines") | [Bats](/Bats "Bats") • [Bug](/Bug "Bug") • [Cave Fly](/Cave_Fly "Cave Fly") • [Duggy](/Duggy "Duggy") • [Dust Sprite](/Dust_Sprite "Dust Sprite") • [Ghost](/Ghost "Ghost") • [Grub](/Grub "Grub") • [Lava Crab](/Lava_Crab "Lava Crab") • [Metal Head](/Metal_Head "Metal Head") • [Rock Crab](/Rock_Crab "Rock Crab") • [Shadow Brute](/Shadow_Brute "Shadow Brute") • Shadow Shaman • [Skeleton](/Skeleton "Skeleton") • [Slimes](/Slimes "Slimes") • [Squid Kid](/Squid_Kid "Squid Kid") • [Stone Golem](/Stone_Golem "Stone Golem") |
