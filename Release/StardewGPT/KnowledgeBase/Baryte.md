...
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="65 ">Gold.png65g |

**Baryte** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Magma Geode](/Magma_Geode "Magma Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Baryte is not used in any [bundles](/Bundles "Bundles").
...
Baryte is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt181.png](/mediawiki/images/thumb/a/ad/Shirt181.png/24px-Shirt181.png)](/File:Shirt181.png) It can be also used as a red dye color at the dye pots in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Baryte is not used in any [quests](/Quests "Quests").
