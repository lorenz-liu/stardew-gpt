...
| Ingredients | Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (2) |

The **Spinner** is a [tackle](/Tackle "Tackle") that helps [fishing](/Fishing "Fishing") by reducing maximum delay before a nibble by 3.75 seconds (7.5 seconds if the player is using an [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") with 2 Spinners). It can be [crafted](/Crafting "Crafting") or purchased from [Willy's Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)500g after reaching [Fishing level 6](/Fishing#Fishing_Skill "Fishing"). It may also randomly appear at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="250"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)750–1,250g.
...
The Spinner is not used in any [bundles](/Bundles "Bundles").

## Quests

The Spinner is not used in any [quests](/Quests "Quests").

## Notes

* This recipe is profitable when the player doesn't have the [Blacksmith profession](/Mining#Mining_Skill "Mining"). It will result in a profit of data-sort-value="10">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)10g, while with the Blacksmith profession it results in a loss of data-sort-value="-110">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)-110g.

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): Reduces maximum delay before a nibble by 7.5 seconds when two Spinners are equipped at once.
