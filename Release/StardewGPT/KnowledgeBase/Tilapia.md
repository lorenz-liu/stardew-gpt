...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Tilapia.png | 75g | | Tilapia.png  Silver Quality Icon.png | 93g | | Tilapia.png  Gold Quality Icon.png | 112g | | Tilapia.png  Iridium Quality Icon.png | 150g | | |  |  | | --- | --- | | Tilapia.png | 93g | | Tilapia.png  Silver Quality Icon.png | 116g | | Tilapia.png  Gold Quality Icon.png | 140g | | Tilapia.png  Iridium Quality Icon.png | 187g | | |  |  | | --- | --- | | Tilapia.png | 112g | | Tilapia.png  Silver Quality Icon.png | 139g | | Tilapia.png  Gold Quality Icon.png | 168g | | Tilapia.png  Iridium Quality Icon.png | 225g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Dark Gray Roe.png | 67g | | |  |  | | --- | --- | | Dark Gray Aged Roe.png | 134g | | |  |  | | --- | --- | | Dark Gray Aged Roe.png | 187g | | | |

The **Tilapia** is a [fish](/Fish "Fish") that can be caught in the ocean at [The Beach](/The_Beach "The Beach") or on the [Beach Farm](/Farm_Maps#Beach "Farm Maps") during [Summer](/Summer "Summer") and [Fall](/Fall "Fall") between 6am and 2pm. It can also be caught during any season on [Ginger Island](/Ginger_Island "Ginger Island") West (freshwater) or North. It may also randomly appear in [Krobus](/Krobus "Krobus")' shop on [Wednesdays](/Days_of_the_Week#Wednesday "Days of the Week") for data-sort-value="200">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)200g, or at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="75"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)225–1,000g.

Tilapia can be caught regardless of time of day or season using [Magic Bait](/Magic_Bait "Magic Bait").
...
Tilapia is used in the ![Bundle Blue.png](/mediawiki/images/thumb/e/e4/Bundle_Blue.png/24px-Bundle_Blue.png) [Ocean Fish Bundle](/Bundles#Ocean_Fish_Bundle "Bundles") in the [Fish Tank](/Bundles#Fish_Tank "Bundles").
...
Tilapia can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [Sailor Shirt](/Tailoring "Tailoring"). [![Shirt259a.png](/mediawiki/images/thumb/3/36/Shirt259a.png/24px-Shirt259a.png)](/File:Shirt259a.png)

## Fish Pond

Tilapia can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"), where they will reproduce every 2 days. The initial pond capacity is 3 fish, but the capacity can be increased to 10 by completing three quests. The only possible output is dark gray Tilapia [Roe](/Roe "Roe").
...
| --- | --- | --- | --- | --- |
| Dark Gray Roe.png [Roe](/Roe "Roe") (1) | 12 | 1-4 | 70% | 16-33% |
| 5-10 | 100% | 55-95% |
...
* **Aquatic Overpopulation:** [Demetrius](/Demetrius "Demetrius") may request 10 Tilapia to be caught in [Summer](/Summer "Summer") at the [Special Orders board](/Quests#List_of_Special_Orders "Quests") outside the [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor") for a reward of gold equivalent to selling the fish and the [Farm Computer](/Farm_Computer "Farm Computer") recipe.

## History

* [1.4](/Version_History#1.4 "Version History"): Added iridium quality. Can now be used in [Tailoring](/Tailoring "Tailoring").
* [1.5](/Version_History#1.5 "Version History"): Special Order quest added. Can now be caught at Ginger Island during any season on Island West (freshwater) and North.
