...
| --- | --- |
| Beet Seeds | |
| [Beet Seeds.png](/File:Beet_Seeds.png) | |
| Plant these in the fall. Takes 6 days to mature. | |
| Information | |
| Crop: | Beet.png [Beet](/Beet "Beet") |
| Growth Time: | 6 days |
...
| Sandy Icon.png [Oasis](/Oasis "Oasis"): | data-sort-value="20">Gold.png20g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="10"Gold.png100–1,000g |

**Beet Seeds** are a type of seed. Mature plants yield [Beets](/Beet "Beet").

They can be purchased at the [Oasis](/Oasis "Oasis") and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker"). Five to twenty Beet Seeds may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern.

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Harvest |
| --- | --- | --- | --- | --- |
| Beet Stage 1.png | Beet Stage 2.png | Beet Stage 3.png | Beet Stage 4.png | Beet Stage 5.png |
