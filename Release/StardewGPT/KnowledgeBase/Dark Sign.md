...
| --- | --- |
| Dark Sign | |
| [Dark Sign.png](/File:Dark_Sign.png) | |
| Use an item on this to change what's displayed. The item won't be consumed. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Krobus Icon.png [Krobus](/Krobus "Krobus") (Mail - 3+ HeartIconLarge.png) |
| Ingredients | Bat Wing.png [Bat Wing](/Bat_Wing "Bat Wing") (5)Bone Fragment.png [Bone Fragment](/Bone_Fragment "Bone Fragment") (5) |

The **Dark Sign** is a [craftable](/Crafting "Crafting") item that can display the image of any item that can be held in [inventory](/Inventory "Inventory"). Similar to the [Wood Sign](/Wood_Sign "Wood Sign") and [Stone Sign](/Stone_Sign "Stone Sign"), an image can be placed on the sign by holding an item in inventory and right-clicking on the sign. The item will not be consumed.

Dark Signs can be placed anywhere in Stardew Valley, indoors or outdoors. If placed in a villager's path, the sign will be destroyed. See "[Crafted goods outside the farm](/Crafting#Crafted_goods_outside_the_farm "Crafting")" for maps of areas safe from villager pathing.

Placing a Dark Sign on a [Fish Pond](/Fish_Pond "Fish Pond") will turn it into a counter of how many [fish](/Fish "Fish") are inside, with an image of the fish visible on the sign, and the number of fish in the pond in the lower right corner.
...
| [Signs](/Crafting#Signs "Crafting") | | Dark Sign • [Stone Sign](/Stone_Sign "Stone Sign") • [Text Sign](/Text_Sign "Text Sign") • [Wood Sign](/Wood_Sign "Wood Sign") |
