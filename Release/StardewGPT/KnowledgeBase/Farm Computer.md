...
| --- | --- |
| Farm Computer | |
| [Farm Computer.png](/File:Farm_Computer.png) | |
| Scans the farm and displays useful information. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Demetrius Icon.png [Special Order](/Quests#List_of_Special_Orders "Quests") |
| Ingredients | Dwarf Gadget.png [Dwarf Gadget](/Dwarf_Gadget "Dwarf Gadget") (1)Battery Pack.png [Battery Pack](/Battery_Pack "Battery Pack") (1)Refined Quartz.png [Refined Quartz](/Refined_Quartz "Refined Quartz") (10) |

The **Farm Computer** is a piece of [craftable equipment](/Crafting "Crafting") for displaying information about the current location. The player receives the recipe after completing either the ["Biome Balance"](/Quests#Biome_Balance "Quests") or ["Aquatic Overpopulation"](/Quests#Aquatic_Overpopulation "Quests") special orders for [Demetrius](/Demetrius "Demetrius").

The Farm Computer can be placed anywhere, and the information displayed depends on its location.

## Information

When activated, the displayed title shows the current location (*e.g.,* Pelican Town Analysis) or "Location Analysis". Items specific to the main farm (*e.g.,* pieces of hay) do not show in other locations.

### The Farm

[![](/mediawiki/images/thumb/2/2c/Farm_Computer_Status_Display.png/200px-Farm_Computer_Status_Display.png)](/File:Farm_Computer_Status_Display.png)

Farm Computer status display

* [Pieces of Hay](/Silo "Silo")
* Total [Crops](/Crops "Crops")
* Crops Ready
* Unwatered Crops
* Crops Ready In [Greenhouse](/Greenhouse "Greenhouse")
* Open Tilled Soil
* [Forage](/Forage "Forage") Items
* Machines Ready
* [Farm Cave](/The_Cave "The Cave") Status

## Notes

* Crops grown from seasonal [Wild Seeds](/Crafting#Seeds "Crafting") show under "Crops".
* [Auto-Grabbers](/Auto-Grabber "Auto-Grabber") that are not empty count towards the "Machines Ready" count even though they do not show a floating icon like other "ready" machines.

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): The farm computer can now be used anywhere to see a summary of that location, instead of only the farm. Fixed bug where [Fiber Seeds](/Fiber_Seeds "Fiber Seeds") counted as unwatered.
