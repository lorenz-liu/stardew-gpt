...
| --- | --- |
| Mutant Carp | |
| [Mutant Carp.png](/File:Mutant_Carp.png) | |
| The strange waters of the sewer turned this carp into a monstrosity. | |
| Information | |
| Location | [The Sewers](/The_Sewers "The Sewers") |
| Time | Any |
...
| Size (inches) | 35–37 |
| Fishing XP | 145   Silver Quality.png 160   Gold Quality.png 175   Iridium Quality.png 205 |
...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Mutant Carp.png | 1,000g | | Mutant Carp.png  Silver Quality Icon.png | 1,250g | | Mutant Carp.png  Gold Quality Icon.png | 1,500g | | Mutant Carp.png  Iridium Quality Icon.png | 2,000g | | |  |  | | --- | --- | | Mutant Carp.png | 1,250g | | Mutant Carp.png  Silver Quality Icon.png | 1,562g | | Mutant Carp.png  Gold Quality Icon.png | 1,875g | | Mutant Carp.png  Iridium Quality Icon.png | 2,500g | | |  |  | | --- | --- | | Mutant Carp.png | 1,500g | | Mutant Carp.png  Silver Quality Icon.png | 1,875g | | Mutant Carp.png  Gold Quality Icon.png | 2,250g | | Mutant Carp.png  Iridium Quality Icon.png | 3,000g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Green Roe.png | 530g | | |  |  | | --- | --- | | Green Aged Roe.png | 1,060g | | |  |  | | --- | --- | | Green Aged Roe.png | 1,484g | | | |

:   *See also: [Radioactive Carp](/Radioactive_Carp "Radioactive Carp")*

The **Mutant Carp** is a [fish](/Fish "Fish") that can be caught in [The Sewers](/The_Sewers "The Sewers") during all seasons. It is one of the five [Legendary Fish](/Fish#Legendary_Fish "Fish"), so it can only be caught once per [save file](/Saves "Saves"), or once per player in [Multiplayer](/Multiplayer "Multiplayer").

There are no special requirements necessary to hook a Mutant Carp; every cast in the sewers has a 10% chance of hooking one (20% chance if using a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure")).[[1]](#cite_note-placement-1)

Although the Mutant Carp cannot be hooked again after it is caught, it is possible to obtain multiple Mutant Carp (per player) by using [Challenge Bait](/Challenge_Bait "Challenge Bait") to catch it.
...
The Mutant Carp is not used in any [bundles](/Bundles "Bundles").
...
Mutant Carp can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"). The pond capacity is 1 fish and this cannot be increased. The only possible output is Mutant Carp [Roe](/Roe "Roe").

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Green Roe.png [Roe](/Roe "Roe") (1-4) | 32 | 1 | 72% | 36% |
| *Nothing* |  | 1 | 28% | 64% |

## Quests

The Mutant Carp is not used in any [quests](/Quests "Quests").

## References

1. [↑](#cite_ref-placement_1-0) See `Data\Locations.xnb`.

## History

* [1.4](/Version_History#1.4 "Version History"): Added iridium quality.
...
* [1.6](/Version_History#1.6 "Version History"): Fixed bug allowing [Legendary Fish](/Fish#Legendary_Fish "Fish") to be hooked with the [Training Rod](/Training_Rod "Training Rod"). Removed extra 8% chance increase to hook the fish on certain unwalkable tiles. Legendary Fish [Roe](/Roe "Roe") now obtainable by the power from the [Jewels Of The Sea](/Jewels_Of_The_Sea "Jewels Of The Sea") book. Can now obtain multiple Mutant Carp per player using [Challenge Bait](/Challenge_Bait "Challenge Bait").
...
| [Sewers](/The_Sewers "The Sewers") | [Carp](/Carp "Carp") • Mutant Carp • [Radioactive Carp](/Radioactive_Carp "Radioactive Carp") |
