...
| --- | --- |
| Obsidian Edge | |
| [Obsidian Edge.png](/File:Obsidian_Edge.png) | |
| It's incredibly sharp. | |
| Information | |
| Type: | Sword |
| Level: | 6 |
| Source: | Chest at Floor 90 of [The Mines](/The_Mines "The Mines") |
| Damage: | 30-45 |
| Critical Strike Chance: | .02 |
| Stats: | Speed w.png [Speed](/Speed "Speed") (−1)Crit. Power.png [Crit. Power](/Crit._Power "Crit. Power") (+10) |
| Adventurer's Guild | |
| Purchase Price: | data-sort-value="9000">Gold.png9,000g |
| Sell Price: | data-sort-value="300">Gold.png300g |

The **Obsidian Edge** is a [sword weapon](/Weapons#Sword "Weapons") that can be obtained from a chest at floor 90 in [The Mines](/The_Mines "The Mines"). It can also be purchased for data-sort-value="9000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)9,000g from the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") after reaching floor 90 in [The Mines](/The_Mines "The Mines").

## History

* [1.5](/Version_History#1.5 "Version History"): Level lowered from 9 to 6 and sell price lowered from data-sort-value="450">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)450g to data-sort-value="300">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)300g.
