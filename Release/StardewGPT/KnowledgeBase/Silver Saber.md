...
| --- | --- |
| Silver Saber | |
| [Silver Saber.png](/File:Silver_Saber.png) | |
| Plated with silver to deter rust. | |
| Information | |
| Type: | Sword |
| Level: | 2 |
| Source: | [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") after reaching Floor 20 in [The Mines](/The_Mines "The Mines") |
| Damage: | 8-15 |
...
The **Silver Saber** is a [sword weapon](/Weapons#Sword "Weapons") that can be purchased for data-sort-value="750">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)750g from the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") after reaching floor 20 in [The Mines](/The_Mines "The Mines"). It is a possible reward for the chest on floor 50 of the Mines if "remixed" mine rewards are selected in the [Advanced Options](/Options "Options") menu when starting a new game.

## History

* [1.5](/Version_History#1.5 "Version History"): Level lowered from 3 to 2 and sell price lowered from data-sort-value="150">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)150g to data-sort-value="100">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100g. Added as a possible reward on floor 50 in the remixed Mines. Bug where weapon defense had no effect fixed.
