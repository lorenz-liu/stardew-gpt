...
| --- | --- |
| Cherry Sapling | |
| [Cherry Sapling.png](/File:Cherry_Sapling.png) | |
| Takes 28 days to produce a mature Cherry tree. Bears fruit in the spring. Only grows if the 8 surrounding "tiles" are empty. | |
| Information | |
| Crop: | Cherry.png [Cherry](/Cherry "Cherry") |
| Growth Time: | 28 days |
| Season: | Spring.png [Spring](/Spring "Spring") |
| Sell Price: | data-sort-value="850"  |  |  | | --- | --- | | Cherry Sapling.png | 850g | | Cherry Sapling.png  Silver Quality Icon.png | 1,062g | | Cherry Sapling.png  Gold Quality Icon.png | 1,275g | | Cherry Sapling.png  Iridium Quality Icon.png | 1,700g | |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="3400">Gold.png3,400g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | Not Sold |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="850"Gold.png2,550–4,250g |

The **Cherry Sapling** is a [Fruit Tree](/Fruit_Trees "Fruit Trees") sapling that takes 28 days to grow into a [Cherry Tree](/Cherry_Tree "Cherry Tree"), after which it will produce one fruit each day during the [Spring](/Spring "Spring"). Like all Fruit Trees, it will produce fruit all year round if planted in the [Greenhouse](/Greenhouse "Greenhouse").

It can be purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). It may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern. One Cherry Sapling may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 - Spring, Summer, Fall, Winter | Harvest |
| --- | --- | --- | --- | --- | --- |
| Cherry Stage 1.png | Cherry Stage 2.png | Cherry Stage 3.png | Cherry Stage 4.png | Cherry Stage 5.png | Cherry Stage 5 Fruit.png |
| 7 Days | 7 Days | 7 Days | 7 Days | Total: 28 Days | Spring.png [Spring](/Spring "Spring") |
