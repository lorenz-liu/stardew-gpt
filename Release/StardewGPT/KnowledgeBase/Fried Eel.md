...
| --- | --- |
| Fried Eel | |
| [Fried Eel.png](/File:Fried_Eel.png) | |
| Greasy but flavorful. | |
| Information | |
| Source | [Cooking](/Cooking "Cooking") |
| Buff(s) | Luck.png [Luck](/Luck "Luck") (+1) |
| Buff Duration | Time Icon.png 7m |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 75 | Health.png | 33 | |
| Sell Price | |  |  | | --- | --- | | Fried Eel.png | 120g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 135 | Health.png  Gold Quality Icon.png | 60 | |  | |  |  | | --- | --- | | Fried Eel.png  Gold Quality Icon.png | 180g | | |
| Recipe | |
| Recipe Source(s) | George Icon.png [George](/George "George") (Mail - 3+ HeartIconLarge.png) |
| Ingredients | Eel.png [Eel](/Eel "Eel") (1)Oil.png [Oil](/Oil "Oil") (1) |

**Fried Eel** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").

Fried Eel may randomly appear in [Krobus](/Krobus "Krobus")' shop on [Saturdays](/Days_of_the_Week#Saturday "Days of the Week"), in the [Garbage Can](/Garbage_Can "Garbage Can") outside the saloon, or in [the Stardrop Saloon](/The_Stardrop_Saloon "The Stardrop Saloon")'s rotating stock. One Fried Eel may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").
...
Fried Eel is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt055.png](/mediawiki/images/thumb/1/1c/Shirt055.png/24px-Shirt055.png)](/File:Shirt055.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as a yellow dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Fried Eel is not used in any [quests](/Quests "Quests").
