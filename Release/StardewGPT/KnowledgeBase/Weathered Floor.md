...
| --- | --- |
| Weathered Floor | |
| [Weathered Floor.png](/File:Weathered_Floor.png) | |
...
| Crafting | |
| Recipe Source | [Dwarf](/Dwarf "Dwarf") for data-sort-value="500">Gold.png500g |
| Ingredients | Wood.png [Wood](/Wood "Wood") (1) |

The **Weathered Floor** is a [crafted item](/Crafting#Decor "Crafting") used to create decorative paths. It can be displaced by lightning or destroyed by [weeds](/Weeds "Weeds").

The Weathered Floor recipe is sold by the [Dwarf](/Dwarf "Dwarf") for data-sort-value="500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)500g.
...
* [![](/mediawiki/images/thumb/6/6b/Weathered_Floor_Tile.png/120px-Weathered_Floor_Tile.png)](/File:Weathered_Floor_Tile.png)

  Spring, Summer, & Fall
* [![](/mediawiki/images/thumb/2/2b/Weathered_Floor_Tile_Winter.png/120px-Weathered_Floor_Tile_Winter.png)](/File:Weathered_Floor_Tile_Winter.png)
