...
| --- | --- |
| Stonefish | |
| [Stonefish.png](/File:Stonefish.png) | |
| A bizarre fish that's shaped like a brick. | |
| Information | |
| Location | Floor 20 of [The Mines](/The_Mines "The Mines") |
| Time | Any |
...
| Size (inches) | 14–16 |
| Fishing XP | 24   Silver Quality.png 27   Gold Quality.png 30   Iridium Quality.png 36 |
| Energy | *Inedible* |
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Stonefish.png | 300g | | Stonefish.png  Silver Quality Icon.png | 375g | | Stonefish.png  Gold Quality Icon.png | 450g | | Stonefish.png  Iridium Quality Icon.png | 600g | | |  |  | | --- | --- | | Stonefish.png | 375g | | Stonefish.png  Silver Quality Icon.png | 468g | | Stonefish.png  Gold Quality Icon.png | 562g | | Stonefish.png  Iridium Quality Icon.png | 750g | | |  |  | | --- | --- | | Stonefish.png | 450g | | Stonefish.png  Silver Quality Icon.png | 562g | | Stonefish.png  Gold Quality Icon.png | 675g | | Stonefish.png  Iridium Quality Icon.png | 900g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Dark Brown Roe.png | 180g | | |  |  | | --- | --- | | Dark Brown Aged Roe.png | 360g | | |  |  | | --- | --- | | Dark Brown Aged Roe.png | 504g | | | |

The **Stonefish** is a [fish](/Fish "Fish") that can be caught in [The Mines](/The_Mines "The Mines") on the 20th floor during all seasons. The only other fish that can be caught on the 20th floor of the mines is the [Ghostfish](/Ghostfish "Ghostfish").

The chances of hooking a Stonefish depends on fishing level and on the distance from land of the spot fished, increasing by 5% if a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure") is equipped and by 10% if [Stonefish Bait](/Targeted_Bait "Targeted Bait") is equipped. For example, at level 10 fishing and distance of 5, the chances of hooking a Stonefish is 7.5%. This increases to 12.5% with a Curiosity Lure equipped, to 17.5% with Stonefish Bait equipped, and to 22.5% with both a Curiosity Lure and Stonefish Bait equipped.[[1]](#cite_note-mineshaft-1)

The Stonefish and the [Octopus](/Octopus "Octopus") are the only [fish caught with a fishing rod](/Fish#Fishing_Pole_Fish "Fish") that cannot be eaten unless used in a [recipe](/Cooking#Recipes "Cooking").
...
Stonefish is not used in any [bundles](/Bundles "Bundles").
...
Stonefish can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the ![Fishing Hat.png](/mediawiki/images/thumb/d/d8/Fishing_Hat.png/24px-Fishing_Hat.png) [Fishing Hat](/Fishing_Hat "Fishing Hat"). It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Fish Pond

Stonefish can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"), where they will reproduce every 5 days. The initial pond capacity is 1 fish, but the capacity can be increased to 10 by completing four quests. The primary output is dark brown Stonefish [Roe](/Roe "Roe"), but [Copper Ore](/Copper_Ore "Copper Ore") is possible starting at population 3 and several more valuable items are possible starting at population 9.
...
| 1 | 3 | 10 [Copper Ore](/Copper_Ore "Copper Ore") | 45 |
| 3 | 5 | 5 [Earth Crystals](/Earth_Crystal "Earth Crystal") | 45 |
| 5 | 7 | 10 [Coal](/Coal "Coal") or 5 [Geodes](/Geode "Geode") | 45 |
| 7 | 10 | 4 [Copper Bars](/Copper_Bar "Copper Bar") or 5 [Refined Quartz](/Refined_Quartz "Refined Quartz") | 45 |

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Dark Brown Roe.png [Roe](/Roe "Roe") (1) | 17 | 1-2 | 25% | 6-8% |
| 3-8 | 23% | 9-18% |
| 9-10 | 43% | 37-41% |
| Copper Ore.png [Copper Ore](/Copper_Ore "Copper Ore") (5) | 10 | 3-8 | 10% | 4-8% |
| 9-10 | 8% | 7% |
| Geode.png [Geode](/Geode "Geode") (1) | 12 | 9-10 | 11% | 9-10% |
| Geode.png [Geode](/Geode "Geode") (5) | 12 | 9-10 | 5% | 4-5% |
| Stone.png [Stone](/Stone "Stone") (30) | 10 | 9-10 | 7% | 6-7% |
| Diamond.png [Diamond](/Diamond "Diamond") (1) | 40 | 9-10 | 0.8% | 0.7% |
| *Nothing* |  | 1-2 | 75% | 94-92% |
| 3-8 | 68% | 87-74% |
| 9-10 | 26% | 35-30% |

## Quests

Stonefish is not used in any [quests](/Quests "Quests").

## References

1. [↑](#cite_ref-mineshaft_1-0) See `MineShaft::getFish` in the game code. While `Data\Fish.xnb` suggests that a fishing level of 3 is needed to hook a Stonefish, the data in `MineShaft::getFish`, which does not have any level conditions, overrides it. This means that there is no fishing level requirement to hook a Stonefish.

## History

* [1.4](/Version_History#1.4 "Version History"): Added iridium quality. Can now be used in [Tailoring](/Tailoring "Tailoring").
* [1.5](/Version_History#1.5 "Version History"): Chance of catching it now increased by 5% when using a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure").
* [1.6](/Version_History#1.6 "Version History"): Chance of catching it now increased by 10% when using [Stonefish Bait](/Targeted_Bait "Targeted Bait").
...
| [Mines](/The_Mines "The Mines") | [Ghostfish](/Ghostfish "Ghostfish") • [Ice Pip](/Ice_Pip "Ice Pip") • [Lava Eel](/Lava_Eel "Lava Eel") • Stonefish |
