...
| --- | --- |
| Amaranth Seeds | |
| [Amaranth Seeds.png](/File:Amaranth_Seeds.png) | |
| Plant these in the fall. Takes 7 days to grow. Harvest with the scythe. | |
| Information | |
| Crop: | Amaranth.png [Amaranth](/Amaranth "Amaranth") |
| Growth Time: | 7 days |
| Season: | Fall.png [Fall](/Fall "Fall") |
| Sell Price: | data-sort-value="35">Gold.png35g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="70">Gold.png70g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="87">Gold.png87g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="35"Gold.png105–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 17): | data-sort-value="70">Gold.png70g |

**Amaranth Seeds** are a type of seed. Mature plants yield [Amaranth](/Amaranth "Amaranth").

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), at [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 17, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Harvest |
| --- | --- | --- | --- | --- |
| Amaranth Stage 1.png | Amaranth Stage 2.png | Amaranth Stage 3.png | Amaranth Stage 4.png | Amaranth Stage 5.png |
