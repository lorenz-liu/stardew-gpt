...
| --- | --- |
| Fireworks (Green) | |
| [Fireworks (Green).png](/File:Fireworks_(Green).png) | |
| An old tradition for celebrations and festivities. Handle with care! | |
| Information | |
| Source | * [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") * [Casino](/Casino "Casino") |
| Sell Price | data-sort-value="50">Gold.png50g |

:   *See also: [Fireworks (Red)](/Fireworks_(Red) "Fireworks (Red)"), [Fireworks (Purple)](/Fireworks_(Purple) "Fireworks (Purple)").*

**Fireworks (Green)** are an item that can be purchased from [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="1">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 1 or from the [Casino](/Casino "Casino") for data-sort-value="200">![QiCoin.png](/mediawiki/images/thumb/6/6c/QiCoin.png/24px-QiCoin.png)200. When used, the firework is placed on the ground. After a short delay, it goes into the air and creates green sparkles in the shape of a Junimo. The player's screen is also briefly tinted green.
...
Fireworks (Green) are not used in any [bundles](/Bundles "Bundles").

## Tailoring

Fireworks (Green) can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the ![Party Hat (green).png](/mediawiki/images/thumb/c/c5/Party_Hat_%28green%29.png/24px-Party_Hat_%28green%29.png) [Party Hat (green)](/Party_Hat_(green) "Party Hat (green)"). It can be used in [dyeing](/Dyeing "Dyeing"), serving as a green dye at the dye pots located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane"). It can also be used as a green dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Fireworks (Green) are not used in any [quests](/Quests "Quests").

## History

* [1.5](/Version_History#1.5 "Version History"): Existed in the game's code, but unobtainable.
* [1.6](/Version_History#1.6 "Version History"): Officially introduced in game.