...
| --- | --- |
| Red Cabbage Seeds | |
| [Red Cabbage Seeds.png](/File:Red_Cabbage_Seeds.png) | |
| Plant these in the summer. Takes 9 days to mature. | |
| Information | |
| Crop: | Red Cabbage.png [Red Cabbage](/Red_Cabbage "Red Cabbage") |
| Growth Time: | 9 days |
| Season: | Summer.png [Summer](/Summer "Summer") |
| Sell Price: | data-sort-value="50">Gold.png50g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="100">Gold.png100g (Year 2+) |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | Not Sold |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="50"Gold.png150–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 16): | data-sort-value="100">Gold.png100g (Year 2+) |

**Red Cabbage Seeds** are a type of seed that can be found:

* at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") for data-sort-value="100">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100g starting in Year 2.
* at the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 16 for data-sort-value="100">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100g starting in Year 2.
* at the [Traveling Cart](/Traveling_Cart "Traveling Cart") occasionally for data-sort-value="50"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)150–1,000g, and [guaranteed](/Traveling_Cart#Guaranteed_Red_Cabbage "Traveling Cart") on at least one day in Year 1 if the "Guarantee Year 1 Completable" [Advanced Option](/Options#Advanced_Game_Options "Options") was enabled.
* in a [Seed Maker](/Seed_Maker "Seed Maker") from a processed [Red Cabbage](/Red_Cabbage "Red Cabbage").
* in the [Skull Cavern](/Skull_Cavern "Skull Cavern") from slain [Mummies](/Mummy "Mummy") (0.2% chance), slain [Serpents](/Serpent "Serpent") (0.2% chance), slain [Purple Slimes](/Slimes "Slimes") (0.125% chance)[[1]](#cite_note-purplesludge-1), or [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") (≈0.09% chance for 5 to 20 seeds).

Mature plants yield [Red Cabbage](/Red_Cabbage "Red Cabbage").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 | Harvest |
| --- | --- | --- | --- | --- | --- |
| Red Cabbage Stage 1.png | Red Cabbage Stage 2.png | Red Cabbage Stage 3.png | Red Cabbage Stage 4.png | Red Cabbage Stage 5.png | Red Cabbage Stage 6.png |
...
1. [↑](#cite_ref-purplesludge_1-0) See `GreenSlime::getExtraDropItems` in the game code, taking into account the specialNumber % 4 == 0 condition.

## History

* [1.5](/Version_History#1.5 "Version History"): The Advanced Game Options, which can be used to customize a new game, can make Red Cabbage Seeds guaranteed to sell at least once at the [Traveling Cart](/Traveling_Cart "Traveling Cart") in year one. Added drops from [Serpents](/Serpent "Serpent") and [Mummies](/Mummy "Mummy").
...
| Summer | [Blueberry Seeds](/Blueberry_Seeds "Blueberry Seeds") • [Coffee Beans](/Coffee_Bean "Coffee Bean") • [Corn Seeds](/Corn_Seeds "Corn Seeds") • [Hops Starter](/Hops_Starter "Hops Starter") • [Melon Seeds](/Melon_Seeds "Melon Seeds") • [Orange Sapling](/Orange_Sapling "Orange Sapling") • [Peach Sapling](/Peach_Sapling "Peach Sapling") • [Pepper Seeds](/Pepper_Seeds "Pepper Seeds") • [Poppy Seeds](/Poppy_Seeds "Poppy Seeds") • [Radish Seeds](/Radish_Seeds "Radish Seeds") • Red Cabbage Seeds • [Spangle Seeds](/Spangle_Seeds "Spangle Seeds") • [Summer Seeds](/Summer_Seeds "Summer Seeds") • [Summer Squash Seeds](/Summer_Squash_Seeds "Summer Squash Seeds") • [Sunflower Seeds](/Sunflower_Seeds "Sunflower Seeds") • [Starfruit Seeds](/Starfruit_Seeds "Starfruit Seeds") • [Tomato Seeds](/Tomato_Seeds "Tomato Seeds") • [Wheat Seeds](/Wheat_Seeds "Wheat Seeds") |
