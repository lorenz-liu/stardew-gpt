...
| --- | --- |
| Lava Crab (dangerous) | |
| [Lava Crab Dangerous Anim.gif](/File:Lava_Crab_Dangerous_Anim.gif) | |
| Information | |
...
| Speed: | 3 |
| XP: | 12 |
| Variations: | Rock Crab.png [Rock Crab](/Rock_Crab "Rock Crab")Truffle Crab.png [Truffle Crab](/Truffle_Crab "Truffle Crab")Lava Crab.png [Lava Crab](/Lava_Crab "Lava Crab")Iridium Crab.png [Iridium Crab](/Iridium_Crab "Iridium Crab")Rock Crab Dangerous.png [Rock Crab (dangerous)](/Rock_Crab_(dangerous) "Rock Crab (dangerous)") |
...
**Lava Crabs (dangerous)** are an [enemy](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") after activating the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") or during the [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") quest. 60 rock crabs (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").

## Behavior

They disguise themselves as [Gold Nodes](/Mining#Mining_Nodes "Mining"), sometimes surprising the player. When immobile, they are invulnerable to attack, though they can be hit with a [pickaxe](/Tools#Pickaxes "Tools") to knock them back, making them mobile again.

## Strategy

Lava Crabs may be differentiated from nodes by striking them with a [weapon](/Weapons "Weapons"). A Lava Crab will make a knocking sound and a zero damage indicator will pop up when hit with a weapon, while a node will not.
