...
| --- | --- |
| Cave Fly | |
| [Cave Fly.png](/File:Cave_Fly.png) | |
| Information | |
...
| Speed: | 2 |
| XP: | 10 |
| Variations: | Mutant Fly.png [Mutant Fly](/Mutant_Fly "Mutant Fly")Cave Fly Dangerous.png [Cave Fly (dangerous)](/Cave_Fly_(dangerous) "Cave Fly (dangerous)") |
| Drops: | Ancient Seed.png [Ancient Seed](/Ancient_Seed "Ancient Seed") (0.5%)Bug Meat.png [Bug Meat](/Bug_Meat "Bug Meat") (90%)Dwarf Scroll I.png [Dwarf Scroll I](/Dwarf_Scroll_I "Dwarf Scroll I") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)White Algae.png [White Algae](/White_Algae "White Algae") (2%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Cave Flies** are an enemy [monster](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines"). 80 cave insects (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").

[Grubs](/Grub "Grub") hatch into Cave Flies shortly after entering their cocoon phase, during which time they are invulnerable. Be sure to kill off a critically-hit Grub before it can enter its cocoon.
...
A swarm event of Cave Flies (green mist) can easily overwhelm a low-level character, so it's advisable to carry enough [stone](/Stone "Stone") to craft a [staircase](/Staircase "Staircase") if you don't have an efficient weapon.
