...
**Calcite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Calcite is not used in any [bundles](/Bundles "Bundles").
...
Calcite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt182.png](/mediawiki/images/thumb/1/14/Shirt182.png/24px-Shirt182.png)](/File:Shirt182.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as a yellow dye in the dye pots, located at [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Calcite is not used in any [quests](/Quests "Quests").
