...
| --- | --- |
| Pomegranate Sapling | |
| [Pomegranate Sapling.png](/File:Pomegranate_Sapling.png) | |
...
| Information | |
| Crop: | Pomegranate.png [Pomegranate](/Pomegranate "Pomegranate") |
| Growth Time: | 28 days |
| Season: | Fall.png [Fall](/Fall "Fall") |
| Sell Price: | data-sort-value="1500"  |  |  | | --- | --- | | Pomegranate Sapling.png | 1,500g | | Pomegranate Sapling.png  Silver Quality Icon.png | 1,875g | | Pomegranate Sapling.png  Gold Quality Icon.png | 2,250g | | Pomegranate Sapling.png  Iridium Quality Icon.png | 3,000g | |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="6000">Gold.png6,000g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | Not Sold |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="1500"Gold.png4,500–7,500g |

The **Pomegranate Sapling** is a [Fruit Tree](/Fruit_Trees "Fruit Trees") sapling that takes 28 days to grow into a [Pomegranate Tree](/Pomegranate_Tree "Pomegranate Tree"), after which it will produce one fruit each day during the [Fall](/Fall "Fall"). Like all Fruit Trees, it will produce fruit all year round if planted in the [Greenhouse](/Greenhouse "Greenhouse").

It can be purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). It may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern, or as the eighth prize from the Prize Machine in the [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor"). One Pomegranate Sapling may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 - Spring, Summer, Fall, Winter | Harvest |
| --- | --- | --- | --- | --- | --- |
| Pomegranate Stage 1.png | Pomegranate Stage 2.png | Pomegranate Stage 3.png | Pomegranate Stage 4.png | Pomegranate Stage 5.png | Pomegranate Stage 5 Fruit.png |
...
* [1.6](/Version_History#1.6 "Version History"): Can now be obtained by chopping down a [Pomegranate Tree](/Pomegranate_Tree "Pomegranate Tree").
