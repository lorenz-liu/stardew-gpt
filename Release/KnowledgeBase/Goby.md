...
| --- | --- |
| Goby | |
| [Goby.png](/File:Goby.png) | |
| Some types of Gobies can climb up waterfalls. | |
| Information | |
| Location | [Cindersap Forest](/Cindersap_Forest "Cindersap Forest") Waterfalls |
| Time | Any |
...
| Size (inches) | 3–13 |
| Fishing XP | 21   Silver Quality.png 24   Gold Quality.png 27   Iridium Quality.png 33 |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Poison.png | −62 | Health.png | 0 | | Poison.png  Silver Quality Icon.png | −87 | Health.png  Silver Quality Icon.png | 0 | | Poison.png  Gold Quality Icon.png | −112 | Health.png  Gold Quality Icon.png | 0 | | Poison.png  Iridium Quality Icon.png | −162 | Health.png  Iridium Quality Icon.png | 0 | |
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Goby.png | 150g | | Goby.png  Silver Quality Icon.png | 187g | | Goby.png  Gold Quality Icon.png | 225g | | Goby.png  Iridium Quality Icon.png | 300g | | |  |  | | --- | --- | | Goby.png | 187g | | Goby.png  Silver Quality Icon.png | 233g | | Goby.png  Gold Quality Icon.png | 281g | | Goby.png  Iridium Quality Icon.png | 375g | | |  |  | | --- | --- | | Goby.png | 225g | | Goby.png  Silver Quality Icon.png | 280g | | Goby.png  Gold Quality Icon.png | 337g | | Goby.png  Iridium Quality Icon.png | 450g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Orange Roe.png | 105g | | |  |  | | --- | --- | | Orange Aged Roe.png | 210g | | |  |  | | --- | --- | | Orange Aged Roe.png | 294g | | | |

The **Goby** is a [fish](/Fish "Fish") that can be caught at the bottom of the waterfalls in southern [Cindersap Forest](/Cindersap_Forest "Cindersap Forest") during any season. The waterfalls are located just east of the [Abandoned House](/Abandoned_House "Abandoned House").

When fishing in the right area without using the [Training Rod](/Training_Rod "Training Rod"), there is a 15% chance to hook a Goby. This chance increases to 30% if using a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure"). Unlike with other fish, the Locational Chance of the Goby is not multiplied by 1.66 if [Goby Bait](/Targeted_Bait "Targeted Bait") is used. Instead, its Locational Chance is increased by a static 20%. So the chance of hooking increases to 35-46% if using [Goby Bait](/Targeted_Bait "Targeted Bait"). These effects stack, so there is a 50-61% chance to hook a Goby with both a Curiosity Lure and Goby Bait.[[1]](#cite_note-waterfallchance-1)

## Map

Goby can be found in the waterfalls in southern [Cindersap Forest](/Cindersap_Forest "Cindersap Forest").
...
Goby is not used in any [bundles](/Bundles "Bundles").
...
Goby can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the ![Shirt158.png](/mediawiki/images/thumb/e/e7/Shirt158.png/24px-Shirt158.png) [Fish Shirt](/Tailoring#Shirts "Tailoring"). It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane"). It can also be used as a brown dye when used in the spool of the [Sewing Machine](/Sewing_Machine "Sewing Machine") with a dyeable clothing item in the feed.

## Fish Pond

Goby can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"), where they will reproduce every 4 days. The initial pond capacity is 3 fish, but the capacity can be increased to 10 by completing three quests. The only possible output is orange Goby [Roe](/Roe "Roe").
...
| 3 | 5 | 3 [Acorns](/Acorn "Acorn"), 10 [Bug Meat](/Bug_Meat "Bug Meat"), 3 [Maple Seeds](/Maple_Seed "Maple Seed"), or 3 [Pine Cones](/Pine_Cone "Pine Cone") | 40 |
| 5 | 7 | 3 [Gold Ore](/Gold_Ore "Gold Ore"), 1 [Maple Syrup](/Maple_Syrup "Maple Syrup"), or 5 [Mixed Seeds](/Mixed_Seeds "Mixed Seeds") | 40 |
| 7 | 10 | 1 [Crayfish](/Crayfish "Crayfish"), 1 [Honey](/Honey "Honey"), 2 [Jade](/Jade "Jade"), or 1 [Periwinkle](/Periwinkle "Periwinkle") | 40 |

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Orange Roe.png [Roe](/Roe "Roe") (1) | 12 | 1-10 | 90% | 21-86% |
| *Nothing* |  | 1-10 | 10% | 79-14% |

## Quests

Goby is not used in any [quests](/Quests "Quests").

## Notes

* While the Goby has a theoretical maximum [Size](/Fishing#Fish_Size_.26_Quality "Fishing") of 13", in actual gameplay it is impossible to catch a Goby longer than 11", due to the location where it is caught being at most 2 [tiles from land](/Fishing#Distance_from_Land "Fishing"). A Fishing level of at least 16 is required to catch an 11" Goby.
* An effective fishing level of at least 4 is required to cast into the waterfall pools. The waterfall illusion makes the pool appear 1 tile away, however, it is actually 5 tiles away on the map grid.

## References

1. [↑](#cite_ref-waterfallchance_1-0) See `Data\Locations.xnb` in the game files.

## History

* [1.6](/Version_History#1.6 "Version History"): Introduced.
* [1.6.4](/Version_History#1.6.4 "Version History"): Chance of hooking now increased by more than 20% when using [Goby Bait](/Targeted_Bait "Targeted Bait"), rather than just 20%.
