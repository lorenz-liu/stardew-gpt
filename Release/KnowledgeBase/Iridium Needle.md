...
| --- | --- |
| Iridium Needle | |
| [Iridium Needle.png](/File:Iridium_Needle.png) | |
| The point is unbelievably sharp, even down to the atomic level. | |
| Information | |
| Type: | Dagger |
| Level: | 12 |
| Source: | [The Mines](/The_Mines "The Mines") ([Special Slimes](/Slimes#Special_Slimes "Slimes")) |
| Damage: | 20-35 |
| Critical Strike Chance: | 0.1 |
| Stats: | Crit. Chance.png [Crit. Chance](/Crit._Chance "Crit. Chance") (+6)Crit. Power.png [Crit. Power](/Crit._Power "Crit. Power") (+200) |
| Adventurer's Guild | |
| Purchase Price: | Not sold |
| Sell Price: | data-sort-value="600">Gold.png600g |

The **Iridium Needle** is a [dagger weapon](/Weapons#Dagger "Weapons") that has a 14% chance of dropping from [special Slimes](/Slimes#Special_Slimes "Slimes") in [The Mines](/The_Mines "The Mines") during Qi's challenge [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") and after the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") has been activated.

## Notes

The Iridium Needle has the highest base critical strike chance and crit power of any weapon. With full investment into critical-boosting equipment and professions, it can achieve a [critical strike chance](/Crit._Chance "Crit. Chance") of 48.99% with each critical hit dealing 14x damage, and 60.01% with +9 [Luck](/Luck "Luck") from [Food](/Cooking "Cooking") and [combining rings](/Forge#Combined_Rings "Forge") for maximum [critical strike chance](/Crit._Chance "Crit. Chance").[[1]](#cite_note-critchance-1)

## References

1. [↑](#cite_ref-critchance_1-0) See `MeleeWeapon::DoDamage` in the game code.
