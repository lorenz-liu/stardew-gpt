...
| --- | --- |
| Lobster Bisque | |
| [Lobster Bisque.png](/File:Lobster_Bisque.png) | |
| This delicate soup is a secret family recipe of Willy's. | |
| Information | |
| Source | [Cooking](/Cooking "Cooking") |
| Buff(s) | Fishing.png [Fishing](/Fishing "Fishing") (+3)Max Energy.png [Max Energy](/Energy "Energy") (+50) |
| Buff Duration | Time Icon.png 16m 47s |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 225 | Health.png | 101 | |
| Sell Price | |  |  | | --- | --- | | Lobster Bisque.png | 205g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 405 | Health.png  Gold Quality Icon.png | 182 | |  | |  |  | | --- | --- | | Lobster Bisque.png  Gold Quality Icon.png | 307g | | |
| Recipe | |
| Recipe Source(s) | |  |  | | --- | --- | | Cooking Channel.png | [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") | | 14 Winter, Year 2 |     Willy Icon.png [Willy](/Willy "Willy") (Mail - 9+ HeartIconLarge.png) |
| Ingredients | Lobster.png [Lobster](/Lobster "Lobster") (1)Milk.png [Milk](/Milk "Milk") (1) |

**Lobster Bisque** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit"). It can randomly be found at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="205"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)615–1,025g. Five can be purchased from [Gus](/Gus "Gus")'s [shop](/Desert_Festival#Villager_Shops "Desert Festival") at the [Desert Festival](/Desert_Festival "Desert Festival") for data-sort-value="30">![Calico Egg.png](/mediawiki/images/thumb/d/da/Calico_Egg.png/24px-Calico_Egg.png) 30 [Calico Eggs](/Calico_Egg "Calico Egg") each. One Lobster Bisque may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").
...
Lobster Bisque is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Lobster Bisque is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt125.png](/mediawiki/images/thumb/4/49/Shirt125.png/24px-Shirt125.png)](/File:Shirt125.png)

## Quests

Lobster Bisque is not used in any [quests](/Quests "Quests").

## Trivia

* Receiving the letter from [Willy](/Willy "Willy") with the Lobster Bisque recipe on 14 Winter, Year 2 and watching [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") before checking the mail will result in the letter still in the mailbox, but the recipe box at the bottom of the letter will be blank.
* Although its description states that it is "a secret family recipe", it can be learned from The Queen of Sauce.

## History

* [1.3.27](/Version_History#1.3.27 "Version History"): The Lobster Bisque recipe now accepts [Large Milk](/Large_Milk "Large Milk") in addition to [regular milk](/Milk "Milk").
