...
| --- | --- |
| Glacierfish Jr. | |
| [Glacierfish Jr..png](/File:Glacierfish_Jr..png) | |
| The original Glacierfish had a son... | |
| Information | |
| Location | [Cindersap Forest](/Cindersap_Forest "Cindersap Forest") |
| Time | Any |
...
| Size (inches) | 26–28 |
| Fishing XP | 36   Silver Quality.png 39   Gold Quality.png 42   Iridium Quality.png 48 |
...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Glacierfish Jr..png | 1,000g | | Glacierfish Jr..png  Silver Quality Icon.png | 1,250g | | Glacierfish Jr..png  Gold Quality Icon.png | 1,500g | | Glacierfish Jr..png  Iridium Quality Icon.png | 2,000g | | |  |  | | --- | --- | | Glacierfish Jr..png | 1,250g | | Glacierfish Jr..png  Silver Quality Icon.png | 1,562g | | Glacierfish Jr..png  Gold Quality Icon.png | 1,875g | | Glacierfish Jr..png  Iridium Quality Icon.png | 2,500g | | |  |  | | --- | --- | | Glacierfish Jr..png | 1,500g | | Glacierfish Jr..png  Silver Quality Icon.png | 1,875g | | Glacierfish Jr..png  Gold Quality Icon.png | 2,250g | | Glacierfish Jr..png  Iridium Quality Icon.png | 3,000g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Blue Roe.png | 530g | | |  |  | | --- | --- | | Blue Aged Roe.png | 1,060g | | |  |  | | --- | --- | | Blue Aged Roe.png | 1,484g | | | |

The **Glacierfish Jr.** is one of the five [Legendary Fish](/Fish#Legendary_Fish_II "Fish") that must be caught for [Mr. Qi](/Mr._Qi "Mr. Qi")'s [Extended Family Quest](/Quests#Extended_Family "Quests"). It has the same sell price, healing effect, location, and chance of hooking as the [Glacierfish](/Glacierfish "Glacierfish"). It can only be caught when the quest is active, but more than one can be caught per quest.

## Map

The Glacierfish Jr. can be found off the southern tip of Arrowhead Island in [Cindersap Forest](/Cindersap_Forest "Cindersap Forest").

![Maplocation.png](/mediawiki/images/thumb/5/5c/Maplocation.png/20px-Maplocation.png)

![Map.png](/mediawiki/images/4/43/Map.png)

[![GlacierfishLocations.png](/mediawiki/images/thumb/1/19/GlacierfishLocations.png/400px-GlacierfishLocations.png)](/File:GlacierfishLocations.png)
...
Glacierfish Jr. is not used in any [bundles](/Bundles "Bundles").
...
Glacierfish Jr. can be used in [dyeing](/Dyeing "Dyeing"), serving as a blue dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Fish Pond

Glacierfish Jr. can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"). The pond capacity is 1 fish and this cannot be increased. The only possible output is Glacierfish Jr. [Roe](/Roe "Roe").

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Blue Roe.png [Roe](/Roe "Roe") (1-4) | 32 | 1 | 79% | 39.5% |
| *Nothing* |  | 1 | 21% | 60.5% |

## Quests

Glacierfish Jr. must be caught for the [Extended Family Quest](/Quests#Extended_Family "Quests").
