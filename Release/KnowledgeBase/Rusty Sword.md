...
| --- | --- |
| Rusty Sword | |
| [Rusty Sword.png](/File:Rusty_Sword.png) | |
| A rusty, dull old sword. | |
| Information | |
| Type: | Sword |
| Level: | 1 |
| Source: | Given by [Marlon](/Marlon "Marlon") at the entrance to [The Mines](/The_Mines "The Mines") |
| Damage: | 2-5 |
...
The **Rusty Sword** is a [sword weapon](/Weapons#Sword "Weapons") obtained from [Marlon](/Marlon "Marlon") in a cutscene the first time you enter [The Mines](/The_Mines "The Mines"). It can also be purchased for data-sort-value="250">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)250g from the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").
