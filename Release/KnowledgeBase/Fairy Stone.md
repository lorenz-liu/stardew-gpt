...
| --- | --- |
| Fairy Stone | |
| [Fairy Stone.png](/File:Fairy_Stone.png) | |
...
**Fairy Stone** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Fairy Stone is not used in any [bundles](/Bundles "Bundles").
...
Fairy Stone is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt070.png](/mediawiki/images/thumb/b/b9/Shirt070.png/24px-Shirt070.png)](/File:Shirt070.png)
It is a purple dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed. It can be placed in the purple dye pot at Emily's and Haley's house for use in dyeing.

## Quests

Fairy Stone is not used in any [quests](/Quests "Quests").
