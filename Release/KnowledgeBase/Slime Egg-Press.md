...
| --- | --- |
| Slime Egg-Press | |
| [Slime Egg-Press.png](/File:Slime_Egg-Press.png) | |
| Compresses 100 pieces of slime into a slime egg. It's a miracle of science! | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") • [Bookseller](/Bookseller "Bookseller") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Combat Skill Icon.png [Combat](/Combat "Combat") (Level 6) |
| Ingredients | Coal.png [Coal](/Coal "Coal") (25)Fire Quartz.png [Fire Quartz](/Fire_Quartz "Fire Quartz") (1)Battery Pack.png [Battery Pack](/Battery_Pack "Battery Pack") (1) |

The **Slime Egg-Press** is a piece of [equipment](/Crafting#Refining_Equipment "Crafting") used to create [Slime Eggs](/Slime_Egg "Slime Egg") from [Slime](/Slime "Slime"). The crafting recipe is unlocked after reaching [Combat](/Combat "Combat") Level 6. The [Bookseller](/Bookseller "Bookseller") may trade 1 Slime Egg-Press for 2 [Monster Compendiums](/Monster_Compendium "Monster Compendium") each, provided the player has already earned the power from that book.

The Slime Egg-Press can be started by adding 100 [Slime](/Slime "Slime") from the toolbar, and it creates 1 Green, Blue, Red, or Purple Slime Egg after ![Time Icon.png](/mediawiki/images/thumb/7/70/Time_Icon.png/24px-Time_Icon.png) 1,200m (20h).[[1]](#cite_note-processtime-1) It cannot produce Tiger Slime Eggs. Slime Eggs can then be used to hatch new [slimes](/Slimes "Slimes") in the [Slime Hutch](/Slime_Hutch "Slime Hutch") or elsewhere, or they can be sold for profit.

The color of the egg is random, and the slime's gender can only be determined after hatching from a [Slime Incubator](/Slime_Incubator "Slime Incubator"). The color of the slime(s) from which pieces of slime were obtained does not affect the color of the resulting egg.

The chances for the press to generate a particular egg are:[[2]](#cite_note-slimechance-2)

* **64.125%** ![Green Slime Egg.png](/mediawiki/images/thumb/1/1d/Green_Slime_Egg.png/24px-Green_Slime_Egg.png) [Green Slime Egg](/Slime_Egg "Slime Egg")
* **21.375%** ![Blue Slime Egg.png](/mediawiki/images/thumb/a/a2/Blue_Slime_Egg.png/24px-Blue_Slime_Egg.png) [Blue Slime Egg](/Slime_Egg "Slime Egg")
* **9.5%** ![Red Slime Egg.png](/mediawiki/images/thumb/a/ae/Red_Slime_Egg.png/24px-Red_Slime_Egg.png) [Red Slime Egg](/Slime_Egg "Slime Egg")
* **5%** ![Purple Slime Egg.png](/mediawiki/images/thumb/6/65/Purple_Slime_Egg.png/24px-Purple_Slime_Egg.png) [Purple Slime Egg](/Slime_Egg "Slime Egg")

## Notes

The average value of each Slime Egg produced by the Slime Egg-Press is roughly data-sort-value="1500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,500g, which is triple the sell value of the Slime used to create it.

## References

1. [↑](#cite_ref-processtime_1-0) See `Object::performObjectDropInAction` in the game code.
2. [↑](#cite_ref-slimechance_2-0) See `Data\Machines.xnb` in the game files.

## History

* [1.6](/Version_History#1.6 "Version History"): Can now be obtained by trading with the [Bookseller](/Bookseller "Bookseller").
