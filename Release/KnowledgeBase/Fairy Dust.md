...
| --- | --- |
| Fairy Dust | |
| [Fairy Dust.png](/File:Fairy_Dust.png) | |
| Sprinkle on kegs, furnaces, and other refining equipment to instantly receive their product. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") • [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor") • [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") • [Giant Stump](/Giant_Stump "Giant Stump") • [Bookseller](/Bookseller "Bookseller") • [Raccoon Wife's Shop](/Giant_Stump#Raccoon_Wife.27s_Shop "Giant Stump") |
| Sell Price | data-sort-value="300">Gold.png300g |
| Recipe | |
| Recipe Source(s) | ["The Pirate's Wife"](/Quests#The_Pirate.27s_Wife "Quests") quest |
| Ingredients | Diamond.png [Diamond](/Diamond "Diamond") (1)Fairy Rose.png [Fairy Rose](/Fairy_Rose "Fairy Rose") (1) |

**Fairy Dust** is a single-use [craftable item](/Crafting "Crafting") that allows the player to make a machine immediately finish the process it is carrying out. The player receives the recipe after completing ["The Pirate's Wife"](/Quests#The_Pirate.27s_Wife "Quests") quest for [Birdie](/Birdie "Birdie").

One to two Fairy Dust can be obtained as a prize from the [Prize Machine](/Mayor%27s_Manor#Prize_Machine "Mayor's Manor"). It can also be found in [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") (7% chance).[[1]](#cite_note-chestchance-1) Five Fairy Dust is the reward for completing the [Raccoon](/Giant_Stump "Giant Stump")'s fourth request, and seven Fairy Dust is a possible reward for the sixth request and beyond.

The [Bookseller](/Bookseller "Bookseller") trades 8 Fairy Dust for 1 [Book Of Stars](/Book_Of_Stars "Book Of Stars"). Once unlocked, the [Raccoon's wife](/Giant_Stump#Raccoon_Wife.27s_Shop "Giant Stump") near the Giant Stump will trade 1 Fairy Dust for 1 [Mystic Syrup](/Mystic_Syrup "Mystic Syrup").

Fairy Dust does not work on [Incubators](/Incubator "Incubator"), [Ostrich Incubators](/Ostrich_Incubator "Ostrich Incubator"), or [Slime Incubators](/Slime_Incubator "Slime Incubator"). When used in [casks](/Cask "Cask"), the product does not go directly to iridium quality unless it is currently in gold quality. Instead, it will upgrade to the next quality level each time Fairy Dust is used, until iridium quality has been reached.
...
Fairy Dust is not used in any [tailoring](/Tailoring "Tailoring") or [dyeing](/Dyeing "Dyeing").

## Quests

Fairy Dust is not used in any [quests](/Quests "Quests").
...
* [1.6](/Version_History#1.6 "Version History"): Reduced sell price from data-sort-value="500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)500g to data-sort-value="300">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)300g. Can now be obtained from [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") as well as traded for with the [Bookseller](/Bookseller "Bookseller") and the [Raccoon's wife](/Giant_Stump "Giant Stump"). Can now be obtained as a prize from the [Prize Machine](/Mayor%27s_Manor#Prize_Machine "Mayor's Manor") and as a reward from the Raccoon.
