...
| --- | --- |
| Grub (dangerous) | |
| [Grub Dangerous Anim.gif](/File:Grub_Dangerous_Anim.gif) | |
| Information | |
| Spawns In: | [Dangerous Mines](/The_Mines#Shrine_of_Challenge "The Mines") |
| Floors: | 41-69 |
| Killable: | Yes |
| Base HP: | 265 |
| Base Damage: | 12-13 |
...
| Speed: | 1 |
| XP: | 2 |
| Variations: | Grub.png [Grub](/Grub "Grub")Mutant Grub.png [Mutant Grub](/Mutant_Grub "Mutant Grub") |
| Drops: | Ancient Seed.png [Ancient Seed](/Ancient_Seed "Ancient Seed") (0.5%)Bug Meat.png [Bug Meat](/Bug_Meat "Bug Meat") (60%)Dwarf Scroll I.png [Dwarf Scroll I](/Dwarf_Scroll_I "Dwarf Scroll I") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)Rice Shoot.png [Rice Shoot](/Rice_Shoot "Rice Shoot") (10%)White Algae.png [White Algae](/White_Algae "White Algae") (2%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Grubs (dangerous)** are an [enemy](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") after activating the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") or during the [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") quest. 80 cave insects (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").

## Behavior

[![GrubCocoon Dangerous.png](/mediawiki/images/f/f1/GrubCocoon_Dangerous.png)](/File:GrubCocoon_Dangerous.png)

*Pupating Grub*

Grubs appear in groups and attack on sight. Upon sustaining critical damage, they will flee and attempt to pupate. When pupating, a Grub turns blue and is immune to all damage. It will emerge from its blue cocoon as a [Cave Fly (dangerous)](/Cave_Fly_(dangerous) "Cave Fly (dangerous)").

## Strategy

Attempt to separate them from their groups to avoid being overrun.

If you find a single grub, simply attack it constantly and chase it down if it tries to escape. They do not charge you like [Slimes](/Slimes "Slimes") do, making it impossible for them to hit you if you have a weapon with decent knockback.

If you encounter a group of grubs, use a weapon with medium or high knockback to push them all into a corner, that way none of them can escape. Just make sure to not let any escape from the corner, as fighting a flying insect and a group of grubs is quite dangerous, especially if there are a lot of grubs. [Explosive Ammo](/Explosive_Ammo "Explosive Ammo") from your slingshot also works well.

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): Changed Monster Eradication Goal for cave insects from 125 to 80.
