...
| --- | --- |
| Wood Path | |
| [Wood Path.png](/File:Wood_Path.png) | |
...
The **Wood Path** is a [crafted item](/Crafting#Decor "Crafting") used to create decorative paths. It can be displaced by lightning or destroyed by [weeds](/Weeds "Weeds").
...
* [![](/mediawiki/images/thumb/1/1b/Wood_Path_Tile.png/120px-Wood_Path_Tile.png)](/File:Wood_Path_Tile.png)

  Spring, Summer, & Fall
* [![](/mediawiki/images/thumb/f/f9/Wood_Path_Tile_Winter.png/120px-Wood_Path_Tile_Winter.png)](/File:Wood_Path_Tile_Winter.png)
...
| Paths | [Cobblestone Path](/Cobblestone_Path "Cobblestone Path") • [Crystal Path](/Crystal_Path "Crystal Path") • [Gravel Path](/Gravel_Path "Gravel Path") • [Stepping Stone Path](/Stepping_Stone_Path "Stepping Stone Path") • Wood Path |