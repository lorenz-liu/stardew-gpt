...
| --- | --- |
| Fireworks (Red) | |
| [Fireworks (Red).png](/File:Fireworks_(Red).png) | |
...
:   *See also: [Fireworks (Purple)](/Fireworks_(Purple) "Fireworks (Purple)"), [Fireworks (Green)](/Fireworks_(Green) "Fireworks (Green)").*
...
Fireworks (Red) are not used in any [bundles](/Bundles "Bundles").

## Tailoring

Fireworks (Red) can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the ![Party Hat (red).png](/mediawiki/images/thumb/9/96/Party_Hat_%28red%29.png/24px-Party_Hat_%28red%29.png) [Party Hat (red)](/Party_Hat_(red) "Party Hat (red)"). It can be used in [dyeing](/Dyeing "Dyeing"), serving as a red dye at the dye pots located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane"). It can also be used as a red dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Fireworks (Red) are not used in any [quests](/Quests "Quests").
