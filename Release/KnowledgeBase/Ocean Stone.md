...
| --- | --- |
| Ocean Stone | |
| [Ocean Stone.png](/File:Ocean_Stone.png) | |
| An old legend claims these stones are the mosaics of ancient mermaids. | |
| Information | |
| Source | Frozen Geode.png [Frozen Geode](/Frozen_Geode "Frozen Geode")Omni Geode.png [Omni Geode](/Omni_Geode "Omni Geode") |
| Sell Price | data-sort-value="220 ">Gold.png220g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="286 ">Gold.png286g |

**Ocean Stone** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Ocean Stone is not used in any [bundles](/Bundles "Bundles").

## Recipes

Ocean Stone is not used in any [recipes](/Cooking "Cooking").

## Tailoring

Ocean Stone is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Ocean Shirt](/Tailoring "Tailoring"). [![Shirt193.png](/mediawiki/images/thumb/b/bd/Shirt193.png/24px-Shirt193.png)](/File:Shirt193.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as a green dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

* One Ocean Stone is requested by [Midnight Squid](/Midnight_Squid "Midnight Squid") in a [Fish Pond quest](/Fish_Pond#Quests "Fish Pond") to increase the capacity of the pond from 8 to 10.
