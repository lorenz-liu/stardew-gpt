...
| --- | --- |
| Ossified Blade | |
| [Ossified Blade.png](/File:Ossified_Blade.png) | |
| A large, sharp blade formed from bone. | |
| Information | |
| Type: | Sword |
| Level: | 6 |
| Source: | [The Mines](/The_Mines "The Mines") |
| Damage: | 26-42 |
| Critical Strike Chance: | .02 |
| Stats: | Speed w.png [Speed](/Speed "Speed") (−2)Defense.png [Defense](/Defense "Defense") (+1)Weight.png [Weight](/Weight "Weight") (+2) |
| Adventurer's Guild | |
| Purchase Price: | N/A |
| Sell Price: | data-sort-value="300 ">Gold.png300g |

The **Ossified Blade** is a [sword weapon](/Weapons#Sword "Weapons") that can be obtained as a possible reward in the chest at floor 90 of [the Mines](/The_Mines "The Mines") if "remixed" mine rewards are selected in the [Advanced Options](/Options "Options") menu when starting a new game. It can also be found from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box") at the [Blacksmith](/Blacksmith "Blacksmith").
