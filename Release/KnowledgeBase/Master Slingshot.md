...
| --- | --- |
| Master Slingshot | |
| [Master Slingshot.png](/File:Master_Slingshot.png) | |
| Requires stones for ammo. | |
| Information | |
| Type: | Slingshot |
| Source: | Chest on Floor 70 of [The Mines](/The_Mines "The Mines") |
...
The **Master Slingshot** is a [slingshot weapon](/Weapons#Slingshot "Weapons") that can be obtained from the chest on floor 70 of [The Mines](/The_Mines "The Mines"). After that, it can be purchased at the Adventurer's Guild for data-sort-value="1000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,000g. Despite its description, many items other than [Stone](/Stone "Stone") can be used as ammunition with the Master Slingshot.

Unlike most weapons, using a Master Slingshot on a villager will decrease [friendship](/Friendship "Friendship") with them by 30 points. Using a master slingshot on the [cat or dog](/Animals#Cat_or_Dog "Animals") will produce a "hate" dialogue bubble, but will not decrease friendship.
...
* The [clipping glitch](/Weapons#Glitches "Weapons") that allows the player to enter the normally unreachable space around a map area does not work with slingshots.

## History

* [1.4](/Version_History#1.4 "Version History"): Slingshots can now be put in the inventory trash bin on computer and console (Mobile already had this ability).
* [1.5](/Version_History#1.5 "Version History"): Can be purchased at the Adventurer's Guild after unlocking.
...
| [Slingshots](/Weapons#Slingshot "Weapons") | [Slingshot](/Slingshot "Slingshot") • Master Slingshot • [Explosive Ammo](/Explosive_Ammo "Explosive Ammo") |
