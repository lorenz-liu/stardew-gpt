...
| --- | --- |
| Celestine | |
| [Celestine.png](/File:Celestine.png) | |
...
**Celestine** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Celestine is not used in any [bundles](/Bundles "Bundles").
...
Celestine is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt100.png](/mediawiki/images/thumb/0/0e/Shirt100.png/24px-Shirt100.png) [Shirt](/Tailoring "Tailoring"). It is an iron dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Celestine is not used in any [quests](/Quests "Quests").
