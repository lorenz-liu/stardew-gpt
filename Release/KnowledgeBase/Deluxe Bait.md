...
| --- | --- |
| Deluxe Bait | |
| [Deluxe Bait.png](/File:Deluxe_Bait.png) | |
| Causes fish to bite even faster and increases size of the "fishing bar". | |
| Information | |
| Source | [Fish Shop](/Fish_Shop "Fish Shop") • [Crafting](/Crafting "Crafting") • [Fishing Treasure Chests](/Fishing#Treasure_Chests "Fishing") • [Deluxe Worm Bin](/Deluxe_Worm_Bin "Deluxe Worm Bin") • [Bookseller](/Bookseller "Bookseller") • [Trout Derby](/Trout_Derby "Trout Derby") • [SquidFest](/SquidFest "SquidFest") |
| Energy | *Inedible* |
| Sell Price | data-sort-value="1">Gold.png1g |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 4) |
| Ingredients | Bait.png [Bait](/Bait_(item) "Bait (item)") (5)Moss.png [Moss](/Moss "Moss") (2) |
| Produces | 5 Bait per craft |

**Deluxe Bait** is used to reduce the delay before a nibble on a fishing rod by 67%.[[1]](#cite_note-fishbitetime-1) It also increases the [fishing bar size](/Fishing#Bar_Size "Fishing") by 12 pixels.[[2]](#cite_note-bobberbar-2) Deluxe Bait can be purchased at the [Fish Shop](/Fish_Shop "Fish Shop") after reaching [Fishing level 4](/Fishing#Fishing_Skill "Fishing") for data-sort-value="100">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100g each, [crafted](/Crafting#Fishing "Crafting"), randomly found in [Fishing Treasure Chests](/Fishing#Treasure_Chests "Fishing") after reaching Fishing level 6, or grown in a [Deluxe Worm Bin](/Deluxe_Worm_Bin "Deluxe Worm Bin").

Thirty Deluxe Bait are the reward for completing the ![Bundle Teal.png](/mediawiki/images/thumb/c/ce/Bundle_Teal.png/24px-Bundle_Teal.png) [River Fish Bundle](/Bundles#River_Fish_Bundle "Bundles") in the [Fish Tank](/Bundles#Fish_Tank "Bundles"). The [Bookseller](/Bookseller "Bookseller") trades 30 Deluxe Bait for 1 [Bait And Bobber](/Bait_And_Bobber "Bait And Bobber"). Twenty Deluxe Bait can be rewarded as a prize during the [Trout Derby](/Trout_Derby "Trout Derby") festival. Twenty Deluxe Bait is the copper tier reward on the 12th for the [SquidFest](/SquidFest "SquidFest") festival.

Deluxe Bait cannot be used with the [Training Rod](/Training_Rod "Training Rod") or the [Bamboo Pole](/Bamboo_Pole "Bamboo Pole"). Only the [Fiberglass Rod](/Fiberglass_Rod "Fiberglass Rod"), the [Iridium Rod](/Iridium_Rod "Iridium Rod"), and the [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") can use bait.

Deluxe Bait can also be used in a [Crab Pot](/Crab_Pot "Crab Pot"), where it decreases the chance of catching trash (if the player does not have the [Mariner](/Skills#Fishing "Skills") profession) compared to using [standard bait](/Bait_(item) "Bait (item)") and increases the quality of Crab Pot fish to silver.[[3]](#cite_note-crabpot-3)
...
Deluxe Bait is not used in any [bundles](/Bundles "Bundles").

## Quests

Deluxe Bait is not used in any [quests](/Quests "Quests").

## Tailoring

Deluxe Bait is not used in any [tailoring](/Tailoring "Tailoring") or [dyeing](/Dyeing "Dyeing").

## References

1. [↑](#cite_ref-fishbitetime_1-0) See `FishingRod::calculateTimeUntilFishingBite` in the game code.
2. [↑](#cite_ref-bobberbar_2-0) See `BobberBar::BobberBar` in the game code.
3. [↑](#cite_ref-crabpot_3-0) See `CrabPot::DayUpdate` in the game code.
...
| [Fishing](/Fishing "Fishing") | [Bait](/Bait "Bait") | [Bait](/Bait_(item) "Bait (item)") • [Challenge Bait](/Challenge_Bait "Challenge Bait") • Deluxe Bait • [Magic Bait](/Magic_Bait "Magic Bait") • [Magnet](/Magnet "Magnet") • [Targeted Bait](/Targeted_Bait "Targeted Bait") • [Wild Bait](/Wild_Bait "Wild Bait") |
