...
| --- | --- |
| Lunarite | |
| [Lunarite.png](/File:Lunarite.png) | |
...
**Lunarite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Lunarite is not used in any [bundles](/Bundles "Bundles").
...
Lunarite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Goodnight Shirt](/Tailoring "Tailoring"). [![Shirt188.png](/mediawiki/images/thumb/4/4e/Shirt188.png/24px-Shirt188.png)](/File:Shirt188.png)

## Quests

Lunarite is not used in any [quests](/Quests "Quests").
