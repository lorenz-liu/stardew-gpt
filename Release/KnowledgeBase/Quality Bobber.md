...
| --- | --- |
| Quality Bobber | |
| [Quality Bobber.png](/File:Quality_Bobber.png) | |
| Boosts the quality of fish that you catch. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | data-sort-value="300">Gold.png300g |
| Crafting | |
| Recipe Source | Willy Icon.png ["Juicy Bugs Wanted!"](/Quests#Juicy_Bugs_Wanted "Quests") Special Order |
| Ingredients | Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (1)Sap.png [Sap](/Sap "Sap") (20)Solar Essence.png [Solar Essence](/Solar_Essence "Solar Essence") (5) |

The **Quality Bobber** is a [tackle](/Tackle "Tackle") that increases the quality of fish caught by one level (*e.g.,* silver → gold). It can be [crafted](/Crafting "Crafting") from a recipe received from [Willy](/Willy "Willy") in the cutscene that follows the completion of the ["Juicy Bugs Wanted!"](/Quests#Juicy_Bugs_Wanted "Quests") Special Order. One Quality Bobber is received after solving the puzzle in [Journal Scrap #4](/Journal_Scraps#Journal_Scrap_.234 "Journal Scraps") on [Ginger Island](/Ginger_Island "Ginger Island").

Using two Quality Bobbers on an [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") increases the quality of fish caught by two levels.

Aside from getting perfect catches, using this tackle is the only way to catch iridium quality fish. It is one of two fishing tackle that cannot be bought from [Willy's Fish Shop](/Fish_Shop "Fish Shop"), along with the [Curiosity Lure](/Curiosity_Lure "Curiosity Lure").
...
The Quality Bobber is not used in any [bundles](/Bundles "Bundles").

## Quests

The Quality Bobber is not used in any [quests](/Quests "Quests").

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.5.3](/Version_History#1.5.3 "Version History"): Fixed bug where the Quality Bobber wasn't applying its bonus.
* [1.6](/Version_History#1.6 "Version History"): Increases the quality of fish caught by two levels when two Quality Bobbers are equipped at once.
