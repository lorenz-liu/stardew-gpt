...
| --- | --- |
| Starfruit Seeds | |
| [Starfruit Seeds.png](/File:Starfruit_Seeds.png) | |
| Plant these in the summer. Takes 13 days to mature. | |
| Information | |
| Crop: | Starfruit.png [Starfruit](/Starfruit "Starfruit") |
| Growth Time: | 13 days |
...
| Sandy Icon.png [Oasis](/Oasis "Oasis"): | data-sort-value="400">Gold.png400g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="200"Gold.png600–1,000g |

**Starfruit Seeds** are a type of seed. Mature plants yield [Starfruit](/Starfruit "Starfruit").

They can be purchased at the [Oasis](/Oasis "Oasis") and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). One seed can be obtained from [Gunther](/Gunther "Gunther") at the [Museum](/Museum "Museum") after donating 15 items. They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker"). 5 to 20 Starfruit Seeds may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern.

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 | Harvest |
| --- | --- | --- | --- | --- | --- |
| Starfruit Stage 1.png | Starfruit Stage 2.png | Starfruit Stage 3.png | Starfruit Stage 4.png | Starfruit Stage 5.png | Starfruit Stage 6.png |
