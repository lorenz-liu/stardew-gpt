...
| --- | --- |
| Sewing Machine | |
| [Sewing Machine.png](/File:Sewing_Machine.png) | |
| Use to tailor clothes from the convenience of your home! | |
| Information | |
| Source | Emily Icon.png ["Rock Rejuvenation"](/Quests#Rock_Rejuvenation "Quests") Special Order |
| Sell Price | *Cannot be sold* |

The **Sewing Machine** is a piece of equipment that can be used to [tailor](/Tailoring "Tailoring") or [dye](/Dyeing "Dyeing") clothing. It is received in the mail after completing [Emily](/Emily "Emily")'s ["Rock Rejuvenation"](/Quests#Rock_Rejuvenation "Quests") special order. It functions the same as the sewing machine at [2 Willow Lane](/2_Willow_Lane#Sewing_Machine "2 Willow Lane").

If the original is lost, a replacement can be purchased at the [Lost Items Shop](/Secret_Woods#Lost_Items_Shop "Secret Woods") in the Secret Woods for data-sort-value="10000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)10,000g.

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.6.9](/Version_History#1.6.9 "Version History"): If the original is lost, a replacement can be purchased at the [Lost Items Shop](/Secret_Woods#Lost_Items_Shop "Secret Woods") in the Secret Woods.
