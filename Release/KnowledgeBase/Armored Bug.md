...
| --- | --- |
| Armored Bug | |
| [Armored Bug Anim.gif](/File:Armored_Bug_Anim.gif) | |
| Information | |
...
| Speed: | 2 |
| XP: | 1 |
| Variations: | Bug.png [Bug](/Bug "Bug")Bug Dangerous.png [Bug (dangerous)](/Bug_(dangerous) "Bug (dangerous)")Armored Bug Dangerous.png [Armored Bug (dangerous)](/Armored_Bug_(dangerous) "Armored Bug (dangerous)") |
| Drops: | Ancient Seed.png [Ancient Seed](/Ancient_Seed "Ancient Seed") (0.5%)Bug Meat.png [Bug Meat](/Bug_Meat "Bug Meat") (76%)Bug Steak.png [Bug Steak](/Bug_Steak "Bug Steak") (10%)Dwarf Scroll I.png [Dwarf Scroll I](/Dwarf_Scroll_I "Dwarf Scroll I") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)White Algae.png [White Algae](/White_Algae "White Algae") (2%)Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Armored Bugs** are an [enemy](/Monsters "Monsters") found in the [Skull Cavern](/Skull_Cavern "Skull Cavern"). They are invincible except when attacked by a weapon with the Bug Killer [enchantment](/Forge#Enchantments "Forge"). 80 cave insects (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").
...
* [1.4](/Version_History#1.4 "Version History"): Can no longer be stopped by blocking with sword.
* [1.5](/Version_History#1.5 "Version History"): Can be killed with enchanted weapons.
