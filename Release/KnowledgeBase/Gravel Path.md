...
| --- | --- |
| Gravel Path | |
| [Gravel Path.png](/File:Gravel_Path.png) | |
...
The **Gravel Path** is a [crafted item](/Crafting#Decor "Crafting") used to create decorative paths. It can be displaced by lightning or destroyed by [weeds](/Weeds "Weeds").
...
* [![](/mediawiki/images/thumb/2/26/Gravel_Path_Tile.png/120px-Gravel_Path_Tile.png)](/File:Gravel_Path_Tile.png)

  Spring, Summer, & Fall
* [![](/mediawiki/images/thumb/b/ba/Gravel_Path_Tile_Winter.png/120px-Gravel_Path_Tile_Winter.png)](/File:Gravel_Path_Tile_Winter.png)
...
| Paths | [Cobblestone Path](/Cobblestone_Path "Cobblestone Path") • [Crystal Path](/Crystal_Path "Crystal Path") • Gravel Path • [Stepping Stone Path](/Stepping_Stone_Path "Stepping Stone Path") • [Wood Path](/Wood_Path "Wood Path") |