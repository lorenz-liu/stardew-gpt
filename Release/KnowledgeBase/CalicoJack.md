...
**CalicoJack** is one of the forms of gambling available in the [Casino](/Casino "Casino"). It is a modified version of blackjack. There are two tables playing the game in the casino, one low stakes (100 Qi coins bet) and one high stakes (1,000 Qi coins bet).
...
Neither daily [Luck](/Luck "Luck") nor luck buffs from eating food affect the results of CalicoJack. The odds of winning, however, slightly favor the player rather than the house.
...
* [![](/mediawiki/images/thumb/2/26/CalicoJack_low_bid_table.png/118px-CalicoJack_low_bid_table.png)](/File:CalicoJack_low_bid_table.png)

  Low bid table
* [![](/mediawiki/images/thumb/7/7e/CalicoJack_table_high_bid_table.png/89px-CalicoJack_table_high_bid_table.png)](/File:CalicoJack_table_high_bid_table.png)

  High bid table
* [![](/mediawiki/images/thumb/4/45/Calicojack_game.png/120px-Calicojack_game.png)](/File:Calicojack_game.png)

  Main game screen
* [![](/mediawiki/images/thumb/4/45/Calicojack_lose.png/120px-Calicojack_lose.png)](/File:Calicojack_lose.png)

  Lose screen
* [![](/mediawiki/images/thumb/6/63/Calicojack_win.png/120px-Calicojack_win.png)](/File:Calicojack_win.png)
...
* [1.4](/Version_History#1.4 "Version History"): Casino mini-games now slightly favor the player rather than the house. Added number of Qi coins to game display.