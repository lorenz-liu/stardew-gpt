...
| --- | --- |
| Squid Kid (dangerous) | |
| [Squid Kid Dangerous.png](/File:Squid_Kid_Dangerous.png) | |
| Information | |
| Spawns In: | * [The Dangerous Mines](/The_Mines#Shrine_of_Challenge "The Mines") * [Skull Cavern](/Skull_Cavern "Skull Cavern") |
| Floors: | 91-119 [[1]](#cite_note-level-1) |
| Killable: | Yes |
| Base HP: | 250 |
| Base Damage: | 22-32 |
| Base Def: | 6 |
| Speed: | 3 |
| XP: | 15 |
| Variations: | Squid Kid.png [Squid Kid](/Squid_Kid "Squid Kid") |
| Drops: | Bomb.png [Bomb](/Bomb "Bomb") (10%)Dwarf Scroll III.png [Dwarf Scroll III](/Dwarf_Scroll_III "Dwarf Scroll III") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (5%)Mega Bomb.png [Mega Bomb](/Mega_Bomb "Mega Bomb") (5%)Solar Essence.png [Solar Essence](/Solar_Essence "Solar Essence") (75%)Squid Ink.png [Squid Ink](/Squid_Ink "Squid Ink") (20%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Squid Kids (dangerous)** are an [enemy](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") after activating the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") or during the [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") quest. They can also be found in the [Skull Cavern](/Skull_Cavern "Skull Cavern") during the [Skull Cavern Invasion](/Quests#Skull_Cavern_Invasion "Quests") quest.

## Behavior

They behave identical to their weaker counterpart, the [Squid Kid](/Squid_Kid "Squid Kid"). They will move suddenly, hover over rocks, and shoot 4 fireballs at the player, which ricochet off walls.

## Strategy

Simply move in quickly and hit them. A [Slingshot](/Slingshot "Slingshot") can be used to safely kill them from a distance. Their fireballs can also be hit and destroyed; however, fireballs will *not* be stopped by a sword's secondary attack.

## References

1. [↑](#cite_ref-level_1-0) See `StardewValley.Locations.MineShaft::getMonsterForThisLevel` in the game code.
