...
| --- | --- |
| Blobfish | |
| [Blobfish.png](/File:Blobfish.png) | |
| This odd creature floats above the ocean floor, consuming any edible material in its path. | |
| Information | |
| Location | Submarine at [Night Market](/Night_Market "Night Market") |
| Time | Anytime during [Night Market](/Night_Market "Night Market") (5pm - 2am) |
| Season | Winter.png [Winter](/Winter "Winter") |
| Weather | [Any](/Weather "Weather") |
| Difficulty | 75 |
| Behavior | [Floater](/Fish#Behavior "Fish") |
| Size (inches) | 8–26 |
| Fishing XP | 28   Silver Quality.png 31   Gold Quality.png 34   Iridium Quality.png 40 |
...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Blobfish.png | 500g | | Blobfish.png  Silver Quality Icon.png | 625g | | Blobfish.png  Gold Quality Icon.png | 750g | | Blobfish.png  Iridium Quality Icon.png | 1,000g | | |  |  | | --- | --- | | Blobfish.png | 625g | | Blobfish.png  Silver Quality Icon.png | 781g | | Blobfish.png  Gold Quality Icon.png | 937g | | Blobfish.png  Iridium Quality Icon.png | 1,250g | | |  |  | | --- | --- | | Blobfish.png | 750g | | Blobfish.png  Silver Quality Icon.png | 937g | | Blobfish.png  Gold Quality Icon.png | 1,125g | | Blobfish.png  Iridium Quality Icon.png | 1,500g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Beige Roe.png | 280g | | |  |  | | --- | --- | | Beige Aged Roe.png | 560g | | |  |  | | --- | --- | | Beige Aged Roe.png | 784g | | | |

The **Blobfish** is a [fish](/Fish "Fish") that can be caught in the submarine ride at the [Night Market](/Night_Market "Night Market"), which takes place at [The Beach](/The_Beach "The Beach") during [Winter](/Winter "Winter") 15-17. It can also be caught by using [Magic Bait](/Magic_Bait "Magic Bait") in the southwest corner of the beach: From the left-most pier, in the southwestern corner, fish facing west.

In the submarine ride at the Night Market, there is a 10% chance to hook a Blobfish (20% if using a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure")). If using Magic Bait in the southwest corner of the beach, there is a 3.3% chance to hook a Blobfish (10.2% if using a Curiosity Lure).[[1]](#cite_note-requirements-1)

The Blobfish and the [Pufferfish](/Pufferfish "Pufferfish") are the only [fishing rod fishes](/Fish#Fishing_Pole_Fish "Fish") that have a "floater" behavior in the fishing mini-game.

## Map

Blobfish can be found in the submarine ride at the [Night Market](/Night_Market "Night Market") ([Winter](/Winter "Winter") 15-17).

![Maplocation.png](/mediawiki/images/thumb/5/5c/Maplocation.png/20px-Maplocation.png)

![Map.png](/mediawiki/images/4/43/Map.png)

[![](/mediawiki/images/thumb/e/ec/NightMarketMagicBaitArea.png/300px-NightMarketMagicBaitArea.png)](/File:NightMarketMagicBaitArea.png)
...
Blobfish is an option in the ![Bundle Red.png](/mediawiki/images/thumb/3/3f/Bundle_Red.png/24px-Bundle_Red.png) [Master Fisher's Bundle](/Remixed_Bundles#Master_Fishers_Bundle "Remixed Bundles") in the [Fish Tank (Remixed)](/Remixed_Bundles#Fish_Tank "Remixed Bundles").
...
Blobfish is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the ![Blobfish Mask.png](/mediawiki/images/thumb/a/a5/Blobfish_Mask.png/24px-Blobfish_Mask.png) [Blobfish Mask](/Blobfish_Mask "Blobfish Mask"). It can be used in [dyeing](/Dyeing "Dyeing"), serving as a yellow dye in the dye pots, located at [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Fish Pond

Blobfish can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"), where they will reproduce every 4 days. The initial pond capacity is 1 fish, but the capacity can be increased to 10 by completing four quests. The primary output is beige Blobfish [Roe](/Roe "Roe"), but more valuable items are possible starting at population 9.
...
| 1 | 3 | 3 [Coral](/Coral "Coral"), 2 [Frozen Tears](/Frozen_Tear "Frozen Tear"), or 2 [Sea Urchins](/Sea_Urchin "Sea Urchin") | 40 |
| 3 | 5 | 5 [Coffee Beans](/Coffee_Bean "Coffee Bean"), 1 [Mayonnaise](/Mayonnaise "Mayonnaise"), or 1 [Pizza](/Pizza "Pizza") | 40 |
| 5 | 7 | 1 [Cookie](/Cookie "Cookie"), 1 [Green Tea](/Green_Tea "Green Tea"), or 1 [Wine](/Wine "Wine") | 40 |
| 7 | 10 | 1 [Rainbow Shell](/Rainbow_Shell "Rainbow Shell") or 1 [Rice Pudding](/Rice_Pudding "Rice Pudding") | 40 |

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Beige Roe.png [Roe](/Roe "Roe") (1) | 21 | 1-5 | 90% | 21-50% |
| 6-8 | 50% | 32-40% |
| 9-10 | 48% | 42-46% |
| Beige Roe.png [Roe](/Roe "Roe") (2) | 21 | 6-8 | 50% | 32-40% |
| 9-10 | 48% | 42-46% |
| Pearl.png [Pearl](/Pearl "Pearl") (1) | 110 | 9-10 | 2% | 1.7-1.9% |
| Warp Totem Farm.png [Warp Totem: Farm](/Warp_Totem:_Farm "Warp Totem: Farm") (5) | 10 | 9-10 | 2% | 1.7-1.9% |
| *Nothing* |  | 1-5 | 10% | 79-50% |
| 6-8 | 0% | 37-21% |
| 9-10 | 0% | 13-5% |

## Quests

Blobfish is not used in any [quests](/Quests "Quests").

## Notes

* Due to the small size of the Submarine pond limiting its tiles' [distance from land](/Fishing#Distance_from_Land "Fishing"), the Blobfish can only be caught at its maximum [Size](/Fishing#Fish_Size_.26_Quality "Fishing") of 26" when fishing on the Beach using Magic Bait.

## References

1. [↑](#cite_ref-requirements_1-0) See `Data\Locations.xnb` in the game files.

## History

* [1.3.27](/Version_History#1.3.27 "Version History"): Introduced.
* [1.4](/Version_History#1.4 "Version History"): Added iridium quality. Can now be used in [Tailoring](/Tailoring "Tailoring").
* [1.5](/Version_History#1.5 "Version History"): Is now used in a remixed bundle. Chance of catching it in the submarine can now be increased by using a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure").
* [1.5.3](/Version_History#1.5.3 "Version History"): Can now be caught by using [Magic Bait](/Magic_Bait "Magic Bait") in the southwest corner of [the Beach](/The_Beach "The Beach").
* [1.6](/Version_History#1.6 "Version History"): Fixed bug allowing all Night Market fish to be hooked with the [Training Rod](/Training_Rod "Training Rod") during the submarine ride. Chance of hooking using [Magic Bait](/Magic_Bait "Magic Bait") in the southwest corner of [the Beach](/The_Beach "The Beach") using a [Curiosity Lure](/Curiosity_Lure "Curiosity Lure") increased.
...
| [Night Market](/Night_Market "Night Market") | Blobfish • [Midnight Squid](/Midnight_Squid "Midnight Squid") • [Octopus](/Octopus "Octopus") • [Sea Cucumber](/Sea_Cucumber "Sea Cucumber") • [Spook Fish](/Spook_Fish "Spook Fish") • [Super Cucumber](/Super_Cucumber "Super Cucumber") |
