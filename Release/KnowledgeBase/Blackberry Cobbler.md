...
| --- | --- |
| Blackberry Cobbler | |
| [Blackberry Cobbler.png](/File:Blackberry_Cobbler.png) | |
| There's nothing quite like it. | |
| Information | |
| Source | [Cooking](/Cooking "Cooking") |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 175 | Health.png | 78 | |
| Sell Price | |  |  | | --- | --- | | Blackberry Cobbler.png | 260g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 315 | Health.png  Gold Quality Icon.png | 141 | |  | |  |  | | --- | --- | | Blackberry Cobbler.png  Gold Quality Icon.png | 390g | | |
| Recipe | |
| Recipe Source(s) | |  |  | | --- | --- | | Cooking Channel.png | [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") | | 14 Fall, Year 2 | |
| Ingredients | Blackberry.png [Blackberry](/Blackberry "Blackberry") (2)Sugar.png [Sugar](/Sugar "Sugar") (1)Wheat Flour.png [Wheat Flour](/Wheat_Flour "Wheat Flour") (1) |

**Blackberry Cobbler** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit"). It can also be received as a gift at the [Feast of the Winter Star](/Feast_of_the_Winter_Star "Feast of the Winter Star").

**Note:** This recipe can be [profitable](/Cooking#Profitable_Recipes "Cooking") - it will result in profit when using the lowest quality ingredients without [Bear's Knowledge](/Bear%27s_Knowledge "Bear's Knowledge"), or if using [Wheat Flour](/Wheat_Flour "Wheat Flour") and/or [Sugar](/Sugar "Sugar") from the [Mill](/Mill "Mill").

## Gifting

| Villager Reactions | |
| --- | --- |
| Love | [Abigail Icon.png](/Abigail "Abigail") [Abigail](/Abigail "Abigail") |
...
Blackberry Cobbler is not used in any [bundles](/Bundles "Bundles").
...
Blackberry Cobbler is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt058.png](/mediawiki/images/thumb/9/94/Shirt058.png/24px-Shirt058.png)](/File:Shirt058.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as a blue dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Blackberry Cobbler is not used in any [quests](/Quests "Quests").
