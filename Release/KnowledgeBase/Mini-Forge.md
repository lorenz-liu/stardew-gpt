...
| --- | --- |
| Mini-Forge | |
| [Mini-Forge.png](/File:Mini-Forge.png) | |
| Now, you can use a dwarvish forge from the convenience of your home. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Mastery Icon.png [Combat Mastery](/Mastery_Cave#Masteries "Mastery Cave") |
| Ingredients | Dragon Tooth.png [Dragon Tooth](/Dragon_Tooth "Dragon Tooth") (5)Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (10)Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (10)Iridium Bar.png [Iridium Bar](/Iridium_Bar "Iridium Bar") (5) |

The **Mini-Forge** is a portable version of the [Forge](/Forge "Forge") found on Floor 10 in the [Volcano Dungeon](/Volcano_Dungeon "Volcano Dungeon"). It can be [crafted](/Crafting "Crafting") after claiming [Combat Mastery](/Mastery_Cave#Masteries "Mastery Cave").
