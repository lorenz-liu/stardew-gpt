...
| Sell Price | data-sort-value="110 ">Gold.png110g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="143 ">Gold.png143g |

**Marble** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Marble is not used in any [bundles](/Bundles "Bundles").

## Recipes

| Image | Name | Description | Ingredients | Recipe Source |
| --- | --- | --- | --- | --- |
| [Marble Brazier.png](/File:Marble_Brazier.png) | [Marble Brazier](/Marble_Brazier "Marble Brazier") | Provides a moderate amount of light. | Marble.png Marble (1)Aquamarine.png [Aquamarine](/Aquamarine "Aquamarine") (1)Stone.png [Stone](/Stone "Stone") (100) | Robin Icon.png [Carpenter's Shop](/Carpenter%27s_Shop "Carpenter's Shop") for data-sort-value="5000">Gold.png5,000g |

## Tailoring

Marble is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Toga Shirt](/Tailoring "Tailoring"). [![Shirt199.png](/mediawiki/images/thumb/0/0e/Shirt199.png/24px-Shirt199.png)](/File:Shirt199.png)

## Quests

Marble is not used in any [quests](/Quests "Quests").
