...
| --- | --- |
| Iridium Sprinkler | |
| [Iridium Sprinkler.png](/File:Iridium_Sprinkler.png) | |
| Waters the 24 adjacent tiles every morning. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") • [Krobus](/Krobus "Krobus") • [Mayor Lewis' Prize Machine](/Mayor%27s_Manor#Prize_Machine "Mayor's Manor") |
| Sell Price | data-sort-value="1000">Gold.png1,000g |
| Crafting | |
| Recipe Source | [Farming Skill Icon.png](/File:Farming_Skill_Icon.png) [Farming](/Farming "Farming") Level 9 |
| Ingredients | Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (1)Iridium Bar.png [Iridium Bar](/Iridium_Bar "Iridium Bar") (1)Battery Pack.png [Battery Pack](/Battery_Pack "Battery Pack") (1) |

The **Iridium Sprinkler** is a [crafted](/Crafting "Crafting") item that waters the 24 adjacent tiles every morning (a 5x5 area). Only tilled tiles will be watered. The Iridium Sprinkler is unlocked at [Farming](/Farming "Farming") level 9.

One Iridium Sprinkler can be purchased from [Krobus](/Krobus "Krobus") for data-sort-value="10000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)10,000g every Friday. One to two Iridium Sprinklers may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern. An Iridium Sprinkler may also randomly be a reward from [Mayor Lewis' Prize Machine](/Mayor%27s_Manor#Prize_Machine "Mayor's Manor"), in exchange for a [Prize Ticket](/Prize_Ticket "Prize Ticket").

A [Torch](/Torch "Torch") can be placed on an Iridium Sprinkler to provide minimal lighting in the dark.

[Sprinklers](/Crafting#Sprinklers "Crafting") cannot be used to water [Garden Pots](/Garden_Pot "Garden Pot") or the [pet's](/Animals#Cat_or_Dog "Animals") water bowl. Sprinklers cannot be placed on sand.

[![IridiumSprinklerExample.png](/mediawiki/images/thumb/a/a8/IridiumSprinklerExample.png/150px-IridiumSprinklerExample.png)](/File:IridiumSprinklerExample.png)
...
| [Iridium Sprinkler.png](/File:Iridium_Sprinkler.png) | Iridium Sprinkler | Waters the 24 adjacent tiles every morning. | Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (1)Iridium Bar.png [Iridium Bar](/Iridium_Bar "Iridium Bar") (1)Battery Pack.png [Battery Pack](/Battery_Pack "Battery Pack") (1) | Farming Skill Icon.png [Farming](/Farming "Farming") Level 9 |
...
| --- | --- | --- | --- | --- |
| [Pressure Nozzle.png](/File:Pressure_Nozzle.png) | [Pressure Nozzle](/Pressure_Nozzle "Pressure Nozzle") (4) | Place on a sprinkler to increase its watering range. | [PressureNozzleSprinklers.png](/File:PressureNozzleSprinklers.png) | data-sort-value="20">Qi Gem.png 20 |
| [Enricher.png](/File:Enricher.png) | [Enricher](/Enricher "Enricher") (4) | Place on a sprinkler and load with fertilizer to automatically apply it when planting seeds nearby. | [EnricherSprinklers.png](/File:EnricherSprinklers.png) | data-sort-value="20">Qi Gem.png 20 |
...
The Iridium Sprinkler is not used in any [bundles](/Bundles "Bundles").

## Quests

The Iridium Sprinkler is not used in any [quests](/Quests "Quests").

## History

* [1.5](/Version_History#1.5 "Version History"): Improved sprinklers: Sprinklers can now water [slime hutch](/Slime_Hutch "Slime Hutch") troughs. [Hoes](/Hoes "Hoes") no longer remove sprinklers. Added [enricher](/Enricher "Enricher") and [pressure nozzle](/Pressure_Nozzle "Pressure Nozzle") upgrades.
* [1.6](/Version_History#1.6 "Version History"): Can now have a [Torch](/Torch "Torch") placed on it.
...
| [Sprinklers](/Crafting#Sprinklers "Crafting") | Iridium Sprinkler • [Quality Sprinkler](/Quality_Sprinkler "Quality Sprinkler") • [Sprinkler](/Sprinkler "Sprinkler") |
