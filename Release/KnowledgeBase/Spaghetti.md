...
| --- | --- |
| Spaghetti | |
| [Spaghetti.png](/File:Spaghetti.png) | |
| An old favorite. | |
| Information | |
...
| Sell Price | |  |  | | --- | --- | | Spaghetti.png | 120g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 135 | Health.png  Gold Quality Icon.png | 60 | |  | |  |  | | --- | --- | | Spaghetti.png  Gold Quality Icon.png | 180g | | |
| Recipe | |
| Recipe Source(s) | Lewis Icon.png [Lewis](/Lewis "Lewis") (Mail - 3+ HeartIconLarge.png) |
| Ingredients | Wheat Flour.png [Wheat Flour](/Wheat_Flour "Wheat Flour") (1)Tomato.png [Tomato](/Tomato "Tomato") (1) |

**Spaghetti** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").

Spaghetti is available for purchase daily at [The Stardrop Saloon](/The_Stardrop_Saloon "The Stardrop Saloon") for data-sort-value="240">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)240g and may randomly appear in [Krobus](/Krobus "Krobus")' shop on [Saturdays](/Days_of_the_Week#Saturday "Days of the Week"). The [Statue Of Endless Fortune](/Statue_Of_Endless_Fortune "Statue Of Endless Fortune") produces one Spaghetti per year on [Robin](/Robin "Robin")'s birthday, [Fall 21](/Fall "Fall"). One Spaghetti may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").

## Gifting

| Villager Reactions | |
| --- | --- |
| Love | [Robin Icon.png](/Robin "Robin") [Robin](/Robin "Robin") |
...
Spaghetti is not used in any [bundles](/Bundles "Bundles").
...
Spaghetti is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Sauce-Stained Shirt](/Tailoring "Tailoring"). [![Shirt236.png](/mediawiki/images/thumb/d/dc/Shirt236.png/24px-Shirt236.png)](/File:Shirt236.png) It can also be used as a red dye in the dye pots, located at [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Spaghetti is not used in any [quests](/Quests "Quests").
