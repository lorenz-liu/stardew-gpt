...
| --- | --- |
| Magic Bait | |
| [Magic Bait.png](/File:Magic_Bait.png) | |
| Allows you to catch fish from any season, time, or weather, from whichever type of water you cast into. | |
| Information | |
| Source | [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="5">Qi Gem.png 5 |
| Energy | *Inedible* |
| Sell Price | data-sort-value="1">Gold.png1g |
| Crafting | |
| Recipe Source | [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="20">Qi Gem.png 20 |
| Ingredients | Radioactive Ore.png [Radioactive Ore](/Radioactive_Ore "Radioactive Ore") (1)Bug Meat.png [Bug Meat](/Bug_Meat "Bug Meat") (3) |
| Produces | 5 Bait per craft |

**Magic Bait** is a type of [bait](/Bait "Bait") that provides the ability to catch any fish from that source regardless of weather, time, or season. Magic Bait has the same effect on fish bite rate as standard [Bait](/Bait_(item) "Bait (item)") (decreasing biting time by 50%).[[1]](#cite_note-fishbitetime-1)

Magic Bait cannot be used with the [Training Rod](/Training_Rod "Training Rod") or the [Bamboo Pole](/Bamboo_Pole "Bamboo Pole"). Only the [Fiberglass Rod](/Fiberglass_Rod "Fiberglass Rod"), the [Iridium Rod](/Iridium_Rod "Iridium Rod"), and the [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") can use bait. It can also technically be inserted into a [Crab Pot](/Crab_Pot "Crab Pot"), but it is no better than [standard bait](/Bait_(item) "Bait (item)") as all crab pot fish can be caught regardless of weather or season.

20 Magic Bait can be purchased from the shop in [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="5">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 5. The recipe to craft Magic Bait can also be purchased for data-sort-value="20">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 20.
...
[![](/mediawiki/images/thumb/e/ec/NightMarketMagicBaitArea.png/120px-NightMarketMagicBaitArea.png)](/File:NightMarketMagicBaitArea.png)

Area for Night Market fish

See [the fish location tables](/Fishing_Strategy#Location_Tables "Fishing Strategy") for a list of all fish that can be caught in a specific area. As long as the fish can be caught at some point in a specific area, it can be caught anytime by using Magic Bait. [Night Market Fish](/Fish#Night_Market_Fish "Fish") can be caught anytime using Magic Bait in the southwest corner of [The Beach](/The_Beach "The Beach"). [Legendary Fish](/Fish#Legendary_Fish "Fish") can be caught anytime in their specific locations by using Magic Bait.
...
Magic Bait is not used in any [bundles](/Bundles "Bundles").

## Quests

Magic Bait is not used in any [quests](/Quests "Quests").
...
* [1.5.2](/Version_History#1.5.2 "Version History"): Fixed crash when fishing from the pond on [the Farm](/The_Farm "The Farm") using Magic Bait.
* [1.5.3](/Version_History#1.5.3 "Version History"): Can now catch [Night Market fish](/Fish#Night_Market_Fish "Fish") using Magic Bait in the southwest corner of [the Beach](/The_Beach "The Beach").
* [1.6](/Version_History#1.6 "Version History"): Fixed bug where Magic Bait disabled some fish area checks, which allowed players to catch river fish in the forest pond, for example. Can be used in the [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod").
...
| [Fishing](/Fishing "Fishing") | [Bait](/Bait "Bait") | [Bait](/Bait_(item) "Bait (item)") • [Challenge Bait](/Challenge_Bait "Challenge Bait") • [Deluxe Bait](/Deluxe_Bait "Deluxe Bait") • Magic Bait • [Magnet](/Magnet "Magnet") • [Targeted Bait](/Targeted_Bait "Targeted Bait") • [Wild Bait](/Wild_Bait "Wild Bait") |
