...
| --- | --- |
| Basic Fertilizer | |
| [Basic Fertilizer.png](/File:Basic_Fertilizer.png) | |
| Improves soil quality a little, increasing your chance to grow quality crops. Mix into tilled soil. | |
| Information | |
| Source | [Pierre's](/Pierre%27s_General_Store "Pierre's General Store") • [Crafting](/Crafting "Crafting") |
| Sell Price | data-sort-value="2">Gold.png2g |
| Recipe | |
| Recipe Source(s) | Farming Skill Icon.png [Farming](/Farming "Farming") Level 1 |
| Ingredients | Sap.png [Sap](/Sap "Sap") (2) |
| Produces | 1 Basic Fertilizer per craft |

**Basic Fertilizer** is a [Fertilizer](/Fertilizer "Fertilizer") that helps by improving soil quality. It can be [crafted](/Crafting "Crafting") or purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") for data-sort-value="100">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100g starting on [Spring](/Spring "Spring") 15th of year 1. [[1]](#cite_note-unlock-1)

Basic Fertilizer must be placed on tilled soil *before* a seed has sprouted.

Basic Fertilizer affects only the basic harvest, which means that extra crops gained at a single harvest (*i.e.,* [Coffee Bean](/Coffee_Bean "Coffee Bean"), [Blueberry](/Blueberry "Blueberry"), [Cranberries](/Cranberries "Cranberries")) will be regular quality.
...
Basic Fertilizer is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Basic Fertilizer can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [High-Waisted Shirt](/Tailoring "Tailoring"). [![Shirt174.png](/mediawiki/images/thumb/6/65/Shirt174.png/24px-Shirt174.png)](/File:Shirt174.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Basic Fertilizer is not used in any [quests](/Quests "Quests").

## History

* [1.4](/Version_History#1.4 "Version History"): Basic Fertilizer can be applied to seeds (but can't be applied once a seed has sprouted). Can now be used in [Tailoring](/Tailoring "Tailoring").

## References

1. [↑](#cite_ref-unlock_1-0) See `SeedShop::shopStock` in the game code.
