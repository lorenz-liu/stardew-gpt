...
| --- | --- |
| Jazz Seeds | |
| [Jazz Seeds.png](/File:Jazz_Seeds.png) | |
| Plant in spring. Takes 7 days to produce a blue puffball flower. | |
| Information | |
| Crop: | Blue Jazz.png [Blue Jazz](/Blue_Jazz "Blue Jazz") |
| Growth Time: | 7 days |
| Season: | Spring.png [Spring](/Spring "Spring") |
| Sell Price: | data-sort-value="15">Gold.png15g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="30">Gold.png30g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="37">Gold.png37g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="15"Gold.png100–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 15): | data-sort-value="30">Gold.png30g |

**Jazz Seeds** are a type of seed. Mature plants yield [Blue Jazz](/Blue_Jazz "Blue Jazz") flowers.

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), at [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 15, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker") or by planting [Mixed Flower Seeds](/Mixed_Flower_Seeds "Mixed Flower Seeds").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Harvest |
| --- | --- | --- | --- | --- |
| Blue Jazz Stage 1.png | Blue Jazz Stage 2.png | Blue Jazz Stage 3.png | Blue Jazz Stage 4.png | Blue Jazz Stage 5.png |
