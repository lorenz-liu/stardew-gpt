#!/usr/bin/env python3
"""
Stardew Valley Wiki Scraper (Chinese)
Downloads Chinese wiki pages and saves them as JSON for embedding.
"""
...
class StardewWikiScraperCN:
    """Scraper for Stardew Valley Chinese Wiki."""

    def __init__(self, output_dir: str = "wiki_data_cn"):
        self.base_url = "https://zh.stardewvalleywiki.com"
    ...
    def scrape_all_pages(self, output_file: str = "wiki_data_cn.json"):
    ...
    def scrape_specific_categories(self, categories: List[str], output_file: str = "wiki_data_cn.json"):
...
def main():
    parser = argparse.ArgumentParser(description="Scrape Stardew Valley Chinese Wiki")
    parser.add_argument("--output-dir", default="wiki_data_cn", help="Output directory")
    parser.add_argument("--output-file", default="wiki_data_cn.json", help="Output JSON file name")
    ...
    scraper = StardewWikiScraperCN(args.output_dir)
