...
if [ ! -f "wiki_data/wiki_data.json" ]; then
    ...
    python3 scrape_wiki_en.py --output-dir wiki_data --output-file wiki_data.json
else
    echo ""
...
python3 build_database.py \
    ...
    --output knowledge_en.db \
    --batch-size 100

# Step 3: Copy to parent directory
echo ""
echo "Step 3: Copying database to mod directory..."
cp knowledge_en.db ../knowledge_en.db
echo "Database copied to ../knowledge_en.db"
