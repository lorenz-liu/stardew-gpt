...
| --- | --- |
| Treasure Hunter | |
| [Treasure Hunter.png](/File:Treasure_Hunter.png) | |
| Fish don't escape while collecting treasures. Also slightly increases the chance to find treasures. | |
| Information | |
| Source | [Fish Shop](/Fish_Shop "Fish Shop") • [Crafting](/Crafting "Crafting") |
| Sell Price | data-sort-value="250">Gold.png250g |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 7) |
| Ingredients | Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (2) |

The **Treasure Hunter** is a [tackle](/Tackle "Tackle") that helps [fishing](/Fishing "Fishing") by preventing [fish](/Fish "Fish") from escaping while collecting [treasure chests](/Fishing#Treasure_Chests "Fishing") and by increasing the chance to find treasure chests by 5% (10% if the player is using an [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") with 2 Treasure Hunters). It can be [crafted](/Crafting "Crafting") or purchased from [Willy's Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="750">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)750g after reaching [Fishing level 7](/Fishing#Fishing_Skill "Fishing"). It may also randomly appear at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="250"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)750–1,250g.
...
The Treasure Hunter is not used in any [bundles](/Bundles "Bundles").

## Quests

The Treasure Hunter is not used in any [quests](/Quests "Quests").

## Notes

It is cheaper to purchase a Treasure Hunter at the [Fish Shop](/Fish_Shop "Fish Shop") than to purchase the [Gold Ore](/Gold_Ore "Gold Ore") and [Coal](/Coal "Coal") required to make 2 [Gold Bars](/Gold_Bar "Gold Bar").

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): Increases the chance of finding treasure chests by 10% when two Treasure Hunters are equipped at once.
