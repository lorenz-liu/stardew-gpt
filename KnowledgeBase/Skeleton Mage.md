...
| --- | --- |
| Skeleton Mage | |
| [Skeleton Mage Dangerous Anim.gif](/File:Skeleton_Mage_Dangerous_Anim.gif) | |
| Information | |
| Spawns In: | [Dangerous Mines](/The_Mines#Shrine_of_Challenge "The Mines"), [Quarry Mine](/Quarry_Mine "Quarry Mine") |
| Floors: | 71-79 |
| Killable: | Yes |
| Base HP: | 355 |
| Base Damage: | 20-25 |
...
| Speed: | 2 |
| XP: | 8 |
| Variations: | Skeleton.png [Skeleton](/Skeleton "Skeleton")Skeleton Dangerous.png [Skeleton (dangerous)](/Skeleton_(dangerous) "Skeleton (dangerous)") |
| Drops: | Bone Fragment.png [Bone Fragment](/Bone_Fragment "Bone Fragment") (50%)Bone Fragment.png [Bone Fragment](/Bone_Fragment "Bone Fragment") (40%)Bone Fragment.png [Bone Fragment](/Bone_Fragment "Bone Fragment") (20%)Bone Sword.png [Bone Sword](/Bone_Sword "Bone Sword") (4%)Prehistoric Scapula.png [Prehistoric Scapula](/Prehistoric_Scapula "Prehistoric Scapula") (0.5%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Skeleton Mages** are an [enemy](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") or after activating the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") or during the [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") quest. They can also be found in the [Quarry Mine](/Quarry_Mine "Quarry Mine") at any time. 50 Skeletons (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").

## Behavior

Skeleton Mages have two distinct spells that fire from a distance, a white spell that follows a straight line and deals damage to the player, and a blue spell that "trembles", similar to the [Shadow Shaman](/Shadow_Shaman "Shadow Shaman") long-distance spell, and causes the ![Frozen.png](/mediawiki/images/thumb/8/86/Frozen.png/24px-Frozen.png) [Frozen](/Buffs#Frozen "Buffs") debuff, paralyzing the player for 2 seconds. In addition to casting spells, the Skeleton Mage approaches the player to deal collision damage.
...
* [1.6](/Version_History#1.6 "Version History"): Can be found in [Quarry Mine](/Quarry_Mine "Quarry Mine").
