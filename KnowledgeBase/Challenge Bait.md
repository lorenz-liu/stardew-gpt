...
| --- | --- |
| Challenge Bait | |
| [Challenge Bait.png](/File:Challenge_Bait.png) | |
| A "perfect" catch yields triple the fish. However, each time a fish escapes the "fishing bar", the catch is reduced. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") • [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") |
| Energy | *Inedible* |
| Sell Price | data-sort-value="1">Gold.png1g |
| Crafting | |
| Recipe Source | Mastery Icon.png [Fishing Mastery](/Mastery_Cave#Masteries "Mastery Cave") |
| Ingredients | Bone Fragment.png [Bone Fragment](/Bone_Fragment "Bone Fragment") (5)Moss.png [Moss](/Moss "Moss") (2) |
| Produces | 5 Bait per craft |

**Challenge Bait** is used to catch up to 3 fish at once. It reduces the delay before a nibble on a fishing rod by 62.5%, the same as with [Wild Bait](/Wild_Bait "Wild Bait").[[1]](#cite_note-fishbitetime-1) It can be [crafted](/Crafting "Crafting") after claiming [Fishing Mastery](/Mastery_Cave#Masteries "Mastery Cave"). It can also be found in [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") (7% chance).[[2]](#cite_note-chestchance-2)
...
Note that catching multiple fish does not grant additional [fishing](/Fishing "Fishing") experience points. However, catching multiple fish while working on a fishing or [special order](/Quests#List_of_Special_Orders "Quests") quest counts all of them toward the required total.

Challenge Bait can be used to catch up to 3 of the same [Legendary Fish](/Fish#Legendary_Fish "Fish").

Challenge Bait cannot be used with the [Training Rod](/Training_Rod "Training Rod") or the [Bamboo Pole](/Bamboo_Pole "Bamboo Pole"). Only the [Fiberglass Rod](/Fiberglass_Rod "Fiberglass Rod"), the [Iridium Rod](/Iridium_Rod "Iridium Rod"), and the [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") can use bait. Challenge bait can also technically be used in a [Crab Pot](/Crab_Pot "Crab Pot"), but it is no better than [standard bait](/Bait_(item) "Bait (item)").
...
Challenge Bait is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Challenge Bait is not used in any [tailoring](/Tailoring "Tailoring") or [dyeing](/Dyeing "Dyeing").

## Quests

Challenge Bait is not used in any [quests](/Quests "Quests").
...
| [Fishing](/Fishing "Fishing") | [Bait](/Bait "Bait") | [Bait](/Bait_(item) "Bait (item)") • Challenge Bait • [Deluxe Bait](/Deluxe_Bait "Deluxe Bait") • [Magic Bait](/Magic_Bait "Magic Bait") • [Magnet](/Magnet "Magnet") • [Targeted Bait](/Targeted_Bait "Targeted Bait") • [Wild Bait](/Wild_Bait "Wild Bait") |
