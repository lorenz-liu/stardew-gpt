...
| --- | --- |
| Shadow Sniper | |
| [Shadow Sniper Anim.gif](/File:Shadow_Sniper_Anim.gif) | |
| Information | |
...
| Speed: | 3 |
| XP: | 20 |
| Variations: | Shadow Brute.png [Shadow Brute](/Shadow_Brute "Shadow Brute")Shadow Brute Dangerous.png [Shadow Brute (dangerous)](/Shadow_Brute_(dangerous) "Shadow Brute (dangerous)") |
| Drops: | Coal.png [Coal](/Coal "Coal") (1-3, 10%)Copper Bar.png [Copper Bar](/Copper_Bar "Copper Bar") (4%)Dwarf Scroll III.png [Dwarf Scroll III](/Dwarf_Scroll_III "Dwarf Scroll III") (0.5%)Dwarf Scroll IV.png [Dwarf Scroll IV](/Dwarf_Scroll_IV "Dwarf Scroll IV") (0.1%)Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (1%)Iridium Bar.png [Iridium Bar](/Iridium_Bar "Iridium Bar") (0.2%)Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (2%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%)Rare Disc.png [Rare Disc](/Rare_Disc "Rare Disc") (0.3%)Strange Bun.png [Strange Bun](/Strange_Bun "Strange Bun") (4%)Void Essence.png [Void Essence](/Void_Essence "Void Essence") (75%)Void Essence.png [Void Essence](/Void_Essence "Void Essence") (10%) If reached bottom of Mines: Diamond.png [Diamond](/Diamond "Diamond") (0.05%)Prismatic Shard.png [Prismatic Shard](/Prismatic_Shard "Prismatic Shard") (0.05%) |

**Shadow Snipers** are an [enemy](/Monsters "Monsters") found in [the Mines](/The_Mines "The Mines") after activating the [Shrine of Challenge](/The_Mines#Shrine_of_Challenge "The Mines") or during the [Danger In The Deep](/Quests#Danger_In_The_Deep "Quests") quest. 150 void spirits (any type) need to be killed for the [Monster Eradication Goal](/Adventurer%27s_Guild#Monster_Eradication_Goals "Adventurer's Guild") at the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild").

It is one of the difficult counterparts of the [Shadow Brute](/Shadow_Brute "Shadow Brute").

## Behavior

Shoots at the player from a distance and inflicts the [![Darkness.png](/mediawiki/images/thumb/c/c0/Darkness.png/24px-Darkness.png)](/Buffs#Darkness "Buffs#Darkness") [Darkness](/Buffs#Darkness "Buffs") debuff on hit.
