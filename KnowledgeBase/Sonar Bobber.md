...
| --- | --- |
| Sonar Bobber | |
| [Sonar Bobber.png](/File:Sonar_Bobber.png) | |
| Shows what fish is on the line before it's caught. | |
| Information | |
| Source | [Fish Shop](/Fish_Shop "Fish Shop") • [Crafting](/Crafting "Crafting") • [Fishing Treasure Chests](/Fishing#Treasure_Chests "Fishing") |
| Sell Price | data-sort-value="250">Gold.png250g |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 6) |
| Ingredients | Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (1)Refined Quartz.png [Refined Quartz](/Refined_Quartz "Refined Quartz") (2) |

[![](/mediawiki/images/thumb/7/7c/Sonar_Bobber_In-game.png/120px-Sonar_Bobber_In-game.png)](/File:Sonar_Bobber_In-game.png)

Fish being caught is displayed on the top-right of the fishing mini-game

The **Sonar Bobber** is a [tackle](/Tackle "Tackle") that helps [fishing](/Fishing "Fishing") by showing what fish is on the line before it is caught. The fish being hooked is revealed right outside of the mini-game display on the top-right.

It can be [crafted](/Crafting "Crafting"), purchased from [Willy's Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)500g after reaching [Fishing level 6](/Fishing#Fishing_Skill "Fishing"), or randomly found in regular [Fishing Treasure Chests](/Fishing#Treasure_Chests "Fishing") (3-4% chance) after reaching Fishing level 6 and in [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") (9-10% chance).[[1]](#cite_note-chestchance-1)

Note that using two Sonar Bobbers on an [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") provides no additional benefit as opposed to only using one.
...
The Sonar Bobber is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Sonar Bobber is not used in any [tailoring](/Tailoring "Tailoring"). It can be used as a gray [dye](/Dyeing "Dyeing") when used in the spool of the [Sewing Machine](/Sewing_Machine "Sewing Machine") with a dyeable clothing item in the feed.

## Quests

The Sonar Bobber is not used in any [quests](/Quests "Quests").
