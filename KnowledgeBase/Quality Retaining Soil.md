...
| --- | --- |
| Quality Retaining Soil | |
| [Quality Retaining Soil.png](/File:Quality_Retaining_Soil.png) | |
| This soil has a good chance of staying watered overnight. Mix into tilled soil. | |
| Information | |
| Source | [Pierre's](/Pierre%27s_General_Store "Pierre's General Store") • [Oasis](/Oasis "Oasis") • [Crafting](/Crafting "Crafting") |
| Sell Price | data-sort-value="5">Gold.png5g |
| Recipe | |
| Recipe Source(s) | Farming Skill Icon.png [Farming](/Farming "Farming") Level 7 |
| Ingredients | Stone.png [Stone](/Stone "Stone") (3)Clay.png [Clay](/Clay "Clay") (1) |
| Produces | 2 Quality Retaining Soil per craft |

**Quality Retaining Soil** is a [Fertilizer](/Fertilizer "Fertilizer") that has a chance to keep soil watered. It can be purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") for data-sort-value="150">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)150g from year 2 onward, from the [Oasis](/Oasis "Oasis") for data-sort-value="200">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)200g on Saturdays, or [crafted](/Crafting "Crafting") once the player has reached [farming level 7](/Farming#Farming_Skill "Farming"). 5-7 Quality Retaining Soil may occasionally found in [Supply Crates](/Supply_Crate "Supply Crate") on the [Beach Farm](/Farm_Maps#Beach "Farm Maps") if the player has not upgraded the [Farmhouse](/Farmhouse "Farmhouse") or only upgraded it once. Quality Retaining Soil may randomly appear in the [Traveling Cart](/Traveling_Cart "Traveling Cart")'s stock for data-sort-value="5"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100–1,000g.
...
Quality Retaining Soil is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Quality Retaining Soil can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [High-Waisted Shirt](/Tailoring "Tailoring"). [![Shirt175.png](/mediawiki/images/thumb/2/24/Shirt175.png/24px-Shirt175.png)](/File:Shirt175.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Quality Retaining Soil is not used in any [quests](/Quests "Quests").

## History

* [1.4](/Version_History#1.4 "Version History"): Can now be used in [Tailoring](/Tailoring "Tailoring").
* [1.5](/Version_History#1.5 "Version History"): Can now be found in [Supply Crates](/Supply_Crate "Supply Crate") on the [Beach Farm](/Farm_Maps#Beach "Farm Maps").
