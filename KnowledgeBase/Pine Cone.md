...
| --- | --- |
| Pine Cone | |
| [Pine Cone.png](/File:Pine_Cone.png) | |
| This can be planted to grow a pine tree. | |
| Information | |
| Crop: | [Pine Tree](/Pine_Tree "Pine Tree") |
...
The **Pine Cone** is a seed that grows into a [Pine Tree](/Pine_Tree "Pine Tree"). It can be obtained by shaking/chopping down a [Pine Tree](/Pine_Tree "Pine Tree") at [Foraging](/Foraging "Foraging") level 1, in [Garbage Cans](/Garbage_Can "Garbage Can"), or by using an [Axe](/Axes "Axes") or [Pickaxe](/Pickaxes "Pickaxes") to dig up a Pine Cone dropped by a fully grown [Pine Tree](/Pine_Tree "Pine Tree") on [The Farm](/The_Farm "The Farm"). One to five Pine Cones may be produced in a [Woodskip](/Woodskip "Woodskip") [Fish Pond](/Fish_Pond "Fish Pond") when the population reaches 9.

Pine Cones can be planted in tillable ground outside [The Farm](/The_Farm "The Farm"). The ground must be un-tilled to plant the seed.

A pine cone has approximately a 20% chance to grow to the next stage each night during [Spring](/Spring "Spring"), [Summer](/Summer "Summer"), or [Fall](/Fall "Fall"). There are 5 growth stages in total. The median time to maturity is about 18 days, with over 90% of seeds maturing in less than 32 growing days.
...
Pine Cone is not used in any [bundles](/Bundles "Bundles").

## Recipes

| Image | Name | Description | Ingredients | Energy / Health | Recipe Source(s) | Sell Price |
| --- | --- | --- | --- | --- | --- | --- |
| [Field Snack.png](/File:Field_Snack.png) | [Field Snack](/Field_Snack "Field Snack") | A quick snack to fuel the hungry forager. | Acorn.png [Acorn](/Acorn "Acorn") (1)Maple Seed.png [Maple Seed](/Maple_Seed "Maple Seed") (1)Pine Cone.png Pine Cone (1) | Energy.png 45 Health.png 20 | Foraging Skill Icon.png [Foraging](/Foraging "Foraging") Level 1 | data-sort-value="20">Gold.png20g |
| [Mystic Tree Seed.png](/File:Mystic_Tree_Seed.png) | [Mystic Tree Seed](/Mystic_Tree_Seed "Mystic Tree Seed") | This can be planted to grow a special tree. | Acorn.png [Acorn](/Acorn "Acorn") (5)Maple Seed.png [Maple Seed](/Maple_Seed "Maple Seed") (5)Pine Cone.png Pine Cone (5)Mahogany Seed.png [Mahogany Seed](/Mahogany_Seed "Mahogany Seed") (5) | N/A | Mastery Icon.png [Foraging Mastery](/Mastery_Cave#Masteries "Mastery Cave") | data-sort-value="100">Gold.png100g |

## Tailoring

Pine Cone can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the ![Beanie.png](/mediawiki/images/thumb/5/51/Beanie.png/24px-Beanie.png) [Beanie](/Beanie "Beanie"). It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Three Pine Cones may be requested by several fish in [Fish Pond quests](/Fish_Pond#Quests "Fish Pond").

## Trading

Once unlocked, the Raccoon's wife near the [Giant Stump](/Giant_Stump "Giant Stump") will trade for Pine Cones.

| Image | Name | Description | Price | Requirements |
| --- | --- | --- | --- | --- |
| [Powdermelon Seeds.png](/File:Powdermelon_Seeds.png) | [Powdermelon Seeds](/Powdermelon_Seeds "Powdermelon Seeds") | This special melon grows in the winter. Takes 7 days to grow. | Pine Cone.png Pine Cone (2) | 1st Request Completed |
...
* [1.6](/Version_History#1.6 "Version History"): Now used as ingredient in [Mystic Tree Seed](/Mystic_Tree_Seed "Mystic Tree Seed") recipe. Now used to trade for [Powdermelon Seeds](/Powdermelon_Seeds "Powdermelon Seeds").
...
| Seeds | [Acorn](/Acorn "Acorn") • [Mahogany Seed](/Mahogany_Seed "Mahogany Seed") • [Maple Seed](/Maple_Seed "Maple Seed") • [Mossy Seed](/Mossy_Seed "Mossy Seed") • [Mushroom Tree Seed](/Mushroom_Tree_Seed "Mushroom Tree Seed") • Pine Cone • [Mystic Tree Seed](/Mystic_Tree_Seed "Mystic Tree Seed") |
