...
| --- | --- |
| Bean Starter | |
| [Bean Starter.png](/File:Bean_Starter.png) | |
| Plant these in the spring. Takes 10 days to mature, but keeps producing after that. Grows on a trellis. | |
| Information | |
| Crop: | Green Bean.png [Green Bean](/Green_Bean "Green Bean") |
| Growth Time: | 10 Days |
| Season: | Spring.png [Spring](/Spring "Spring") |
| Sell Price: | data-sort-value="30">Gold.png30g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="60">Gold.png60g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="75">Gold.png75g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="30"Gold.png100–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 15): | data-sort-value="60">Gold.png60g |

**Bean starter** is a type of seed. Mature plants yield [Green Beans](/Green_Bean "Green Bean").

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), at [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 15, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be made from the [Seed Maker](/Seed_Maker "Seed Maker"). Five to twenty Bean Starter may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern. Eight to twenty Bean starter may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").
...
| --- | --- | --- | --- | --- | --- | --- |
| Green Bean Stage 2.png | Green Bean Stage 3.png | Green Bean Stage 4.png | Green Bean Stage 5.png | Green Bean Stage 6.png | Green Bean Stage 7.png | Green Bean Stage 8.png |
