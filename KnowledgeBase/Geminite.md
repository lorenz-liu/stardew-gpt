...
| --- | --- |
| Geminite | |
| [Geminite.png](/File:Geminite.png) | |
...
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="195 ">Gold.png195g |

**Geminite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Geminite is not used in any [bundles](/Bundles "Bundles").
...
Geminite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt104.png](/mediawiki/images/thumb/6/6d/Shirt104.png/24px-Shirt104.png) [Shirt](/Tailoring "Tailoring"). It is a gray dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Geminite is not used in any [quests](/Quests "Quests").
