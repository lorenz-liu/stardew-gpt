...
| --- | --- |
| Tulip Bulb | |
| [Tulip Bulb.png](/File:Tulip_Bulb.png) | |
| Plant in spring. Takes 6 days to produce a colorful flower. Assorted colors. | |
| Information | |
| Crop: | Tulip.png [Tulip](/Tulip "Tulip") |
| Growth Time: | 6 days |
| Season: | Spring.png [Spring](/Spring "Spring") |
| Sell Price: | data-sort-value="10">Gold.png10g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="20">Gold.png20g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="25">Gold.png25g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="10"Gold.png100–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 15): | data-sort-value="20">Gold.png20g |

The **Tulip Bulb** is a type of seed. Mature plants yield [Tulips](/Tulip "Tulip").

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 15, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker") or by planting [Mixed Flower Seeds](/Mixed_Flower_Seeds "Mixed Flower Seeds").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Harvest |
| --- | --- | --- | --- | --- |
| Tulip Stage 1.png | Tulip Stage 2.png | Tulip Stage 3.png | Tulip Stage 4.png | Tulip Stage 6.png |
...
| --- | --- | --- | --- | --- |
| [Tub o' Flowers.png](/File:Tub_o%27_Flowers.png) | [Tub o' Flowers](/Tub_o%27_Flowers "Tub o' Flowers") | Flowers planted in an oak barrel. Blooms in spring and summer. | Wood.png [Wood](/Wood "Wood") (15)Tulip Bulb.png Tulip Bulb (1)Jazz Seeds.png [Jazz Seeds](/Jazz_Seeds "Jazz Seeds") (1)Poppy Seeds.png [Poppy Seeds](/Poppy_Seeds "Poppy Seeds") (1)Spangle Seeds.png [Spangle Seeds](/Spangle_Seeds "Spangle Seeds") (1) | Pierre Icon.png [Pierre](/Pierre "Pierre")'s stand at [Flower Dance](/Flower_Dance "Flower Dance") (data-sort-value="1000">Gold.png1,000g) |
