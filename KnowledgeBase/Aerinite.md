...
| --- | --- |
| Aerinite | |
| [Aerinite.png](/File:Aerinite.png) | |
...
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="162 ">Gold.png162g |

**Aerinite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Frozen Geode](/Frozen_Geode "Frozen Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Aerinite is not used in any [bundles](/Bundles "Bundles").
...
Aerinite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt115.png](/mediawiki/images/thumb/e/e3/Shirt115.png/24px-Shirt115.png) [Shirt](/Tailoring "Tailoring"). It is a cyan dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed. It can be placed in the blue dye pot at Emily's and Haley's house for use in [dyeing](/Dyeing "Dyeing").

## Quests

Aerinite is not used in any [quests](/Quests "Quests").
