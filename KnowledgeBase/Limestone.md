...
| --- | --- |
| Limestone | |
| [Limestone.png](/File:Limestone.png) | |
| A very common type of stone. It's not worth very much. | |
| Information | |
| Source | Geode.png [Geode](/Geode "Geode") Omni Geode.png [Omni Geode](/Omni_Geode "Omni Geode") Coral.png [Coral](/Coral "Coral") ([Fish Pond](/Fish_Pond "Fish Pond")) |
| Sell Price | data-sort-value="15 ">Gold.png15g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="19 ">Gold.png19g |

**Limestone** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode"). A [Coral](/Coral "Coral") [Fish Pond](/Fish_Pond "Fish Pond") may produce 1 Limestone when the population of the pond reaches 9.
...
Limestone is not used in any [bundles](/Bundles "Bundles").
...
Limestone is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt102.png](/mediawiki/images/thumb/7/79/Shirt102.png/24px-Shirt102.png) [Shirt](/Tailoring "Tailoring"). It is a gray dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

1 Limestone may be requested by [Bullhead](/Bullhead "Bullhead") or [Largemouth Bass](/Largemouth_Bass "Largemouth Bass") in a [Fish Pond quest](/Fish_Pond#Quests "Fish Pond") to increase the capacity of the pond from 5 to 7.

## History

* [1.4](/Version_History#1.4 "Version History"): Can now be used in [Tailoring](/Tailoring "Tailoring"). Can be requested in [Fish Pond quests](/Fish_Pond#Quests "Fish Pond"). Can be produced by [Fish Ponds](/Fish_Pond "Fish Pond").
* [1.6](/Version_History#1.6 "Version History"): Is no longer a possible Midnight Carp Fish Pond request.
