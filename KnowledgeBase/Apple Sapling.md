...
| --- | --- |
| Apple Sapling | |
| [Apple Sapling.png](/File:Apple_Sapling.png) | |
| Takes 28 days to produce a mature Apple tree. Bears fruit in the fall. Only grows if the 8 surrounding "tiles" are empty. | |
| Information | |
| Crop: | Apple.png [Apple](/Apple "Apple") |
| Growth Time: | 28 days |
| Season: | Fall.png [Fall](/Fall "Fall") |
| Sell Price: | data-sort-value="1000"  |  |  | | --- | --- | | Apple Sapling.png | 1,000g | | Apple Sapling.png  Silver Quality Icon.png | 1,250g | | Apple Sapling.png  Gold Quality Icon.png | 1,500g | | Apple Sapling.png  Iridium Quality Icon.png | 2,000g | |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="4000">Gold.png4,000g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | Not Sold |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="1000"Gold.png3,000–5,000g |

The **Apple Sapling** is a [Fruit Tree](/Fruit_Trees "Fruit Trees") sapling that takes 28 days to grow into an [Apple Tree](/Apple_Tree "Apple Tree"), after which it will produce one fruit each day during the [Fall](/Fall "Fall"). Like all Fruit Trees, it will produce fruit all year round if planted in the [Greenhouse](/Greenhouse "Greenhouse").

It can be purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). It may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern, or as the eighth prize from the Prize Machine in the [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor") (50% chance). One Apple Sapling may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 - Spring, Summer, Fall, Winter | Harvest |
| --- | --- | --- | --- | --- | --- |
| Apple Stage 1.png | Apple Stage 2.png | Apple Stage 3.png | Apple Stage 4.png | Apple Stage 5.png | Apple Stage 5 Fruit.png |
| 7 Days | 7 Days | 7 Days | 7 Days | Total: 28 Days | Fall.png [Fall](/Fall "Fall") |
...
* [1.6](/Version_History#1.6 "Version History"): Can now be obtained by chopping down an [Apple Tree](/Apple_Tree "Apple Tree").
