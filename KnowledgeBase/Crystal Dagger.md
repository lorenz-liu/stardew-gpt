...
| --- | --- |
| Crystal Dagger | |
| [Crystal Dagger.png](/File:Crystal_Dagger.png) | |
| The blade is made of purified quartz. | |
| Information | |
| Type: | Dagger |
| Level: | 4 |
| Source: | Chest at Floor 60 in [The Mines](/The_Mines "The Mines") |
| Damage: | 4-10 |
| Critical Strike Chance: | .03 |
| Stats: | Crit. Power.png [Crit. Power](/Crit._Power "Crit. Power") (+50)Weight.png [Weight](/Weight "Weight") (+5) |
| Adventurer's Guild | |
| Purchase Price: | data-sort-value="4500">Gold.png4,500g |
| Sell Price: | data-sort-value="200">Gold.png200g |

The **Crystal Dagger** is a [dagger weapon](/Weapons#Dagger "Weapons") that can be obtained from the treasure chest on floor 60 in [The Mines](/The_Mines "The Mines"). It can also be purchased for data-sort-value="4500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)4,500g from the [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") after reaching floor 60 in [The Mines](/The_Mines "The Mines").

## History

* [1.5](/Version_History#1.5 "Version History"): Level lowered from 9 to 4 and sell price lowered from data-sort-value="450">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)450g to data-sort-value="200">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)200g.
* [1.6.9](/Version_History#1.6.9 "Version History"): Added to [Adventurer's Guild](/Adventurer%27s_Guild "Adventurer's Guild") shop inventory.
