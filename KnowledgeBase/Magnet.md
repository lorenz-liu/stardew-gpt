...
| --- | --- |
| Magnet | |
| [Magnet.png](/File:Magnet.png) | |
| Increases the chance of finding treasures when fishing. However, fish aren't crazy about the taste. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") • [Fish Shop](/Fish_Shop "Fish Shop") • [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") • [Krobus](/Krobus "Krobus") • [Festival of Ice](/Festival_of_Ice "Festival of Ice") • [Casino](/Casino "Casino") |
| Sell Price | data-sort-value="15">Gold.png15g |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 9) |
| Ingredients | Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (1) |
| Produces | 3 Magnets per craft |

The **Magnet** is a type of [bait](/Bait "Bait") that increases the chance of finding [treasure chests](/Fishing#Treasure_Chests "Fishing") by 15% (30% chance base instead of 15% base). It can be [crafted](/Crafting "Crafting") or purchased from [Willy's Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="1000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,000g after reaching [fishing level 9](/Fishing#Fishing_Skill "Fishing"). It can also be purchased from the [Casino](/Casino "Casino") for data-sort-value="1000">![QiCoin.png](/mediawiki/images/thumb/6/6c/QiCoin.png/24px-QiCoin.png)1,000. It can also be found in [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") (7% chance).[[1]](#cite_note-chestchance-1)

It is received as one of the prizes for winning the Ice Fishing Contest at the [Festival of Ice](/Festival_of_Ice "Festival of Ice") for the first time, and can also be received as a gift from [Willy](/Willy "Willy") at the [Feast of the Winter Star](/Feast_of_the_Winter_Star "Feast of the Winter Star"). It may also randomly appear in [Krobus](/Krobus "Krobus")' shop on [Wednesdays](/Days_of_the_Week#Wednesday "Days of the Week") for data-sort-value="200">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)200g, or at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="15"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100–1,000g.

Magnets cannot be used with the [Training Rod](/Training_Rod "Training Rod") or the [Bamboo Pole](/Bamboo_Pole "Bamboo Pole"). Only the [Fiberglass Rod](/Fiberglass_Rod "Fiberglass Rod"), the [Iridium Rod](/Iridium_Rod "Iridium Rod"), and the [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") can use bait. Magnets can also technically be used in a [Crab Pot](/Crab_Pot "Crab Pot"), but it is no better than [standard bait](/Bait_(item) "Bait (item)") as crab pots never yield any treasure.
...
The Magnet is not used in any [bundles](/Bundles "Bundles").

## Quests

The Magnet is not used in any [quests](/Quests "Quests").

## Notes

* Despite the description, the Magnet has the same effect on fish bite rate as standard [Bait](/Bait_(item) "Bait (item)") (decreasing biting time by 50%).
* While the Magnet can be purchased at the [Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="1000">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,000g, crafting is a cheaper option, even if purchasing the ingredients. In year 1, 5 [Iron Ore](/Iron_Ore "Iron Ore") and 1 [Coal](/Coal "Coal") cost data-sort-value="900">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)900g at the [Blacksmith](/Blacksmith "Blacksmith") (data-sort-value="300">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)300g per magnet). In years 2+, 5 Iron Ore and 1 Coal cost data-sort-value="1500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)1,500g (data-sort-value="500">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)500g per magnet).
* Success at playing the minigames in the [Casino](/Casino "Casino") can also yield virtually free Magnets from the Casino shop.
...
* [1.6](/Version_History#1.6 "Version History"): Can now be obtained from [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing"). Can be used in the [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod").
...
| [Fishing](/Fishing "Fishing") | [Bait](/Bait "Bait") | [Bait](/Bait_(item) "Bait (item)") • [Challenge Bait](/Challenge_Bait "Challenge Bait") • [Deluxe Bait](/Deluxe_Bait "Deluxe Bait") • [Magic Bait](/Magic_Bait "Magic Bait") • Magnet • [Targeted Bait](/Targeted_Bait "Targeted Bait") • [Wild Bait](/Wild_Bait "Wild Bait") |
