...
**Alamite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Alamite is not used in any [bundles](/Bundles "Bundles").
...
Alamite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt081.png](/mediawiki/images/thumb/e/e3/Shirt081.png/24px-Shirt081.png) [Shirt](/Tailoring "Tailoring"). It is a gray dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Alamite is not used in any [quests](/Quests "Quests").
