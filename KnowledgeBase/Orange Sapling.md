...
| --- | --- |
| Orange Sapling | |
| [Orange Sapling.png](/File:Orange_Sapling.png) | |
| Takes 28 days to produce a mature Orange tree. Bears fruit in the summer. Only grows if the 8 surrounding "tiles" are empty. | |
| Information | |
| Crop: | Orange.png [Orange](/Orange "Orange") |
| Growth Time: | 28 days |
| Season: | Summer.png [Summer](/Summer "Summer") |
| Sell Price: | data-sort-value="1000"  |  |  | | --- | --- | | Orange Sapling.png | 1,000g | | Orange Sapling.png  Silver Quality Icon.png | 1,250g | | Orange Sapling.png  Gold Quality Icon.png | 1,500g | | Orange Sapling.png  Iridium Quality Icon.png | 2,000g | |
| Purchase Prices | |
...
The **Orange Sapling** is a [Fruit Tree](/Fruit_Trees "Fruit Trees") sapling that takes 28 days to grow into an [Orange Tree](/Orange_Tree "Orange Tree"), after which it will produce one fruit each day during the [Summer](/Summer "Summer"). Like all Fruit Trees, it will produce fruit all year round if planted in the [Greenhouse](/Greenhouse "Greenhouse").

It can be purchased from [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). It may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern, or as the second prize from the Prize Machine in the [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor") (50% chance). One Orange Sapling may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 - Spring, Summer, Fall, Winter | Harvest |
| --- | --- | --- | --- | --- | --- |
| Orange Stage 1.png | Orange Stage 2.png | Orange Stage 3.png | Orange Stage 4.png | Orange Stage 5.png | Orange Stage 5 Fruit.png |
| 7 Days | 7 Days | 7 Days | 7 Days | Total: 28 Days | Summer.png [Summer](/Summer "Summer") |
...
* [1.6](/Version_History#1.6 "Version History"): Can now be obtained from chopping down an [Orange Tree](/Orange_Tree "Orange Tree").
...
| Summer | [Blueberry Seeds](/Blueberry_Seeds "Blueberry Seeds") • [Coffee Beans](/Coffee_Bean "Coffee Bean") • [Corn Seeds](/Corn_Seeds "Corn Seeds") • [Hops Starter](/Hops_Starter "Hops Starter") • [Melon Seeds](/Melon_Seeds "Melon Seeds") • Orange Sapling • [Peach Sapling](/Peach_Sapling "Peach Sapling") • [Pepper Seeds](/Pepper_Seeds "Pepper Seeds") • [Poppy Seeds](/Poppy_Seeds "Poppy Seeds") • [Radish Seeds](/Radish_Seeds "Radish Seeds") • [Red Cabbage Seeds](/Red_Cabbage_Seeds "Red Cabbage Seeds") • [Spangle Seeds](/Spangle_Seeds "Spangle Seeds") • [Summer Seeds](/Summer_Seeds "Summer Seeds") • [Summer Squash Seeds](/Summer_Squash_Seeds "Summer Squash Seeds") • [Sunflower Seeds](/Sunflower_Seeds "Sunflower Seeds") • [Starfruit Seeds](/Starfruit_Seeds "Starfruit Seeds") • [Tomato Seeds](/Tomato_Seeds "Tomato Seeds") • [Wheat Seeds](/Wheat_Seeds "Wheat Seeds") |
