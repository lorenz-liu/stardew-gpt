...
| --- | --- |
| Cobblestone Path | |
| [Cobblestone Path.png](/File:Cobblestone_Path.png) | |
...
The **Cobblestone Path** is a [crafted item](/Crafting#Decor "Crafting") used to create decorative paths. It can be displaced by lightning or destroyed by [weeds](/Weeds "Weeds").
...
* [![](/mediawiki/images/thumb/f/fb/Cobblestone_Path_Tile.png/120px-Cobblestone_Path_Tile.png)](/File:Cobblestone_Path_Tile.png)

  Spring, Summer, & Fall
* [![](/mediawiki/images/thumb/9/99/Cobblestone_Path_Tile_Winter.png/120px-Cobblestone_Path_Tile_Winter.png)](/File:Cobblestone_Path_Tile_Winter.png)
...
| Paths | Cobblestone Path • [Crystal Path](/Crystal_Path "Crystal Path") • [Gravel Path](/Gravel_Path "Gravel Path") • [Stepping Stone Path](/Stepping_Stone_Path "Stepping Stone Path") • [Wood Path](/Wood_Path "Wood Path") |