...
| --- | --- |
| Hopper | |
| [Hopper.png](/File:Hopper.png) | |
| Items placed inside will automatically be loaded into the machine in front of it. | |
| Information | |
| Source | * [Crafting](/Crafting "Crafting") * [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="10">Qi Gem.png 10 |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="50">Qi Gem.png 50 |
| Ingredients | Hardwood.png [Hardwood](/Hardwood "Hardwood") (10)Iridium Bar.png [Iridium Bar](/Iridium_Bar "Iridium Bar") (1)Radioactive Bar.png [Radioactive Bar](/Radioactive_Bar "Radioactive Bar") (1) |

:   *See also: [Hay Hopper](/Hay_Hopper "Hay Hopper")*

The **Hopper** is a [craftable item](/Crafting "Crafting") that can be purchased from [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="10">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 10 [Qi Gems](/Qi_Gem "Qi Gem"). The recipe can also be purchased from [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="50">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 50 [Qi Gems](/Qi_Gem "Qi Gem").
...
Items produced this way will still have to be manually removed from the machine. A Hopper will not start processing again until the finished item is removed. On the other hand, multiple possible input items can be loaded at the same time, and it also works with two different input items at the same time. For instance, one could load [Coal](/Coal "Coal") and an array of different ores into a Hopper connected to a [Furnace](/Furnace "Furnace"), which will have the Furnace auto-smelt the ores from left to right.

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.6.9](/Version_History#1.6.9 "Version History"): Fixed bug where if a Hopper was used to bait a [Crab Pot](/Crab_Pot "Crab Pot"), [Bait](/Bait "Bait") would not be consumed the first time the Crab Pot gets baited.
