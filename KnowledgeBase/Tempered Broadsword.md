...
| --- | --- |
| Tempered Broadsword | |
| [Tempered Broadsword.png](/File:Tempered_Broadsword.png) | |
| It looks like it could withstand anything. | |
| Information | |
| Type: | Sword |
| Level: | 7 |
| Source: | * Floor 90 of [The Mines](/The_Mines "The Mines") (remixed) * [The Mines](/The_Mines "The Mines") (Floors 81-99) * [Skull Cavern](/Skull_Cavern "Skull Cavern") * [Quarry Mine](/Quarry_Mine "Quarry Mine") |
| Damage: | 29-44 |
| Critical Strike Chance: | .02 |
| Stats: | Speed w.png [Speed](/Speed "Speed") (−3)Defense.png [Defense](/Defense "Defense") (+3)Weight.png [Weight](/Weight "Weight") (+3) |
| Adventurer's Guild | |
| Purchase Price: | Not Sold |
| Sell Price: | data-sort-value="350">Gold.png350g |

The **Tempered Broadsword** is a [sword weapon](/Weapons#Sword "Weapons") that can be obtained as a [special item drop](/The_Mines#Special_Items "The Mines") on Floors 81-99 of [The Mines](/The_Mines "The Mines"), in the [Skull Cavern](/Skull_Cavern "Skull Cavern")[[1]](#cite_note-specialitem-1), or in the [Quarry Mine](/Quarry_Mine "Quarry Mine") by killing [special monsters](/The_Mines#Special_Items "The Mines") or by breaking [crates and barrels](/The_Mines#Crates_and_Barrels "The Mines"). It is a possible reward for the chest on floor 90 of the Mines if "remixed" mine rewards are selected in the [Advanced Options](/Options "Options") menu when starting a new game.

## History

* [1.5](/Version_History#1.5 "Version History"): Level lowered from 8 to 7 and sell price lowered from data-sort-value="400">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)400g to data-sort-value="350">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)350g. Bug where weapon defense had no effect fixed.
