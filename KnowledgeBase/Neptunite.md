...
| --- | --- |
| Neptunite | |
| [Neptunite.png](/File:Neptunite.png) | |
| A jet-black crystal that is unusually reflective. | |
| Information | |
| Source | Magma Geode.png [Magma Geode](/Magma_Geode "Magma Geode")Omni Geode.png [Omni Geode](/Omni_Geode "Omni Geode")[Black Slime.png](/File:Black_Slime.png) [Black Slime](/Slimes "Slimes") |
| Sell Price | data-sort-value="400 ">Gold.png400g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="520 ">Gold.png520g |

**Neptunite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Magma Geode](/Magma_Geode "Magma Geode") and the [Omni Geode](/Omni_Geode "Omni Geode"). It can also be dropped by [Black Slimes](/Slimes "Slimes").
...
Neptunite is not used in any [bundles](/Bundles "Bundles").
...
Neptunite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt098.png](/mediawiki/images/thumb/0/0e/Shirt098.png/24px-Shirt098.png) [Shirt](/Tailoring "Tailoring"). It is a black dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Neptunite is not used in any [quests](/Quests "Quests").
