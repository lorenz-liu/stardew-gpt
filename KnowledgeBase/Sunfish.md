...
| --- | --- |
| Sunfish | |
| [Sunfish.png](/File:Sunfish.png) | |
| A common river fish. | |
| Information | |
| Location | River |
| Time | 6am – 7pm |
| Season | Spring.png [Spring](/Spring "Spring") • Summer.png [Summer](/Summer "Summer") |
| Weather | Sunny.png [Sun](/Weather "Weather") • Pollen spring.png [Wind](/Weather "Weather") |
| Difficulty | 30 |
...
| |  |  |  | | --- | --- | --- | | Sell Prices | | | | Base | Fisher.png [Fisher](/Skills#Fishing "Skills") *(+25%)* | Angler Icon.png [Angler](/Skills#Fishing "Skills") *(+50%)* | | |  |  | | --- | --- | | Sunfish.png | 30g | | Sunfish.png  Silver Quality Icon.png | 37g | | Sunfish.png  Gold Quality Icon.png | 45g | | Sunfish.png  Iridium Quality Icon.png | 60g | | |  |  | | --- | --- | | Sunfish.png | 37g | | Sunfish.png  Silver Quality Icon.png | 46g | | Sunfish.png  Gold Quality Icon.png | 56g | | Sunfish.png  Iridium Quality Icon.png | 75g | | |  |  | | --- | --- | | Sunfish.png | 45g | | Sunfish.png  Silver Quality Icon.png | 55g | | Sunfish.png  Gold Quality Icon.png | 67g | | Sunfish.png  Iridium Quality Icon.png | 90g | | | |
| |  |  |  | | --- | --- | --- | | Artisan Sell Prices | | | | Roe | Aged Roe | Artisan.png Aged Roe *(+40%)* | | |  |  | | --- | --- | | Orange Roe.png | 45g | | |  |  | | --- | --- | | Orange Aged Roe.png | 90g | | |  |  | | --- | --- | | Orange Aged Roe.png | 126g | | | |

The **Sunfish** is a [fish](/Fish "Fish") that can be caught in the river (in [Pelican Town](/Pelican_Town "Pelican Town") or [Cindersap Forest](/Cindersap_Forest "Cindersap Forest")) during [Spring](/Spring "Spring") and [Summer](/Summer "Summer") during sunny [weather](/Weather "Weather"). It may also be caught on the [Riverlands Farm](/Farm_Maps "Farm Maps"), [Forest Farm](/Farm_Maps "Farm Maps"), or [Hill-top Farm](/Farm_Maps "Farm Maps"). It can also be gifted by a [pet](/Animals#Pets "Animals") cat with max [friendship](/Animals#Friendship "Animals"). It may also randomly be found at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="30"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)100–1,000g or in [Garbage Cans](/Garbage_Can "Garbage Can") during [Spring](/Spring "Spring") and [Summer](/Summer "Summer").

The Sunfish replaces any ineligible fish or non-fish items for the [tutorial catch](/Fish#Tutorial_Catch "Fish"). This can happen regardless of time, weather, season, or location.

One Sunfish is contained in the [Community Center Fish Tank](/Bundles#Fish_Tank "Bundles") right after it is repaired.

Sunfish can be caught regardless of weather, time, or season using [Magic Bait](/Magic_Bait "Magic Bait").
...
Sunfish is used in the ![Bundle Teal.png](/mediawiki/images/thumb/c/ce/Bundle_Teal.png/24px-Bundle_Teal.png) [River Fish Bundle](/Bundles#River_Fish_Bundle "Bundles") in the [Fish Tank](/Bundles#Fish_Tank "Bundles").

## Recipes

| Image | Name | Description | Ingredients | Energy / Health | Recipe Source(s) | Sell Price |
| --- | --- | --- | --- | --- | --- | --- |
| [Baked Fish.png](/File:Baked_Fish.png) | [Baked Fish](/Baked_Fish "Baked Fish") | Baked fish on a bed of herbs. | Sunfish.png Sunfish (1)Bream.png [Bream](/Bream "Bream") (1)Wheat Flour.png [Wheat Flour](/Wheat_Flour "Wheat Flour") (1) | Energy.png 75 Health.png 33 | |  |  | | --- | --- | | Cooking Channel.png | [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") | | 7 Summer, Year 1 | | data-sort-value="100">Gold.png100g |
...
Sunfish can be used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [Fish Shirt](/Tailoring "Tailoring"). [![Shirt158.png](/mediawiki/images/thumb/e/e7/Shirt158.png/24px-Shirt158.png)](/File:Shirt158.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Fish Pond

Sunfish can be placed in a [Fish Pond](/Fish_Pond "Fish Pond"), where they will reproduce every day. The initial pond capacity is 3 fish, but the capacity can be increased to 10 by completing two quests. The primary output is orange Sunfish [Roe](/Roe "Roe"), but [Solar Essence](/Solar_Essence "Solar Essence") is also possible at population 10.
...
| 3 | 5 | 2 [Acorns](/Acorn "Acorn") or 2 [Geodes](/Geode "Geode") | 25 |
| 5 | 10 | 1 [Amethyst](/Amethyst "Amethyst") or 3 [Mixed Seeds](/Mixed_Seeds "Mixed Seeds") | 25 |

**[Produce](/Fish_Pond#Produce "Fish Pond")**

| Item(s) Produced | Fishing XP Granted | Population | % of Items | Overall Daily Chance |
| --- | --- | --- | --- | --- |
| Orange Roe.png [Roe](/Roe "Roe") (1) | 11 | 1-9 | 90% | 21-78% |
| 10 | 83% | 79% |
| Solar Essence.png [Solar Essence](/Solar_Essence "Solar Essence") (1) | 11 | 10 | 8% | 8% |
| *Nothing* |  | 1-9 | 10% | 79-22% |
| 10 | 9% | 14% |

## Quests

* **Item Delivery:** One Sunfish may be randomly requested in [Spring](/Spring "Spring") or [Summer](/Summer "Summer") at the ["Help Wanted" board](/Quests#Help_Wanted_Quests "Quests") outside [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") for a reward of data-sort-value="90">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)90g and 150 [Friendship](/Friendship "Friendship") points.
* **Fishing:** [Demetrius](/Demetrius "Demetrius") or [Willy](/Willy "Willy") may randomly request 1-5 sunfish during [Spring](/Spring "Spring") or [Summer](/Summer "Summer") at the ["Help Wanted" board](/Quests#Help_Wanted_Quests "Quests") outside [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store") for a reward of data-sort-value="30">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)30g per fish. (You get to keep the fish).
* **Aquatic Overpopulation:** [Demetrius](/Demetrius "Demetrius") may request 10 Sunfish to be caught in [Spring](/Spring "Spring") at the [Special Orders board](/Quests#List_of_Special_Orders "Quests") outside the [Mayor's Manor](/Mayor%27s_Manor "Mayor's Manor") for a reward of gold equivalent to selling the fish and the [Farm Computer](/Farm_Computer "Farm Computer") recipe.
...
* [1.6](/Version_History#1.6 "Version History"): One is contained in the [Community Center Fish Tank](/Bundles#Fish_Tank "Bundles") right after it is repaired. Can now be gifted by a [pet](/Animals#Pets "Animals") cat with max [friendship](/Animals#Friendship "Animals").
