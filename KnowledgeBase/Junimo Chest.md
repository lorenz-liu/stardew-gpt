...
| --- | --- |
| Junimo Chest | |
| [Junimo Chest.png](/File:Junimo_Chest.png) | |
| Through the power of forest magic, every Junimo Chest links to the same stash. | |
| Information | |
| Source | [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room") for data-sort-value="30">Qi Gem.png 30 |
...
They can be purchased from [Qi's Walnut Room](/Qi%27s_Walnut_Room "Qi's Walnut Room"). The first two chests can be purchased for data-sort-value="30">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 30. After buying the first two, additional chests can be purchased for data-sort-value="15">![Qi Gem.png](/mediawiki/images/thumb/7/78/Qi_Gem.png/24px-Qi_Gem.png) 15 each.

Much like regular chests, Junimo Chests must be empty to be removed, and can be placed in many different places throughout the Stardew world. However, if a Junimo Chest is left in the [walking pathway of a villager](/Crafting#Crafted_goods_outside_the_farm "Crafting") it will be moved out of the way.

Unlike regular chests, items placed inside a Junimo Chest will not be available for crafting when using a [Workbench](/Workbench "Workbench") placed next to it. Junimo Chests may not be placed in the Skull Caverns or Mines.

## History

* [1.5](/Version_History#1.5 "Version History"): Introduced.
* [1.5.2](/Version_History#1.5.2 "Version History"): Special Order related items that are stashed in Junimo Chests are now properly removed once the Special Order expires.
...
| [Storage](/Crafting#Storage_Equipment "Crafting") | | [Big Chest](/Big_Chest "Big Chest") • [Big Stone Chest](/Big_Stone_Chest "Big Stone Chest") • [Chest](/Chest "Chest") • Junimo Chest • [Mini-Fridge](/Mini-Fridge "Mini-Fridge") • [Stone Chest](/Stone_Chest "Stone Chest") |
