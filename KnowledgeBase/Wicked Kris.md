...
| --- | --- |
| Wicked Kris | |
| [Wicked Kris.png](/File:Wicked_Kris.png) | |
| The blade is made of an iridium alloy. | |
| Information | |
| Type: | Dagger |
| Level: | 8 |
| Source: | * Floor 90 of [The Mines](/The_Mines "The Mines") (remixed) * [Skull Cavern](/Skull_Cavern "Skull Cavern") * [Quarry Mine](/Quarry_Mine "Quarry Mine") |
| Damage: | 24-30 |
| Critical Strike Chance: | .06 |
| Stats: | Crit. Chance.png [Crit. Chance](/Crit._Chance "Crit. Chance") (+4) |
| Adventurer's Guild | |
| Purchase Price: | Not Sold |
| Sell Price: | data-sort-value="400">Gold.png400g |

The **Wicked Kris** is a [dagger weapon](/Weapons#Dagger "Weapons") that can be obtained as a [special item drop](/The_Mines#Special_Items "The Mines") in the [Skull Cavern](/Skull_Cavern "Skull Cavern")[[1]](#cite_note-specialitem-1) or [Quarry Mine](/Quarry_Mine "Quarry Mine") by killing [special monsters](/The_Mines#Special_Items "The Mines") or by breaking [crates and barrels](/The_Mines#Crates_and_Barrels "The Mines"). It is a possible reward for the chest on floor 90 of the Mines if "remixed" mine rewards are selected in the [Advanced Options](/Options "Options") menu when starting a new game.

## History

* [1.5](/Version_History#1.5 "Version History"): Level lowered from 15 to 8 and sell price lowered from data-sort-value="750">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)750g to data-sort-value="400">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)400g.
