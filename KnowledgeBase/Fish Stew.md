...
| --- | --- |
| Fish Stew | |
| [Fish Stew.png](/File:Fish_Stew.png) | |
...
| Buff(s) | Fishing.png [Fishing](/Fishing "Fishing") (+3) |
| Buff Duration | Time Icon.png 16m 47s |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 225 | Health.png | 101 | |
| Sell Price | |  |  | | --- | --- | | Fish Stew.png | 175g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 405 | Health.png  Gold Quality Icon.png | 182 | |  | |  |  | | --- | --- | | Fish Stew.png  Gold Quality Icon.png | 262g | | |
| Recipe | |
| Recipe Source(s) | Willy Icon.png [Willy](/Willy "Willy") (Mail - 7+ HeartIconLarge.png) |
| Ingredients | Crayfish.png [Crayfish](/Crayfish "Crayfish") (1)Mussel.png [Mussel](/Mussel "Mussel") (1)Periwinkle.png [Periwinkle](/Periwinkle "Periwinkle") (1)Tomato.png [Tomato](/Tomato "Tomato") (1) |

**Fish Stew** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit"). It may also randomly appear at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="175"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)525–1,000g. It can also be found in [Golden Fishing Treasure Chests](/Fishing#Golden_Treasure_Chests "Fishing") (7% chance).[[1]](#cite_note-chestchance-1) One Fish Stew may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").
...
Fish Stew is not used in any [bundles](/Bundles "Bundles").
...
Fish Stew is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create a [Shirt](/Tailoring "Tailoring"). [![Shirt124.png](/mediawiki/images/thumb/f/fd/Shirt124.png/24px-Shirt124.png)](/File:Shirt124.png)

## Quests

Fish Stew is not used in any [quests](/Quests "Quests").
...
* [1.4](/Version_History#1.4 "Version History"): Standardized position in stove interface relative to Cooking tab of player menu. Can now be used in [Tailoring](/Tailoring "Tailoring").
