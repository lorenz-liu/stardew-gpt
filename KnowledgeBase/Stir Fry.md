...
| --- | --- |
| Stir Fry | |
| [Stir Fry.png](/File:Stir_Fry.png) | |
...
| Sell Price | |  |  | | --- | --- | | Stir Fry.png | 335g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 360 | Health.png  Gold Quality Icon.png | 162 | |  | |  |  | | --- | --- | | Stir Fry.png  Gold Quality Icon.png | 502g | | |
| Recipe | |
| Recipe Source(s) | |  |  | | --- | --- | | Cooking Channel.png | [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") | | 7 Spring, Year 1 | |
| Ingredients | Cave Carrot.png [Cave Carrot](/Cave_Carrot "Cave Carrot") (1)Common Mushroom.png [Common Mushroom](/Common_Mushroom "Common Mushroom") (1)Kale.png [Kale](/Kale "Kale") (1)Oil.png [Oil](/Oil "Oil") (1) |

**Stir Fry** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").

**Note:** this recipe is [profitable](/Cooking#Profitable_Recipes "Cooking") - it will result in profit when using the lowest quality ingredients and homemade [Oil](/Oil "Oil").
...
Stir Fry is not used in any [bundles](/Bundles "Bundles").
...
Stir Fry is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Camo Shirt](/Tailoring "Tailoring"). [![Shirt274.png](/mediawiki/images/thumb/e/e7/Shirt274.png/24px-Shirt274.png)](/File:Shirt274.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Stir Fry is not used in any [quests](/Quests "Quests").
