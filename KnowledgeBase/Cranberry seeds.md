...
| --- | --- |
| Cranberry Seeds | |
| [Cranberry Seeds.png](/File:Cranberry_Seeds.png) | |
| Plant these in the fall. Takes 7 days to mature, and continues to produce after first harvest. | |
| Information | |
| Crop: | Cranberries.png [Cranberries](/Cranberries "Cranberries") |
| Growth Time: | 7 days |
| Season: | Fall.png [Fall](/Fall "Fall") |
| Sell Price: | data-sort-value="60">Gold.png60g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="240">Gold.png240g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="300">Gold.png300g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="120"Gold.png360–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 17): | data-sort-value="240">Gold.png240g |

**Cranberry Seeds** are a type of seed. Mature plants yield [Cranberries](/Cranberries "Cranberries").

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), at [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 17, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker"). Five to twenty Cranberry Seeds may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern.

## Stages

When harvested, each Cranberry plant gives 2 Cranberries every 5 days, with a 10% chance of one or more extra cranberries (0.11 more cranberries on average).[[1]](#cite_note-extra_cranberries-1)

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 | Harvest | After-Harvest |
| --- | --- | --- | --- | --- | --- | --- |
| Cranberry Stage 1.png | Cranberry Stage 2.png | Cranberry Stage 3.png | Cranberry Stage 4.png | Cranberry Stage 5.png | Cranberry Stage 6.png | Cranberry Stage 7.png |
...
1. [↑](#cite_ref-extra_cranberries_1-0) The game generates a random number between 0 and 1, and if it is less than 0.1, then another Cranberry will spawn. This repeats until the random number is greater than or equal to 0.1, at which point the chance for an extra Cranberry ends. This, on average, will give 0.11 extra Cranberries. Keep in mind that [Luck](/Luck "Luck") can also double the amount of extra Cranberries spawned by the above formula.

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.1](/Version_History#1.1 "Version History"): Reduced seed sell price from data-sort-value="120">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)120g to data-sort-value="60">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)60g.
