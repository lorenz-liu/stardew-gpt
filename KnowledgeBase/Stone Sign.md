...
| --- | --- |
| Stone Sign | |
| [Stone Sign.png](/File:Stone_Sign.png) | |
...
| Ingredients | Stone.png [Stone](/Stone "Stone") (25) |

The **Stone Sign** is a [craftable](/Crafting "Crafting") item that can display the image of any item that can be held in [inventory](/Inventory "Inventory"). An image can be placed on the sign by holding an item in inventory and right-clicking on the sign. The item will not be consumed.

Stone Signs can be placed anywhere in Stardew Valley, indoors or outdoors. If placed in a [villager](/Villagers "Villagers")'s path, the sign will be destroyed. See "[Crafted goods outside the farm](/Crafting#Crafted_goods_outside_the_farm "Crafting")" for maps of areas safe from villager pathing.

Placing a Stone Sign on a [Fish Pond](/Fish_Pond "Fish Pond") will turn it into a counter of how many [fish](/Fish "Fish") are inside, with an image of the fish visible on the sign, and the number of fish in the pond in the lower right corner.

## History

* [1.3.27](/Version_History#1.3.27 "Version History"): Introduced.
* [1.4](/Version_History#1.4 "Version History"): Can now be stacked in a player's [inventory](/Inventory "Inventory") and in [chests](/Chest "Chest").
...
| [Signs](/Crafting#Signs "Crafting") | | [Dark Sign](/Dark_Sign "Dark Sign") • Stone Sign • [Text Sign](/Text_Sign "Text Sign") • [Wood Sign](/Wood_Sign "Wood Sign") |
