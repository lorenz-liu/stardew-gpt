...
| --- | --- |
| Tigerseye | |
| [Tigerseye.png](/File:Tigerseye.png) | |
...
| Sell Price | data-sort-value="275 ">Gold.png275g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="357 ">Gold.png357g |

**Tigerseye** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Magma Geode](/Magma_Geode "Magma Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").

## Gifting

| Villager Reactions | |
| --- | --- |
| Love | [Sam Icon.png](/Sam "Sam") [Sam](/Sam "Sam") |
...
Tigerseye is not used in any [bundles](/Bundles "Bundles").
...
Tigerseye is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [Dark Striped Shirt](/Tailoring "Tailoring"). [![Shirt194b.png](/mediawiki/images/thumb/9/98/Shirt194b.png/24px-Shirt194b.png)](/File:Shirt194b.png) It can be used in [dyeing](/Dyeing "Dyeing"), serving as an orange dye at the dye pots, located in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Tigerseye is not used in any [quests](/Quests "Quests").
