...
| --- | --- |
| Bait Maker | |
| [Bait Maker.png](/File:Bait_Maker.png) | |
| Place a fish inside to create targeted bait. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Fishing Skill Icon.png [Fishing](/Fishing "Fishing") (Level 6) |
| Ingredients | Iron Bar.png [Iron Bar](/Iron_Bar "Iron Bar") (3)Coral.png [Coral](/Coral "Coral") (3)Sea Urchin.png [Sea Urchin](/Sea_Urchin "Sea Urchin") (1) |
| Produces | Pink Bait.png [Targeted Bait](/Targeted_Bait "Targeted Bait") (5-10) |

The **Bait Maker** is a piece of [Refining Equipment](/Crafting#Refining_Equipment "Crafting") that is used to create [Targeted Bait](/Targeted_Bait "Targeted Bait") from any [fish](/Fish "Fish"). It takes ![Time Icon.png](/mediawiki/images/thumb/7/70/Time_Icon.png/24px-Time_Icon.png) 10m to process fish into bait. It can be [crafted](/Crafting "Crafting") after reaching [Fishing](/Fishing "Fishing") Level 6.

To use, insert any fish into the machine. It will then produce 5-10 "[fish name] Bait," which will increase the chance of catching that fish when attached. Any fish can be used, including [Legendary Fish](/Fish#Legendary_Fish "Fish") and [Crab Pot Fish](/Fish#Crab_Pot_Fish "Fish"). However, catchable items such as [Seaweed](/Seaweed "Seaweed"), Algae, and Jelly cannot be put into the Bait Maker.
