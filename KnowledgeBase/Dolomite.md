...
| --- | --- |
| Dolomite | |
| [Dolomite.png](/File:Dolomite.png) | |
| It can occur in coral reefs, often near an underwater volcano. | |
| Information | |
| Source | Magma Geode.png [Magma Geode](/Magma_Geode "Magma Geode") Omni Geode.png [Omni Geode](/Omni_Geode "Omni Geode") Coral.png [Coral](/Coral "Coral") ([Fish Pond](/Fish_Pond "Fish Pond")) |
| Sell Price | data-sort-value="300 ">Gold.png300g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="390 ">Gold.png390g |

**Dolomite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Magma Geode](/Magma_Geode "Magma Geode") and the [Omni Geode](/Omni_Geode "Omni Geode"). A [Coral](/Coral "Coral") [Fish Pond](/Fish_Pond "Fish Pond") may produce 1 Dolomite when the population of the pond reaches 9.
...
Dolomite is not used in any [bundles](/Bundles "Bundles").
...
Dolomite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt113.png](/mediawiki/images/thumb/0/09/Shirt113.png/24px-Shirt113.png) [Shirt](/Tailoring "Tailoring"). It is a pink dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed. It can be placed in the red dye pot at [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane"), for use in [dyeing](/Dyeing "Dyeing").

## Quests

Dolomite is not used in any [quests](/Quests "Quests").
