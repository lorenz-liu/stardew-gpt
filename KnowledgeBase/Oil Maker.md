...
| --- | --- |
| Oil Maker | |
| [Oil Maker.png](/File:Oil_Maker.png) | |
| Makes gourmet truffle oil. | |
| Information | |
| Source | [Crafting](/Crafting "Crafting") |
| Sell Price | *Cannot be sold* |
| Crafting | |
| Recipe Source | Farming Skill Icon.png [Farming](/Farming "Farming") (Level 8) |
| Ingredients | Slime.png [Slime](/Slime "Slime") (50)Hardwood.png [Hardwood](/Hardwood "Hardwood") (20)Gold Bar.png [Gold Bar](/Gold_Bar "Gold Bar") (1) |

The **Oil Maker** is a type of [Artisan Equipment](/Crafting#Artisan_Equipment "Crafting") used to make [Artisan Goods](/Artisan_Goods "Artisan Goods"). It takes specific items and turns them into [oil](/Oil "Oil").

## Products

:   *For Truffle/Truffle Oil profitability, see also: [Animal Products Profitability](/Animal_Products_Profitability "Animal Products Profitability")*

| Image | Name | Description | Ingredient | Processing Time[[1]](#cite_note-processtime-1) | Sell Price | Energy / Health |
| --- | --- | --- | --- | --- | --- | --- |
| [Truffle Oil.png](/File:Truffle_Oil.png) | [Truffle Oil](/Truffle_Oil "Truffle Oil") | A gourmet cooking ingredient. | Truffle.png [Truffle](/Truffle "Truffle") (1) | Time Icon.png 360m (6 Hours) | data-sort-value="1065">Gold.png1,065g | Energy.png38Health.png17 |
| [Oil.png](/File:Oil.png) | [Oil](/Oil "Oil") | All purpose cooking oil. | Corn.png [Corn](/Corn "Corn") (1) | Time Icon.png 1000m (≈16 Hours) | data-sort-value="100">Gold.png100g | Energy.png13Health.png5 |
| Sunflower Seeds.png [Sunflower Seeds](/Sunflower_Seeds "Sunflower Seeds") (1) | Time Icon.png 3200m (2 Days) |
| Sunflower.png [Sunflower](/Sunflower "Sunflower") (1) | Time Icon.png 60m (1 Hour) |
...
* [1.4](/Version_History#1.4 "Version History"): Adjusted processing time so that machines process 100 minutes from 2:00 AM to 6:00 AM, not every hour the player is asleep. Oil makers can now be stacked in a player's [inventory](/Inventory "Inventory") and in [chests](/Chest "Chest").
