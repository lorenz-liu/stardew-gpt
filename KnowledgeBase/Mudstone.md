...
| --- | --- |
| Mudstone | |
| [Mudstone.png](/File:Mudstone.png) | |
| A fine-grained rock made from ancient clay or mud. | |
| Information | |
| Source | Geode.png [Geode](/Geode "Geode")Omni Geode.png [Omni Geode](/Omni_Geode "Omni Geode") |
| Sell Price | data-sort-value="25 ">Gold.png25g |
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="32 ">Gold.png32g |

**Mudstone** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Mudstone is not used in any [bundles](/Bundles "Bundles").
...
Mudstone is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt018.png](/mediawiki/images/thumb/6/6f/Shirt018.png/24px-Shirt018.png) [Brown Jacket](/Tailoring "Tailoring"). It is a brown dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed. It can be placed in the orange dye pot at Emily's and Haley's house for use in [dyeing](/Dyeing "Dyeing").

## Quests

1 Mudstone may be requested by [Bullhead](/Bullhead "Bullhead") or [Largemouth Bass](/Largemouth_Bass "Largemouth Bass") in a [Fish Pond quest](/Fish_Pond#Quests "Fish Pond") to increase the capacity of the pond from 7 to 10.
