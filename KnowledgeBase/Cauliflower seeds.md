...
| --- | --- |
| Cauliflower Seeds | |
| [Cauliflower Seeds.png](/File:Cauliflower_Seeds.png) | |
| Plant these in the spring. Takes 12 days to produce a large cauliflower. | |
| Information | |
| Crop: | Cauliflower.png [Cauliflower](/Cauliflower "Cauliflower") |
| Growth Time: | 12 days |
| Season: | Spring.png [Spring](/Spring "Spring") |
| Sell Price: | data-sort-value="40">Gold.png40g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="80">Gold.png80g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="100">Gold.png100g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="40"Gold.png120–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 15): | data-sort-value="80">Gold.png80g |

**Cauliflower Seeds** are a type of seed. Mature plants yield [Cauliflower](/Cauliflower "Cauliflower").

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), at [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 15, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). Nine seeds can be obtained from [Gunther](/Gunther "Gunther") at the [Museum](/Museum "Museum") after donating 5 items. Seeds can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker"), as well as having a chance of being planted when using [Mixed Seeds](/Mixed_Seeds "Mixed Seeds"). Five to twenty Cauliflower Seeds may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern. Eight to twenty Cauliflower Seeds may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").

## Stages

Cauliflower can become a [Giant Crop](/Crops#Giant_Crops "Crops").

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Stage 5 | Harvest |
| --- | --- | --- | --- | --- | --- |
| Cauliflower Stage 1.png | Cauliflower Stage 2.png | Cauliflower Stage 3.png | Cauliflower Stage 4.png | Cauliflower Stage 5.png | Cauliflower Stage 6.png |
