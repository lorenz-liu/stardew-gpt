...
| --- | --- |
| Chowder | |
| [Chowder.png](/File:Chowder.png) | |
| A perfect way to warm yourself after a cold night at sea. | |
| Information | |
| Source | [Cooking](/Cooking "Cooking") |
| Buff(s) | Fishing.png [Fishing](/Fishing "Fishing") (+1) |
| Buff Duration | Time Icon.png 16m 47s |
| [Energy](/Energy "Energy") / [Health](/Health "Health") | |  |  |  |  | | --- | --- | --- | --- | | Energy.png | 225 | Health.png | 101 | |
| Sell Price | |  |  | | --- | --- | | Chowder.png | 135g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 405 | Health.png  Gold Quality Icon.png | 182 | |  | |  |  | | --- | --- | | Chowder.png  Gold Quality Icon.png | 202g | | |
| Recipe | |
| Recipe Source(s) | Willy Icon.png [Willy](/Willy "Willy") (Mail - 3+ HeartIconLarge.png) |
| Ingredients | Clam.png [Clam](/Clam "Clam") (1)Milk.png [Milk](/Milk "Milk") (1) |

**Chowder** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").

One Chowder may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box").
...
Chowder is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Chowder is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the dyeable [Fringed Vest](/Tailoring "Tailoring"). [![Shirt283a.png](/mediawiki/images/thumb/b/b9/Shirt283a.png/24px-Shirt283a.png)](/File:Shirt283a.png)

## Quests

Chowder is not used in any [quests](/Quests "Quests").

## History

* [1.3.27](/Version_History#1.3.27 "Version History"): The Chowder recipe accepts [Large Milk](/Large_Milk "Large Milk") in addition to [regular milk](/Milk "Milk").
