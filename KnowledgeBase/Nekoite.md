...
| Gemologist.png Gemologist Profession *(+30% Sell Price)* | data-sort-value="104 ">Gold.png104g |

**Nekoite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Geode](/Geode "Geode") and the [Omni Geode](/Omni_Geode "Omni Geode").
...
Nekoite is not used in any [bundles](/Bundles "Bundles").
...
Nekoite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt107.png](/mediawiki/images/thumb/4/48/Shirt107.png/24px-Shirt107.png) [Shirt](/Tailoring "Tailoring"). It is a pink dye when used in the spool of the [Sewing Machine](/Sewing_Machine "Sewing Machine") with a dyeable clothing item in the feed. It can be placed in the red dye pot at [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane"), for use in [dyeing](/Dyeing "Dyeing").

## Quests

Nekoite is not used in any [quests](/Quests "Quests").
