...
| --- | --- |
| Lead Bobber | |
| [Lead Bobber.png](/File:Lead_Bobber.png) | |
| Adds weight to your "fishing bar", preventing it from bouncing along the bottom. | |
| Information | |
| Source | [Fish Shop](/Fish_Shop "Fish Shop") • [Traveling Cart](/Traveling_Cart "Traveling Cart") |
| Sell Price | data-sort-value="150">Gold.png150g |

The **Lead Bobber** is a [tackle](/Tackle "Tackle") that helps [fishing](/Fishing "Fishing") by preventing the bar from bouncing. It can be purchased from [Willy's Fish Shop](/Fish_Shop "Fish Shop") for data-sort-value="200">![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)200g after reaching [Fishing level 6](/Fishing#Fishing_Skill "Fishing"). It may also randomly appear at the [Traveling Cart](/Traveling_Cart "Traveling Cart") for data-sort-value="150"![Gold.png](/mediawiki/images/thumb/1/10/Gold.png/18px-Gold.png)450–1,000g. It is one of two fishing tackle that cannot be [crafted](/Crafting "Crafting"), along with the [Curiosity Lure](/Curiosity_Lure "Curiosity Lure").

Using two Lead Bobbers on an [Advanced Iridium Rod](/Advanced_Iridium_Rod "Advanced Iridium Rod") prevents the fishing bar from bouncing even more compared to using one.
...
The Lead Bobber is not used in any [bundles](/Bundles "Bundles").

## Quests

The Lead Bobber is not used in any [quests](/Quests "Quests").

## History

* [1.0](/Version_History#1.0 "Version History"): Introduced.
* [1.6](/Version_History#1.6 "Version History"): Using two Lead Bobbers prevents the fishing bar from bouncing even more.
