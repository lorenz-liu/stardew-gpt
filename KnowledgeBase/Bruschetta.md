...
| --- | --- |
| Bruschetta | |
| [Bruschetta.png](/File:Bruschetta.png) | |
...
| Sell Price | |  |  | | --- | --- | | Bruschetta.png | 210g | |
| Qi Seasoning.png[Qi Seasoning](/Qi_Seasoning "Qi Seasoning") | |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | |  |  |  |  | | --- | --- | --- | --- | | Energy.png  Gold Quality Icon.png | 203 | Health.png  Gold Quality Icon.png | 91 | |  | |  |  | | --- | --- | | Bruschetta.png  Gold Quality Icon.png | 315g | | |
| Recipe | |
| Recipe Source(s) | |  |  | | --- | --- | | Cooking Channel.png | [The Queen of Sauce](/The_Queen_of_Sauce "The Queen of Sauce") | | 21 Winter, Year 2 | |
| Ingredients | Bread.png [Bread](/Bread "Bread") (1)Oil.png [Oil](/Oil "Oil") (1)Tomato.png [Tomato](/Tomato "Tomato") (1) |

**Bruschetta** is a [cooked dish](/Cooking "Cooking"). It is prepared using either the kitchen inside an upgraded [farmhouse](/Farmhouse "Farmhouse") or a [Cookout Kit](/Cookout_Kit "Cookout Kit").
...
Bruschetta is not used in any [bundles](/Bundles "Bundles").

## Tailoring

Bruschetta is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") to create the [Shirt And Tie](/Tailoring "Tailoring"). [![Shirt123.png](/mediawiki/images/thumb/d/d0/Shirt123.png/24px-Shirt123.png)](/File:Shirt123.png) It can be also used as a red dye color at the dye pots in [Emily](/Emily "Emily")'s and [Haley](/Haley "Haley")'s house, [2 Willow Lane](/2_Willow_Lane "2 Willow Lane").

## Quests

Bruschetta is not used in any [quests](/Quests "Quests").
