...
| --- | --- |
| Bixite | |
| [Bixite.png](/File:Bixite.png) | |
| A dark metallic Mineral sought after for its cubic structure. | |
| Information | |
| Source | Magma Geode.png [Magma Geode](/Magma_Geode "Magma Geode")Omni Geode.png [Omni Geode](/Omni_Geode "Omni Geode")Black Slime.png [Black Slime](/Slimes "Slimes") |
...
**Bixite** is a [mineral](/Minerals#Geode_Minerals "Minerals") that can be found in the [Magma Geode](/Magma_Geode "Magma Geode") and the [Omni Geode](/Omni_Geode "Omni Geode"). It can also be dropped by [Black Slimes](/Slimes "Slimes").
...
Bixite is not used in any [bundles](/Bundles "Bundles").
...
Bixite is used in the spool of the [Sewing Machine](/2_Willow_Lane#Sewing_Machine "2 Willow Lane") with [Cloth](/Cloth "Cloth") in the feed to create a ![Shirt101.png](/mediawiki/images/thumb/b/ba/Shirt101.png/24px-Shirt101.png) [Shirt](/Tailoring "Tailoring"). It is a black dye when used in the spool of the Sewing Machine with a dyeable clothing item in the feed.

## Quests

Bixite is not used in any [quests](/Quests "Quests").
