...
| --- | --- |
| Wheat Seeds | |
| [Wheat Seeds.png](/File:Wheat_Seeds.png) | |
| Plant these in the summer or fall. Takes 4 days to mature. Harvest with the scythe. | |
| Information | |
| Crop: | Wheat.png [Wheat](/Wheat "Wheat") |
| Growth Time: | 4 days |
| Season: | Summer.png [Summer](/Summer "Summer") • Fall.png [Fall](/Fall "Fall") |
| Sell Price: | data-sort-value="5">Gold.png5g |
| Purchase Prices | |
| Pierre Icon.png [General Store](/Pierre%27s_General_Store "Pierre's General Store"): | data-sort-value="10">Gold.png10g |
| Morris Icon.png [JojaMart](/JojaMart "JojaMart"): | data-sort-value="12">Gold.png12g |
| Traveling Cart Icon.png [Traveling Cart](/Traveling_Cart "Traveling Cart"): | data-sort-value="5"Gold.png100–1,000g |
| [Night Market](/Night_Market "Night Market") (Winter 16 & 17): | data-sort-value="10">Gold.png10g |

**Wheat Seeds** are a type of seed. Mature plants yield [Wheat](/Wheat "Wheat").

They can be purchased at [Pierre's General Store](/Pierre%27s_General_Store "Pierre's General Store"), at [JojaMart](/JojaMart "JojaMart"), from the Magic Shop Boat at the [Night Market](/Night_Market "Night Market") on Winter 16 & 17, and occasionally from the [Traveling Cart](/Traveling_Cart "Traveling Cart"). They can also be obtained by using the [Seed Maker](/Seed_Maker "Seed Maker"), as well as having a chance of being planted when using [Mixed Seeds](/Mixed_Seeds "Mixed Seeds"). Five to twenty Wheat Seeds may occasionally be found in [treasure rooms](/Skull_Cavern#Treasure_Rooms "Skull Cavern") in the Skull Cavern. Eight to twenty Wheat Seeds may be received from opening a [Mystery Box](/Mystery_Box "Mystery Box") or [Golden Mystery Box](/Golden_Mystery_Box "Golden Mystery Box").

## Stages

| Stage 1 | Stage 2 | Stage 3 | Stage 4 | Harvest |
| --- | --- | --- | --- | --- |
| Wheat Stage 1.png | Wheat Stage 2.png | Wheat Stage 3.png | Wheat Stage 4.png | Wheat Stage 5.png |
...
* Planting wheat seeds at the end of Summer offers a cheap way to ensure a tile doesn't lose its tilled status (and watered status, if supplied by a [sprinkler](/Sprinkler "Sprinkler")) at the change of the season. Wheat is ideal for this as it lasts two seasons and has a very short growth time.
